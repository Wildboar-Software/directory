...
import { id_at_atn_use_of_directory } from "../ATNDirectoryObjectIdentifiers/id-at-atn-use-of-directory.va";
export { id_at_atn_use_of_directory } from "../ATNDirectoryObjectIdentifiers/id-at-atn-use-of-directory.va";


/* START_OF_SYMBOL_DEFINITION atn_use_of_directory */
/**
 * @summary atn_use_of_directory
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const atn_use_of_directory: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": [ "atn-use-of-directory" ] /* OBJECT_FIELD_SETTING */,
    "&id": id_at_atn_use_of_directory /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION atn_use_of_directory */
