...
export { x509Certificate } from "@wildboar/x500/src/lib/modules/AuthenticationFramework/x509Certificate.oa";
import { id_at_atn_DerCertificate } from "../ATNDirectoryObjectIdentifiers/id-at-atn-DerCertificate.va";
export { id_at_atn_DerCertificate } from "../ATNDirectoryObjectIdentifiers/id-at-atn-DerCertificate.va";
