...
import { id_at_voPersonStatus } from "../VOPerson/id-at-voPersonStatus.va";
...
export { id_at_voPersonStatus } from "../VOPerson/id-at-voPersonStatus.va";


/* START_OF_SYMBOL_DEFINITION voPersonStatus */
/**
 * @summary voPersonStatus
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const voPersonStatus: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "voPersonStatus" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "voPerson Status" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_voPersonStatus /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION voPersonStatus */
