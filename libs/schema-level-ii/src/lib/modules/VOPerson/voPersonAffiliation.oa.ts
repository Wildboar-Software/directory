...
import { id_at_voPersonAffiliation } from "../VOPerson/id-at-voPersonAffiliation.va";
...
export { id_at_voPersonAffiliation } from "../VOPerson/id-at-voPersonAffiliation.va";


/* START_OF_SYMBOL_DEFINITION voPersonAffiliation */
/**
 * @summary voPersonAffiliation
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const voPersonAffiliation: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "voPersonAffiliation" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "voPerson Affiliation Within Local Scope" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_voPersonAffiliation /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION voPersonAffiliation */
