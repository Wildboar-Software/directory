...
import { id_at_voPersonAuthorName } from "../VOPerson/id-at-voPersonAuthorName.va";
export { id_at_voPersonAuthorName } from "../VOPerson/id-at-voPersonAuthorName.va";


/* START_OF_SYMBOL_DEFINITION voPersonAuthorName */
/**
 * @summary voPersonAuthorName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const voPersonAuthorName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "voPersonAuthorName" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "voPerson Author Name" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_voPersonAuthorName /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION voPersonAuthorName */
