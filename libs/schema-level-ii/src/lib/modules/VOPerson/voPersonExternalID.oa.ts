...
import { id_at_voPersonExternalID } from "../VOPerson/id-at-voPersonExternalID.va";
export { id_at_voPersonExternalID } from "../VOPerson/id-at-voPersonExternalID.va";


/* START_OF_SYMBOL_DEFINITION voPersonExternalID */
/**
 * @summary voPersonExternalID
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const voPersonExternalID: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "voPersonExternalID" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "voPerson Scoped External Identifier" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_voPersonExternalID /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION voPersonExternalID */
