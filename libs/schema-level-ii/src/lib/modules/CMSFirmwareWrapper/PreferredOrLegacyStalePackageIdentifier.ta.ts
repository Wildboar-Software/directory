...
function _decode_PreferredOrLegacyStalePackageIdentifier (el: _Element) {
    if (!_cached_decoder_for_PreferredOrLegacyStalePackageIdentifier) { _cached_decoder_for_PreferredOrLegacyStalePackageIdentifier = $._decode_inextensible_choice<PreferredOrLegacyStalePackageIdentifier>({
