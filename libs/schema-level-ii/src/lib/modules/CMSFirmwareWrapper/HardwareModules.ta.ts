...
export { HardwareSerialEntry, _decode_HardwareSerialEntry, _encode_HardwareSerialEntry } from "../CMSFirmwareWrapper/HardwareSerialEntry.ta";
...
class HardwareModules {
    ...
    public static _from_object (_o: { [_K in keyof (HardwareModules)]: (HardwareModules)[_K] }): HardwareModules {
        return new HardwareModules(_o.hwType, _o.hwSerialEntries);
    }
