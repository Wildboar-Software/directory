...
export { ExtensionReq, _decode_ExtensionReq, _encode_ExtensionReq } from "../EnrollmentMessageSyntax-2009/ExtensionReq.ta";
export { id_ExtensionReq } from "../EnrollmentMessageSyntax-2009/id-ExtensionReq.va";
