 ...
 */
export
type CertReqMessages = CertReqMsg[]; // SequenceOfType
 ...
 */
export
function _decode_CertReqMessages (el: _Element) {
    if (!_cached_decoder_for_CertReqMessages) { _cached_decoder_for_CertReqMessages = $._decodeSequenceOf<CertReqMsg>(() => _decode_CertReqMsg); }
 ...
 */
export
function _encode_CertReqMessages (value: CertReqMessages, elGetter: $.ASN1Encoder<CertReqMessages>) {
    if (!_cached_encoder_for_CertReqMessages) { _cached_encoder_for_CertReqMessages = $._encodeSequenceOf<CertReqMsg>(() => _encode_CertReqMsg, $.BER); }
