...
function _decode_OptionalValidity (el: _Element) {
    ...
    const callbacks: $.DecodingMap = {
        "notBefore": (_el: _Element): void => { notBefore = $._decode_implicit<Time>(() => _decode_Time)(_el); },
        "notAfter": (_el: _Element): void => { notAfter = $._decode_implicit<Time>(() => _decode_Time)(_el); }
    };
...
function _encode_OptionalValidity (value: OptionalValidity, elGetter: $.ASN1Encoder<OptionalValidity>) {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.notBefore === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => _encode_Time, $.BER)(value.notBefore, $.BER)),
            /* IF_ABSENT  */ ((value.notAfter === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => _encode_Time, $.BER)(value.notAfter, $.BER))
        ],
