...
class CertRequest {
     ...
     * @returns {CertRequest}
     */
    public static _from_object (_o: { [_K in keyof (CertRequest)]: (CertRequest)[_K] }): CertRequest {
 ...
 */
export
const _root_component_type_list_1_spec_for_CertRequest: $.ComponentSpec[] = [
    new $.ComponentSpec("certReqId", false, $.hasTag(_TagClass.universal, 2), undefined, undefined),
    new $.ComponentSpec("certTemplate", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("controls", true, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
 ...
 */
export
function _decode_CertRequest (el: _Element) {
    if (!_cached_decoder_for_CertRequest) { _cached_decoder_for_CertRequest = function (el: _Element): CertRequest {
    ...
    const callbacks: $.DecodingMap = {
        "certReqId": (_el: _Element): void => { certReqId = $._decodeInteger(_el); },
        "certTemplate": (_el: _Element): void => { certTemplate = _decode_CertTemplate(_el); },
        "controls": (_el: _Element): void => { controls = _decode_Controls(_el); }
    };
 ...
 */
export
function _encode_CertRequest (value: CertRequest, elGetter: $.ASN1Encoder<CertRequest>) {
    if (!_cached_encoder_for_CertRequest) { _cached_encoder_for_CertRequest = function (value: CertRequest, elGetter: $.ASN1Encoder<CertRequest>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeInteger(value.certReqId, $.BER),
            /* REQUIRED   */ _encode_CertTemplate(value.certTemplate, $.BER),
            /* IF_ABSENT  */ ((value.controls === undefined) ? undefined : _encode_Controls(value.controls, $.BER))
        ],
