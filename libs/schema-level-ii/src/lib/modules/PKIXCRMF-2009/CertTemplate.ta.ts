...
function _encode_CertTemplate (value: CertTemplate, elGetter: $.ASN1Encoder<CertTemplate>) {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.issuer === undefined) ? undefined : $._encode_implicit(_TagClass.context, 3, () => _encode_Name, $.BER)(value.issuer, $.BER)),
            ...
            /* IF_ABSENT  */ ((value.subject === undefined) ? undefined : $._encode_implicit(_TagClass.context, 5, () => _encode_Name, $.BER)(value.subject, $.BER)),
