...
function _decode_CertReqMsg (el: _Element) {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "regInfo": (_el: _Element): void => { regInfo = $._decodeSequenceOf<SingleAttribute>(() => _decode_SingleAttribute)(_el); }
    };
...
function _encode_CertReqMsg (value: CertReqMsg, elGetter: $.ASN1Encoder<CertReqMsg>) {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.regInfo === undefined) ? undefined : $._encodeSequenceOf<SingleAttribute>(() => _encode_SingleAttribute, $.BER)(value.regInfo, $.BER))
        ],
