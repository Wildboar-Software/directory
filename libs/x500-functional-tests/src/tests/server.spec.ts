...
} from "@wildboar/x500/src/lib/modules/IDMProtocolSpecification/TLSResponse.ta.js";
import {
    Attribute,
...
} from "@wildboar/ldap/src/lib/modules/Lightweight-Directory-Access-Protocol-V3/LDAPResult-resultCode.ta.js";
import {
    BindRequest,
} from "@wildboar/ldap/src/lib/modules/Lightweight-Directory-Access-Protocol-V3/BindRequest.ta.js";
import {
    SearchRequest,
} from "@wildboar/ldap/src/lib/modules/Lightweight-Directory-Access-Protocol-V3/SearchRequest.ta.js";
import {
    SearchRequest_scope_baseObject,
} from "@wildboar/ldap/src/lib/modules/Lightweight-Directory-Access-Protocol-V3/SearchRequest-scope.ta.js";
import {
    SearchRequest_derefAliases_neverDerefAliases,
} from "@wildboar/ldap/src/lib/modules/Lightweight-Directory-Access-Protocol-V3/SearchRequest-derefAliases.ta.js";
import {
    list,
...
import { Request } from "@wildboar/x500/src/lib/modules/IDMProtocolSpecification/Request.ta.js";
import { SimpleCredentials } from "@wildboar/x500/src/lib/modules/DirectoryAbstractService/SimpleCredentials.ta.js";
...
//
// UPDATE: This code is commented out entirely, because it has also not been
// upgraded to NodeJS-style tests.
// When you do convert them, set the timeout to 5000.
