...
import {
    tagOid,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/tagOid.oa.js";
import {
    uiiInUrn,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/uiiInUrn.oa.js";
...
describe("Meerkat DSA", async () => {
     ...
     */
    await it("alias loops do not cause the search procedure to run indefinitely", { timeout: 10000 }, async () => {
    ...
    }); // This seems to be flaky at only five seconds.

    await it("alias loops do not cause the find DSE procedure to run indefinitely", { timeout: 10000 }, async () => {
