...
import { id_at_vendorName } from "../RFC3045VendorInfo/id-at-vendorName.va";
export { id_at_vendorName } from "../RFC3045VendorInfo/id-at-vendorName.va";
 ...
 */
export
const vendorName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["vendorName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC3045: name of implementation vendor" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_vendorName /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
