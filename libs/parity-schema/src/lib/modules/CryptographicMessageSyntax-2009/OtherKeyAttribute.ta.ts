...
class OtherKeyAttribute {
     ...
     */
    public static _from_object (_o: { [_K in keyof (OtherKeyAttribute)]: (OtherKeyAttribute)[_K] }): OtherKeyAttribute {
 ...
 */
export
const _root_component_type_list_1_spec_for_OtherKeyAttribute: $.ComponentSpec[] = [
    new $.ComponentSpec("keyAttrId", false, $.hasTag(_TagClass.universal, 6), undefined, undefined),
 ...
 */
export
const _root_component_type_list_2_spec_for_OtherKeyAttribute: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_OtherKeyAttribute: $.ComponentSpec[] = [
 ...
 */
export
function _decode_OtherKeyAttribute (el: _Element) {
    if (!_cached_decoder_for_OtherKeyAttribute) { _cached_decoder_for_OtherKeyAttribute = function (el: _Element): OtherKeyAttribute {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("OtherKeyAttribute contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_OtherKeyAttribute (value: OtherKeyAttribute, elGetter: $.ASN1Encoder<OtherKeyAttribute>) {
    if (!_cached_encoder_for_OtherKeyAttribute) { _cached_encoder_for_OtherKeyAttribute = function (value: OtherKeyAttribute, elGetter: $.ASN1Encoder<OtherKeyAttribute>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.keyAttrId, $.BER),
