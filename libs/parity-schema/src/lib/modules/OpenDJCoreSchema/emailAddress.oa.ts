 ...
 */
export
const emailAddress: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "represents the email address part of an X.509 certificate" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 2, 840, 113549, 1, 9, 1,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
