...
import { id_at_eduPersonOrcid } from "../EduPersonSchema/id-at-eduPersonOrcid.va";
export { id_at_eduPersonOrcid } from "../EduPersonSchema/id-at-eduPersonOrcid.va";


/* START_OF_SYMBOL_DEFINITION eduPersonOrcid */
/**
 * @summary eduPersonOrcid
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const eduPersonOrcid: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["eduPersonOrcid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "ORCID researcher identifiers belonging to the principal" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_eduPersonOrcid /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION eduPersonOrcid */
