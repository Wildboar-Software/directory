...
import { id_at_eduPersonPrimaryAffiliation } from '../EduPersonSchema/id-at-eduPersonPrimaryAffiliation.va';
...
export { id_at_eduPersonPrimaryAffiliation } from '../EduPersonSchema/id-at-eduPersonPrimaryAffiliation.va';

/* START_OF_SYMBOL_DEFINITION eduPersonPrimaryAffiliation */
/**
 * @summary eduPersonPrimaryAffiliation
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const eduPersonPrimaryAffiliation: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapName': ['eduPersonPrimaryAffiliation'] /* OBJECT_FIELD_SETTING */,
        '&ldapDesc': 'Primary Affiliation' /* OBJECT_FIELD_SETTING */,
        '&id': id_at_eduPersonPrimaryAffiliation /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
        '&Type':
...
/* END_OF_SYMBOL_DEFINITION eduPersonPrimaryAffiliation */
