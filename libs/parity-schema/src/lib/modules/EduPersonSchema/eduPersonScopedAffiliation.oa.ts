...
export { id_at_eduPersonScopedAffiliation } from "../EduPersonSchema/id-at-eduPersonScopedAffiliation.va";
 ...
 */
export
const eduPersonScopedAffiliation: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
