...
import { id_at_eduPersonPrincipalNamePrior } from "../EduPersonSchema/id-at-eduPersonPrincipalNamePrior.va";
export { id_at_eduPersonPrincipalNamePrior } from "../EduPersonSchema/id-at-eduPersonPrincipalNamePrior.va";


/* START_OF_SYMBOL_DEFINITION eduPersonPrincipalNamePrior */
/**
 * @summary eduPersonPrincipalNamePrior
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const eduPersonPrincipalNamePrior: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["eduPersonPrincipalNamePrior"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "eduPersonPrincipalNamePrior per Internet2" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_eduPersonPrincipalNamePrior /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION eduPersonPrincipalNamePrior */
