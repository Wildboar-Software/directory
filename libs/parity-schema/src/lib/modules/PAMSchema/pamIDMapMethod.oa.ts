...
/* START_OF_SYMBOL_DEFINITION pamIDMapMethod */
/**
 * @summary pamIDMapMethod
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const pamIDMapMethod: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pamIDMapMethod"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "How to map BIND DN to PAM identity" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 2070,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pamIDMapMethod */
