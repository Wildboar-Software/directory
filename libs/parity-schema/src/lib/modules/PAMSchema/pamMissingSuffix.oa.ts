...
/* START_OF_SYMBOL_DEFINITION pamMissingSuffix */
/**
 * @summary pamMissingSuffix
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const pamMissingSuffix: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pamMissingSuffix"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "How to handle missing include or exclude suffixes" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 2069,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pamMissingSuffix */
