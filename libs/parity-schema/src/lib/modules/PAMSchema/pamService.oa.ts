...
/* START_OF_SYMBOL_DEFINITION pamService */
/**
 * @summary pamService
 * @description
 * 
 ...
 */
export
const pamService: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pamService"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Service name to pass to pam_start" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 2074,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pamService */
