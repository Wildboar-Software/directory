...
/* START_OF_SYMBOL_DEFINITION pamFilter */
/**
 * @summary pamFilter
 * @description
 * 
 ...
 */
export
const pamFilter: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pamFilter"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Filter to match entries that should use PAM authentication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 2131,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pamFilter */
