...
/* START_OF_SYMBOL_DEFINITION pamIDAttr */
/**
 * @summary pamIDAttr
 * @description
 * 
 ...
 */
export
const pamIDAttr: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pamIDAttr"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Name of attribute holding PAM ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 2071,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pamIDAttr */
