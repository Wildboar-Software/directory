 ...
 */
export
type Creator = UTF8String; // UTF8String
 ...
 */
export
function _decode_Creator (el: _Element) {
    if (!_cached_decoder_for_Creator) { _cached_decoder_for_Creator = $._decodeUTF8String; }
 ...
 */
export
function _encode_Creator (value: Creator, elGetter: $.ASN1Encoder<Creator>) {
    if (!_cached_encoder_for_Creator) { _cached_encoder_for_Creator = $._encodeUTF8String; }
