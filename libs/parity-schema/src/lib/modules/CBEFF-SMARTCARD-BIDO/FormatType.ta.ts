 ...
 */
export
type FormatType = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_FormatType (el: _Element) {
    if (!_cached_decoder_for_FormatType) { _cached_decoder_for_FormatType = $._decodeOctetString; }
 ...
 */
export
function _encode_FormatType (value: FormatType, elGetter: $.ASN1Encoder<FormatType>) {
    if (!_cached_encoder_for_FormatType) { _cached_encoder_for_FormatType = $._encodeOctetString; }
