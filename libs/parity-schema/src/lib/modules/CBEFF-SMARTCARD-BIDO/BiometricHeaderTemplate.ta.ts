...
import {
    BCDDatePeriod,
    _decode_BCDDatePeriod,
    _encode_BCDDatePeriod,
} from '../CBEFF-SMARTCARD-BIDO/BCDDatePeriod.ta';
import {
    BCDTime,
    _decode_BCDTime,
    _encode_BCDTime,
} from '../CBEFF-SMARTCARD-BIDO/BCDTime.ta';
import {
    BiometricSubType,
    _decode_BiometricSubType,
    _encode_BiometricSubType,
} from '../CBEFF-SMARTCARD-BIDO/BiometricSubType.ta';
import {
    BiometricType,
    _decode_BiometricType,
    _encode_BiometricType,
} from '../CBEFF-SMARTCARD-BIDO/BiometricType.ta';
import {
    BIRIndex,
    _decode_BIRIndex,
    _encode_BIRIndex,
} from '../CBEFF-SMARTCARD-BIDO/BIRIndex.ta';
import {
    Creator,
    _decode_Creator,
    _encode_Creator,
} from '../CBEFF-SMARTCARD-BIDO/Creator.ta';
import {
    FormatOwner,
    _decode_FormatOwner,
    _encode_FormatOwner,
} from '../CBEFF-SMARTCARD-BIDO/FormatOwner.ta';
import {
    FormatType,
    _decode_FormatType,
    _encode_FormatType,
} from '../CBEFF-SMARTCARD-BIDO/FormatType.ta';
import {
    PatronHeaderVersion,
    _decode_PatronHeaderVersion,
    _encode_PatronHeaderVersion,
} from '../CBEFF-SMARTCARD-BIDO/PatronHeaderVersion.ta';
import {
    ProductID,
    _decode_ProductID,
    _encode_ProductID,
} from '../CBEFF-SMARTCARD-BIDO/ProductID.ta';
 ...
 * @class
 */
export class BiometricHeaderTemplate {
    constructor(
        /**
    ...
    public static _from_object(_o: {
        [_K in keyof BiometricHeaderTemplate]: BiometricHeaderTemplate[_K];
    }): BiometricHeaderTemplate {
        return new BiometricHeaderTemplate(
            _o.patronHeaderVersion,
            _o.bdbBiometricType,
            _o.bdbBiometricSubType,
            _o.bdbCreationDate,
            _o.birCreator,
            _o.bdbValidityPeriod,
            _o.bdbPID,
            _o.bdbFormatOwner,
            _o.bdbFormatType,
            _o.birIndex,
            _o.matchingAlgParameters
        );
    }
     ...
     * @method
     */
    public static get _default_value_for_patronHeaderVersion() {
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_BiometricHeaderTemplate: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'patronHeaderVersion',
            true,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_BiometricHeaderTemplate: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_BiometricHeaderTemplate: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_BiometricHeaderTemplate: $.ASN1Decoder<BiometricHeaderTemplate> | null =
    null;
 ...
 */
export function _decode_BiometricHeaderTemplate(el: _Element) {
    if (!_cached_decoder_for_BiometricHeaderTemplate) {
        _cached_decoder_for_BiometricHeaderTemplate = function (
            el: _Element
        ): BiometricHeaderTemplate {
            /* START_OF_SET_COMPONENT_DECLARATIONS */
            let patronHeaderVersion: OPTIONAL<PatronHeaderVersion> =
                BiometricHeaderTemplate._default_value_for_patronHeaderVersion;
            ...
            const callbacks: $.DecodingMap = {
                patronHeaderVersion: (_el: _Element): void => {
                    patronHeaderVersion =
                        $._decode_implicit<PatronHeaderVersion>(
                            () => _decode_PatronHeaderVersion
                        )(_el);
                },
                bdbBiometricType: (_el: _Element): void => {
                    bdbBiometricType = $._decode_implicit<BiometricType>(
                        () => _decode_BiometricType
                    )(_el);
                },
                bdbBiometricSubType: (_el: _Element): void => {
                    bdbBiometricSubType = $._decode_implicit<BiometricSubType>(
                        () => _decode_BiometricSubType
                    )(_el);
                },
                bdbCreationDate: (_el: _Element): void => {
                    bdbCreationDate = $._decode_implicit<BCDTime>(
                        () => _decode_BCDTime
                    )(_el);
                },
                birCreator: (_el: _Element): void => {
                    birCreator = $._decode_implicit<Creator>(
                        () => _decode_Creator
                    )(_el);
                },
                bdbValidityPeriod: (_el: _Element): void => {
                    bdbValidityPeriod = $._decode_implicit<BCDDatePeriod>(
                        () => _decode_BCDDatePeriod
                    )(_el);
                },
                bdbPID: (_el: _Element): void => {
                    bdbPID = $._decode_implicit<ProductID>(
                        () => _decode_ProductID
                    )(_el);
                },
                bdbFormatOwner: (_el: _Element): void => {
                    bdbFormatOwner = $._decode_implicit<FormatOwner>(
                        () => _decode_FormatOwner
                    )(_el);
                },
                bdbFormatType: (_el: _Element): void => {
                    bdbFormatType = $._decode_implicit<FormatType>(
                        () => _decode_FormatType
                    )(_el);
                },
                birIndex: (_el: _Element): void => {
                    birIndex = $._decode_implicit<BIRIndex>(
                        () => _decode_BIRIndex
                    )(_el);
                },
                matchingAlgParameters: (_el: _Element): void => {
                    matchingAlgParameters = $._decode_implicit<OCTET_STRING>(
                        () => $._decodeOctetString
                    )(_el);
                },
            };
...
let _cached_encoder_for_BiometricHeaderTemplate: $.ASN1Encoder<BiometricHeaderTemplate> | null =
    null;
 ...
 */
export function _encode_BiometricHeaderTemplate(
    value: BiometricHeaderTemplate,
    elGetter: $.ASN1Encoder<BiometricHeaderTemplate>
) {
    if (!_cached_encoder_for_BiometricHeaderTemplate) {
        _cached_encoder_for_BiometricHeaderTemplate = function (
            value: BiometricHeaderTemplate,
            elGetter: $.ASN1Encoder<BiometricHeaderTemplate>
        ): _Element {
            return $._encodeSet(
                ([] as (_Element | undefined)[])
                    .concat([
                        /* IF_DEFAULT */ value.patronHeaderVersion ===
                            undefined ||
                        $.deepEq(
                            ...
                            : $._encode_implicit(
                                  ...
                                  () => _encode_PatronHeaderVersion,
                                  $.BER
                              )(value.patronHeaderVersion, $.BER),
                        /* IF_ABSENT  */ value.bdbBiometricType === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  1,
                                  () => _encode_BiometricType,
                                  $.BER
                              )(value.bdbBiometricType, $.BER),
                        /* IF_ABSENT  */ value.bdbBiometricSubType === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  2,
                                  () => _encode_BiometricSubType,
                                  $.BER
                              )(value.bdbBiometricSubType, $.BER),
                        /* IF_ABSENT  */ value.bdbCreationDate === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  3,
                                  () => _encode_BCDTime,
                                  $.BER
                              )(value.bdbCreationDate, $.BER),
                        /* IF_ABSENT  */ value.birCreator === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  4,
                                  () => _encode_Creator,
                                  $.BER
                              )(value.birCreator, $.BER),
                        /* IF_ABSENT  */ value.bdbValidityPeriod === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  5,
                                  () => _encode_BCDDatePeriod,
                                  $.BER
                              )(value.bdbValidityPeriod, $.BER),
                        /* IF_ABSENT  */ value.bdbPID === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  6,
                        ...
                        /* REQUIRED   */ $._encode_implicit(
                            ...
                            () => _encode_FormatOwner,
                            $.BER
                        )(value.bdbFormatOwner, $.BER),
                        /* REQUIRED   */ $._encode_implicit(
                            _TagClass.context,
                            8,
                            () => _encode_FormatType,
                            $.BER
                        )(value.bdbFormatType, $.BER),
                        /* IF_ABSENT  */ value.birIndex === undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  16,
                        ...
                        /* IF_ABSENT  */ value.matchingAlgParameters ===
                        undefined
                            ? undefined
                            : $._encode_implicit(
                                  _TagClass.context,
                                  ...
                                  () => $._encodeOctetString,
                                  $.BER
                              )(value.matchingAlgParameters, $.BER),
                    ])
