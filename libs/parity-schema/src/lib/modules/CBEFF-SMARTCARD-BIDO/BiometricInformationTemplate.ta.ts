...
import { BiometricHeaderTemplate, _decode_BiometricHeaderTemplate, _encode_BiometricHeaderTemplate } from "../CBEFF-SMARTCARD-BIDO/BiometricHeaderTemplate.ta";
export { BiometricHeaderTemplate, _decode_BiometricHeaderTemplate, _encode_BiometricHeaderTemplate } from "../CBEFF-SMARTCARD-BIDO/BiometricHeaderTemplate.ta";
 ...
 */
export
class BiometricInformationTemplate {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (BiometricInformationTemplate)]: (BiometricInformationTemplate)[_K] }): BiometricInformationTemplate {
        return new BiometricInformationTemplate(_o.algorithmReference, _o.referenceDataQualifier, _o.biometricHeaderTemplate, _o.bdbReferenceData, _o.birPayLoad);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BiometricInformationTemplate: $.ComponentSpec[] = [
    new $.ComponentSpec("algorithmReference", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("referenceDataQualifier", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("biometricHeaderTemplate", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("bdbReferenceData", true, $.hasTag(_TagClass.application, 46), undefined, undefined),
    new $.ComponentSpec("birPayLoad", true, $.hasTag(_TagClass.application, 19), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BiometricInformationTemplate: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BiometricInformationTemplate: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BiometricInformationTemplate (el: _Element) {
    if (!_cached_decoder_for_BiometricInformationTemplate) { _cached_decoder_for_BiometricInformationTemplate = $._decode_implicit<BiometricInformationTemplate>(() => function (el: _Element): BiometricInformationTemplate {
    ...
    const callbacks: $.DecodingMap = {
        "algorithmReference": (_el: _Element): void => { algorithmReference = $._decode_implicit<OCTET_STRING>(() => $._decodeOctetString)(_el); },
        "referenceDataQualifier": (_el: _Element): void => { referenceDataQualifier = $._decode_implicit<OCTET_STRING>(() => $._decodeOctetString)(_el); },
        "biometricHeaderTemplate": (_el: _Element): void => { biometricHeaderTemplate = $._decode_implicit<BiometricHeaderTemplate>(() => _decode_BiometricHeaderTemplate)(_el); },
        "bdbReferenceData": (_el: _Element): void => { bdbReferenceData = $._decode_implicit<EXTERNAL>(() => $._decodeExternal)(_el); },
        "birPayLoad": (_el: _Element): void => { birPayLoad = $._decode_implicit<OCTET_STRING>(() => $._decodeOctetString)(_el); }
    };
 ...
 */
export
function _encode_BiometricInformationTemplate (value: BiometricInformationTemplate, elGetter: $.ASN1Encoder<BiometricInformationTemplate>) {
    if (!_cached_encoder_for_BiometricInformationTemplate) { _cached_encoder_for_BiometricInformationTemplate = $._encode_implicit(_TagClass.application, 96, () => function (value: BiometricInformationTemplate, elGetter: $.ASN1Encoder<BiometricInformationTemplate>): _Element {
    return $._encodeSet(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.algorithmReference === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => $._encodeOctetString, $.BER)(value.algorithmReference, $.BER)),
            /* IF_ABSENT  */ ((value.referenceDataQualifier === undefined) ? undefined : $._encode_implicit(_TagClass.context, 3, () => $._encodeOctetString, $.BER)(value.referenceDataQualifier, $.BER)),
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 1, () => _encode_BiometricHeaderTemplate, $.BER)(value.biometricHeaderTemplate, $.BER),
            /* IF_ABSENT  */ ((value.bdbReferenceData === undefined) ? undefined : $._encode_implicit(_TagClass.application, 46, () => $._encodeExternal, $.BER)(value.bdbReferenceData, $.BER)),
            /* IF_ABSENT  */ ((value.birPayLoad === undefined) ? undefined : $._encode_implicit(_TagClass.application, 19, () => $._encodeOctetString, $.BER)(value.birPayLoad, $.BER))
        ],
