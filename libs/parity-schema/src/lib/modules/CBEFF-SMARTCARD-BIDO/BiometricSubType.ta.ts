 ...
 */
export
type BiometricSubType = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_BiometricSubType (el: _Element) {
    if (!_cached_decoder_for_BiometricSubType) { _cached_decoder_for_BiometricSubType = $._decodeOctetString; }
 ...
 */
export
function _encode_BiometricSubType (value: BiometricSubType, elGetter: $.ASN1Encoder<BiometricSubType>) {
    if (!_cached_encoder_for_BiometricSubType) { _cached_encoder_for_BiometricSubType = $._encodeOctetString; }
