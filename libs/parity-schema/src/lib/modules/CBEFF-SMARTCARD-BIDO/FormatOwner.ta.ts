 ...
 */
export
type FormatOwner = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_FormatOwner (el: _Element) {
    if (!_cached_decoder_for_FormatOwner) { _cached_decoder_for_FormatOwner = $._decodeOctetString; }
 ...
 */
export
function _encode_FormatOwner (value: FormatOwner, elGetter: $.ASN1Encoder<FormatOwner>) {
    if (!_cached_encoder_for_FormatOwner) { _cached_encoder_for_FormatOwner = $._encodeOctetString; }
