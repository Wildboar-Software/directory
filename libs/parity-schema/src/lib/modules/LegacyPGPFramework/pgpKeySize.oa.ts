...
/* START_OF_SYMBOL_DEFINITION pgpKeySize */
/**
 * @summary pgpKeySize
 * @description
 *
 ...
 */
export
const pgpKeySize: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpKeySize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "pgpKeySize attribute for PGP. A hint on the keysize." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 21,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpKeySize */
