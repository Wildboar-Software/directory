...
/* START_OF_SYMBOL_DEFINITION pgpKeyType */
/**
 * @summary pgpKeyType
 * @description
 *
 ...
 */
export
const pgpKeyType: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpKeyType"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "pgpKeyType attribute for PGP." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 15,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpKeyType */
