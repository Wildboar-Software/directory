...
/* START_OF_SYMBOL_DEFINITION pgpDisabled */
/**
 * @summary pgpDisabled
 * @description
 *
 ...
 */
export
const pgpDisabled: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpDisabled"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "pgpDisabled attribute for PGP. A flag to temporary disable a keyblock." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 13,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpDisabled */
