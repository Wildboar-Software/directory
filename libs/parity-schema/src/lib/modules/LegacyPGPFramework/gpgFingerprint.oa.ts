...
/* START_OF_SYMBOL_DEFINITION gpgFingerprint */
/**
 * @summary gpgFingerprint
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const gpgFingerprint: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["gpgFingerprint"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fingerprint of the primary key." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 4, 1, 1,], fsf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION gpgFingerprint */
