...
/* START_OF_SYMBOL_DEFINITION pgpCertID */
/**
 * @summary pgpCertID
 * @description
 *
 ...
 */
export
const pgpCertID: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpCertID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "OpenPGP long key id." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 12,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpCertID */
