...
/* START_OF_SYMBOL_DEFINITION pgpUserID */
/**
 * @summary pgpUserID
 * @description
 *
 ...
 */
export
const pgpUserID: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpUserID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "User ID(s) associated with the key." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 16,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpUserID */
