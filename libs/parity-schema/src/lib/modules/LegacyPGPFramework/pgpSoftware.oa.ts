...
/* START_OF_SYMBOL_DEFINITION pgpSoftware */
/**
 * @summary pgpSoftware
 * @description
 *
 ...
 */
export
const pgpSoftware: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpSoftware"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Origin of the schema." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 9,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpSoftware */
