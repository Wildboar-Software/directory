...
/* START_OF_SYMBOL_DEFINITION pgpSubKeyID */
/**
 * @summary pgpSubKeyID
 * @description
 *
 ...
 */
export
const pgpSubKeyID: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpSubKeyID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Sub-key ID(s) of the PGP key." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 20,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpSubKeyID */
