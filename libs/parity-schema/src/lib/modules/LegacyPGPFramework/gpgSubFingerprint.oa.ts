 ...
 */
export
const gpgSubFingerprint: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Fingerprints of the secondary keys." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 4, 1, 2,], fsf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
