...
/* START_OF_SYMBOL_DEFINITION gpgSubCertID */
/**
 * @summary gpgSubCertID
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const gpgSubCertID: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["gpgSubCertID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "OpenPGP long subkey id." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 4, 1, 4,], fsf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION gpgSubCertID */
