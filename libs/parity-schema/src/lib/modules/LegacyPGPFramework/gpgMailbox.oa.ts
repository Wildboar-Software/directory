 ...
 */
export
const gpgMailbox: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "The utf8 encoded addr-spec of a mailbox." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 4, 1, 3,], fsf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
