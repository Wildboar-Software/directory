...
/* START_OF_SYMBOL_DEFINITION pgpSignerID */
/**
 * @summary pgpSignerID
 * @description
 *
 ...
 */
export
const pgpSignerID: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpSignerID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "pgpSignerID attribute for PGP" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 18,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpSignerID */
