...
/* START_OF_SYMBOL_DEFINITION pgpVersion */
/**
 * @summary pgpVersion
 * @description
 *
 ...
 */
export
const pgpVersion: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpVersion"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Version of this schema." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 10,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpVersion */
