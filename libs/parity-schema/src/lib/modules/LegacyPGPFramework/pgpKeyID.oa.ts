...
/* START_OF_SYMBOL_DEFINITION pgpKeyID */
/**
 * @summary pgpKeyID
 * @description
 *
 ...
 */
export
const pgpKeyID: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpKeyID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "OpenPGP short key id." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 14,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpKeyID */
