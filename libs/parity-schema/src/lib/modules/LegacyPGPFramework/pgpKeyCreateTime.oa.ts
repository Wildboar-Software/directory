...
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/caseIgnoreSubstringsMatch.oa";


/* START_OF_SYMBOL_DEFINITION pgpKeyCreateTime */
/**
 * @summary pgpKeyCreateTime
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const pgpKeyCreateTime: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pgpKeyCreateTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Primary key creation time. Stored in ISO format: '20201231 120000'." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 17,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pgpKeyCreateTime */
