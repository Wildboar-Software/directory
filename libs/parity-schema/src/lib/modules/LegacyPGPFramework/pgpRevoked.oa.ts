 ...
 */
export
const pgpRevoked: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "pgpRevoked attribute for PGP. A value of 1 indicated that the keyblock has been revoked." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 19,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
