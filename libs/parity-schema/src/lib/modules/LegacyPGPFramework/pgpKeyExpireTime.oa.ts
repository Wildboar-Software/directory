 ...
 */
export
const pgpKeyExpireTime: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "pgpKeyExpireTime attribute for PGP. Stored in ISO format: '20201231 120000'." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 2, 22,], mcafee) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
