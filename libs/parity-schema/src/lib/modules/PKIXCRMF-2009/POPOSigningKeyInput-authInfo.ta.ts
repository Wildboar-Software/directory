...
let _cached_decoder_for_POPOSigningKeyInput_authInfo: $.ASN1Decoder<POPOSigningKeyInput_authInfo> | null =
    null;
...
export function _decode_POPOSigningKeyInput_authInfo(el: _Element) {
    if (!_cached_decoder_for_POPOSigningKeyInput_authInfo) {
        _cached_decoder_for_POPOSigningKeyInput_authInfo =
            $._decode_inextensible_choice<POPOSigningKeyInput_authInfo>({
                'CONTEXT 0': [
                    'sender',
...
let _cached_encoder_for_POPOSigningKeyInput_authInfo: $.ASN1Encoder<POPOSigningKeyInput_authInfo> | null =
    null;
...
export function _encode_POPOSigningKeyInput_authInfo(
    ...
    if (!_cached_encoder_for_POPOSigningKeyInput_authInfo) {
        _cached_encoder_for_POPOSigningKeyInput_authInfo =
            $._encode_choice<POPOSigningKeyInput_authInfo>(
                {
