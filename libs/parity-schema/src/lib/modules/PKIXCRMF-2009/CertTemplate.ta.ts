...
import { Version, Version_v1 /* IMPORTED_LONG_NAMED_INTEGER */, v1 /* IMPORTED_SHORT_NAMED_INTEGER */, Version_v2 /* IMPORTED_LONG_NAMED_INTEGER */, v2 /* IMPORTED_SHORT_NAMED_INTEGER */, Version_v3 /* IMPORTED_LONG_NAMED_INTEGER */, v3 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_Version, _encode_Version } from "@wildboar/x500/src/lib/modules/AuthenticationFramework/Version.ta";
export { Version, Version_v1 /* IMPORTED_LONG_NAMED_INTEGER */, v1 /* IMPORTED_SHORT_NAMED_INTEGER */, Version_v2 /* IMPORTED_LONG_NAMED_INTEGER */, v2 /* IMPORTED_SHORT_NAMED_INTEGER */, Version_v3 /* IMPORTED_LONG_NAMED_INTEGER */, v3 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_Version, _encode_Version } from "@wildboar/x500/src/lib/modules/AuthenticationFramework/Version.ta";
...
export { UniqueIdentifier, _decode_UniqueIdentifier, _encode_UniqueIdentifier } from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/UniqueIdentifier.ta";
...
export { Extensions, _decode_Extensions, _encode_Extensions } from "@wildboar/x500/src/lib/modules/AuthenticationFramework/Extensions.ta";
...
class CertTemplate {
     ...
     */
    public static _from_object (_o: { [_K in keyof (CertTemplate)]: (CertTemplate)[_K] }): CertTemplate {
        return new CertTemplate(_o.version, _o.serialNumber, _o.signingAlg, _o.issuer, _o.validity, _o.subject, _o.publicKey, _o.issuerUID, _o.subjectUID, _o.extensions);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_CertTemplate: $.ComponentSpec[] = [
    new $.ComponentSpec("version", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("serialNumber", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("signingAlg", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("issuer", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("validity", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
    new $.ComponentSpec("subject", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
    new $.ComponentSpec("publicKey", true, $.hasTag(_TagClass.context, 6), undefined, undefined),
    new $.ComponentSpec("issuerUID", true, $.hasTag(_TagClass.context, 7), undefined, undefined),
    new $.ComponentSpec("subjectUID", true, $.hasTag(_TagClass.context, 8), undefined, undefined),
    new $.ComponentSpec("extensions", true, $.hasTag(_TagClass.context, 9), undefined, undefined)
];
 ...
 */
export
function _decode_CertTemplate (el: _Element) {
    if (!_cached_decoder_for_CertTemplate) { _cached_decoder_for_CertTemplate = function (el: _Element): CertTemplate {
    ...
    const callbacks: $.DecodingMap = {
        "version": (_el: _Element): void => { version = $._decode_implicit<Version>(() => _decode_Version)(_el); },
        "serialNumber": (_el: _Element): void => { serialNumber = $._decode_implicit<INTEGER>(() => $._decodeInteger)(_el); },
        "signingAlg": (_el: _Element): void => { signingAlg = $._decode_implicit<AlgorithmIdentifier>(() => _decode_AlgorithmIdentifier)(_el); },
        "issuer": (_el: _Element): void => { issuer = $._decode_explicit<Name>(() => _decode_Name)(_el); },
        "validity": (_el: _Element): void => { validity = $._decode_implicit<OptionalValidity>(() => _decode_OptionalValidity)(_el); },
        "subject": (_el: _Element): void => { subject = $._decode_explicit<Name>(() => _decode_Name)(_el); },
        "publicKey": (_el: _Element): void => { publicKey = $._decode_implicit<SubjectPublicKeyInfo>(() => _decode_SubjectPublicKeyInfo)(_el); },
        "issuerUID": (_el: _Element): void => { issuerUID = $._decode_implicit<UniqueIdentifier>(() => _decode_UniqueIdentifier)(_el); },
        "subjectUID": (_el: _Element): void => { subjectUID = $._decode_implicit<UniqueIdentifier>(() => _decode_UniqueIdentifier)(_el); },
 ...
 */
export
function _encode_CertTemplate (value: CertTemplate, elGetter: $.ASN1Encoder<CertTemplate>) {
    if (!_cached_encoder_for_CertTemplate) { _cached_encoder_for_CertTemplate = function (value: CertTemplate, elGetter: $.ASN1Encoder<CertTemplate>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.version === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => _encode_Version, $.BER)(value.version, $.BER)),
            /* IF_ABSENT  */ ((value.serialNumber === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => $._encodeInteger, $.BER)(value.serialNumber, $.BER)),
            /* IF_ABSENT  */ ((value.signingAlg === undefined) ? undefined : $._encode_implicit(_TagClass.context, 2, () => _encode_AlgorithmIdentifier, $.BER)(value.signingAlg, $.BER)),
            /* IF_ABSENT  */ ((value.issuer === undefined) ? undefined : $._encode_explicit(_TagClass.context, 3, () => _encode_Name, $.BER)(value.issuer, $.BER)),
            /* IF_ABSENT  */ ((value.validity === undefined) ? undefined : $._encode_implicit(_TagClass.context, 4, () => _encode_OptionalValidity, $.BER)(value.validity, $.BER)),
            /* IF_ABSENT  */ ((value.subject === undefined) ? undefined : $._encode_explicit(_TagClass.context, 5, () => _encode_Name, $.BER)(value.subject, $.BER)),
            /* IF_ABSENT  */ ((value.publicKey === undefined) ? undefined : $._encode_implicit(_TagClass.context, 6, () => _encode_SubjectPublicKeyInfo, $.BER)(value.publicKey, $.BER)),
            /* IF_ABSENT  */ ((value.issuerUID === undefined) ? undefined : $._encode_implicit(_TagClass.context, 7, () => _encode_UniqueIdentifier, $.BER)(value.issuerUID, $.BER)),
            /* IF_ABSENT  */ ((value.subjectUID === undefined) ? undefined : $._encode_implicit(_TagClass.context, 8, () => _encode_UniqueIdentifier, $.BER)(value.subjectUID, $.BER)),
            /* IF_ABSENT  */ ((value.extensions === undefined) ? undefined : $._encode_implicit(_TagClass.context, 9, () => _encode_Extensions, $.BER)(value.extensions, $.BER))
        ],
