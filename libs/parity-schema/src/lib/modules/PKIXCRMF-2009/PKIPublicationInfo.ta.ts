...
export class PKIPublicationInfo {
    ...
    public static _from_object(_o: {
        [_K in keyof PKIPublicationInfo]: PKIPublicationInfo[_K];
    }): PKIPublicationInfo {
...
let _cached_decoder_for_PKIPublicationInfo: $.ASN1Decoder<PKIPublicationInfo> | null =
    null;
...
let _cached_encoder_for_PKIPublicationInfo: $.ASN1Encoder<PKIPublicationInfo> | null =
    null;
