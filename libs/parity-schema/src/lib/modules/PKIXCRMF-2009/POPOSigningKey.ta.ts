...
export class POPOSigningKey {
    ...
    public static _from_object(_o: {
        [_K in keyof POPOSigningKey]: POPOSigningKey[_K];
    }): POPOSigningKey {
...
let _cached_decoder_for_POPOSigningKey: $.ASN1Decoder<POPOSigningKey> | null =
    null;
...
let _cached_encoder_for_POPOSigningKey: $.ASN1Encoder<POPOSigningKey> | null =
    null;
