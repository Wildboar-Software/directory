...
export class EncryptedValue {
    ...
    public static _from_object(_o: {
        [_K in keyof EncryptedValue]: EncryptedValue[_K];
    }): EncryptedValue {
...
let _cached_decoder_for_EncryptedValue: $.ASN1Decoder<EncryptedValue> | null =
    null;
 ...
 */
export function _decode_EncryptedValue(el: _Element) {
...
let _cached_encoder_for_EncryptedValue: $.ASN1Encoder<EncryptedValue> | null =
    null;
