 ...
 */
export function _decode_UTF8Pairs(el: _Element) {
    if (!_cached_decoder_for_UTF8Pairs) {
        _cached_decoder_for_UTF8Pairs = $._decodeUTF8String;
    }
 ...
 */
export function _encode_UTF8Pairs(
    value: UTF8Pairs,
    elGetter: $.ASN1Encoder<UTF8Pairs>
) {
    if (!_cached_encoder_for_UTF8Pairs) {
        _cached_encoder_for_UTF8Pairs = $._encodeUTF8String;
    }
