...
let _cached_decoder_for_KeyGenParameters: $.ASN1Decoder<KeyGenParameters> | null =
    null;
 ...
 */
export function _decode_KeyGenParameters(el: _Element) {
    if (!_cached_decoder_for_KeyGenParameters) {
        _cached_decoder_for_KeyGenParameters = $._decodeOctetString;
    }
...
let _cached_encoder_for_KeyGenParameters: $.ASN1Encoder<KeyGenParameters> | null =
    null;
 ...
 */
export function _encode_KeyGenParameters(
    value: KeyGenParameters,
    elGetter: $.ASN1Encoder<KeyGenParameters>
) {
    if (!_cached_encoder_for_KeyGenParameters) {
        _cached_encoder_for_KeyGenParameters = $._encodeOctetString;
    }
