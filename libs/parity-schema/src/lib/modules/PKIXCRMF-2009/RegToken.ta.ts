 ...
 */
export function _decode_RegToken(el: _Element) {
    if (!_cached_decoder_for_RegToken) {
        _cached_decoder_for_RegToken = $._decodeUTF8String;
    }
 ...
 */
export function _encode_RegToken(
    value: RegToken,
    elGetter: $.ASN1Encoder<RegToken>
) {
    if (!_cached_encoder_for_RegToken) {
        _cached_encoder_for_RegToken = $._encodeUTF8String;
    }
