 ...
 */
export
type Controls = AttributeTypeAndValue[]; // SequenceOfType
...
function _decode_Controls (el: _Element) {
    if (!_cached_decoder_for_Controls) { _cached_decoder_for_Controls = $._decodeSequenceOf<AttributeTypeAndValue>(() => _decode_AttributeTypeAndValue); }
...
function _encode_Controls (value: Controls, elGetter: $.ASN1Encoder<Controls>) {
    if (!_cached_encoder_for_Controls) { _cached_encoder_for_Controls = $._encodeSequenceOf<AttributeTypeAndValue>(() => _encode_AttributeTypeAndValue, $.BER); }
