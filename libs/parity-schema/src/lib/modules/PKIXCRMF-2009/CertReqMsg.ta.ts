...
import { AttributeTypeAndValue, _decode_AttributeTypeAndValue, _encode_AttributeTypeAndValue } from "@wildboar/x500/src/lib/modules/InformationFramework/AttributeTypeAndValue.ta";
export { AttributeTypeAndValue, _decode_AttributeTypeAndValue, _encode_AttributeTypeAndValue } from "@wildboar/x500/src/lib/modules/InformationFramework/AttributeTypeAndValue.ta";
...
class CertReqMsg {
     ...
     * @returns {CertReqMsg}
     */
    public static _from_object (_o: { [_K in keyof (CertReqMsg)]: (CertReqMsg)[_K] }): CertReqMsg {
 ...
 */
export
const _root_component_type_list_1_spec_for_CertReqMsg: $.ComponentSpec[] = [
    new $.ComponentSpec("certReq", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("popo", true, $.or($.hasTag(_TagClass.context, 0), $.hasTag(_TagClass.context, 1), $.hasTag(_TagClass.context, 2), $.hasTag(_TagClass.context, 3)), undefined, undefined),
    new $.ComponentSpec("regInfo", true, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
 ...
 */
export
function _decode_CertReqMsg (el: _Element) {
    if (!_cached_decoder_for_CertReqMsg) { _cached_decoder_for_CertReqMsg = function (el: _Element): CertReqMsg {
    ...
    const callbacks: $.DecodingMap = {
        "certReq": (_el: _Element): void => { certReq = _decode_CertRequest(_el); },
        "popo": (_el: _Element): void => { popo = _decode_ProofOfPossession(_el); },
        "regInfo": (_el: _Element): void => { regInfo = $._decodeSequenceOf<AttributeTypeAndValue>(() => _decode_AttributeTypeAndValue)(_el); }
    };
 ...
 */
export
function _encode_CertReqMsg (value: CertReqMsg, elGetter: $.ASN1Encoder<CertReqMsg>) {
    if (!_cached_encoder_for_CertReqMsg) { _cached_encoder_for_CertReqMsg = function (value: CertReqMsg, elGetter: $.ASN1Encoder<CertReqMsg>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_CertRequest(value.certReq, $.BER),
            /* IF_ABSENT  */ ((value.popo === undefined) ? undefined : _encode_ProofOfPossession(value.popo, $.BER)),
            /* IF_ABSENT  */ ((value.regInfo === undefined) ? undefined : $._encodeSequenceOf<AttributeTypeAndValue>(() => _encode_AttributeTypeAndValue, $.BER)(value.regInfo, $.BER))
        ],
