...
} from '../PKIXCRMF-2009/SinglePubInfo-pubMethod.ta';
...
export class SinglePubInfo {
    ...
    public static _from_object(_o: {
        [_K in keyof SinglePubInfo]: SinglePubInfo[_K];
    }): SinglePubInfo {
...
let _cached_decoder_for_SinglePubInfo: $.ASN1Decoder<SinglePubInfo> | null =
    null;
...
let _cached_encoder_for_SinglePubInfo: $.ASN1Encoder<SinglePubInfo> | null =
    null;
