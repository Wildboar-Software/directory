...
import { SinglePubInfo_pubMethod, SinglePubInfo_pubMethod_dontCare /* IMPORTED_LONG_NAMED_INTEGER */, dontCare /* IMPORTED_SHORT_NAMED_INTEGER */, SinglePubInfo_pubMethod_x500 /* IMPORTED_LONG_NAMED_INTEGER */, x500 /* IMPORTED_SHORT_NAMED_INTEGER */, SinglePubInfo_pubMethod_web /* IMPORTED_LONG_NAMED_INTEGER */, web /* IMPORTED_SHORT_NAMED_INTEGER */, SinglePubInfo_pubMethod_ldap /* IMPORTED_LONG_NAMED_INTEGER */, ldap /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_SinglePubInfo_pubMethod, _encode_SinglePubInfo_pubMethod } from "../PKIXCRMF-2009/SinglePubInfo-pubMethod.ta";
...
const _root_component_type_list_1_spec_for_SinglePubInfo: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("pubLocation", true, $.or($.hasTag(_TagClass.context, 0), $.hasTag(_TagClass.context, 1), $.hasTag(_TagClass.context, 2), $.hasAnyTag, $.hasTag(_TagClass.context, 4), $.hasTag(_TagClass.context, 5), $.hasTag(_TagClass.context, 6), $.hasTag(_TagClass.context, 7), $.hasTag(_TagClass.context, 8)), undefined, undefined)
];
