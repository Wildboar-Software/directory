...
export { Authenticator, _decode_Authenticator, _encode_Authenticator } from "../PKIXCRMF-2009/Authenticator.ta";
import { id_regCtrl_authenticator } from "../PKIXCRMF-2009/id-regCtrl-authenticator.va";
export { id_regCtrl_authenticator } from "../PKIXCRMF-2009/id-regCtrl-authenticator.va";
