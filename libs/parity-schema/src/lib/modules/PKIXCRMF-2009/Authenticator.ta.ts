...
let _cached_decoder_for_Authenticator: $.ASN1Decoder<Authenticator> | null =
    null;
...
export function _decode_Authenticator(el: _Element) {
    if (!_cached_decoder_for_Authenticator) {
        _cached_decoder_for_Authenticator = $._decodeUTF8String;
    }
...
let _cached_encoder_for_Authenticator: $.ASN1Encoder<Authenticator> | null =
    null;
...
export function _encode_Authenticator(
    ...
    if (!_cached_encoder_for_Authenticator) {
        _cached_encoder_for_Authenticator = $._encodeUTF8String;
    }
