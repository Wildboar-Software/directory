...
export class PrivateKeyInfo {
    ...
    public static _from_object(_o: {
        [_K in keyof PrivateKeyInfo]: PrivateKeyInfo[_K];
    }): PrivateKeyInfo {
...
let _cached_decoder_for_PrivateKeyInfo: $.ASN1Decoder<PrivateKeyInfo> | null =
    null;
...
let _cached_encoder_for_PrivateKeyInfo: $.ASN1Encoder<PrivateKeyInfo> | null =
    null;
