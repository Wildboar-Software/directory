 ...
 */
export
const uniqueIdentifier: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uniqueIdentifier"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: unique identifer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([44,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
