...
/* START_OF_SYMBOL_DEFINITION documentTitle */
/**
 ...
 */
export
const documentTitle: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["documentTitle"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: title of document." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([12,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION documentTitle */
