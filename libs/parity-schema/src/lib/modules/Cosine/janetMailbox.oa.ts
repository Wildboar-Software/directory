...
/* START_OF_SYMBOL_DEFINITION janetMailbox */
/**
 * @summary janetMailbox
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const janetMailbox: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["janetMailbox"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: Janet mailbox" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([46,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION janetMailbox */
