...
/* START_OF_SYMBOL_DEFINITION favouriteDrink */
/**
 * @summary favouriteDrink
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const favouriteDrink: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["favoriteDrink","favouriteDrink","drink"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: favorite drink." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([5,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION favouriteDrink */
