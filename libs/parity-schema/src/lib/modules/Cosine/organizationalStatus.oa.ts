...
/* START_OF_SYMBOL_DEFINITION organizationalStatus */
/**
 * @summary organizationalStatus
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const organizationalStatus: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["organizationalStatus"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: organizational status." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([45,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION organizationalStatus */
