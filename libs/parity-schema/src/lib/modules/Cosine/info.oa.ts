...
/* START_OF_SYMBOL_DEFINITION info */
/**
 * @summary info
 * @description
 *
 ...
 */
export
const info: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["info"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: general information." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
