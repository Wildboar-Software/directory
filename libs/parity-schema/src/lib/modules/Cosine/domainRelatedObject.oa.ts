 ...
 */
export
const domainRelatedObject: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&ldapDesc": "RFC1274: an object related to an domain." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([17,], pilotObjectClass) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
