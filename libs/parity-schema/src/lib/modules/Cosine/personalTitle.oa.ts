...
/* START_OF_SYMBOL_DEFINITION personalTitle */
/**
 * @summary personalTitle
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const personalTitle: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["personalTitle"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: personal title." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([40,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION personalTitle */
