...
/* START_OF_SYMBOL_DEFINITION documentPublisher */
/**
 * @summary documentPublisher
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const documentPublisher: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["documentPublisher"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: publisher of document." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([56,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION documentPublisher */
