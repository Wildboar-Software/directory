...
/* START_OF_SYMBOL_DEFINITION nSRecord */
/**
 * @summary nSRecord
 * @description
 * 
 ...
 */
export
const nSRecord: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["nSRecord"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([0, 9, 2342, 19200300, 100, 1, 29,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION nSRecord */
