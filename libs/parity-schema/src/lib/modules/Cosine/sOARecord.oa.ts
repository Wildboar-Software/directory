...
/* START_OF_SYMBOL_DEFINITION sOARecord */
/**
 * @summary sOARecord
 * @description
 * 
 ...
 */
export
const sOARecord: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sOARecord"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([0, 9, 2342, 19200300, 100, 1, 30,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sOARecord */
