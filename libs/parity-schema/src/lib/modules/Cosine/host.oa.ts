...
/* START_OF_SYMBOL_DEFINITION host */
/**
 * @summary host
 * @description
 *
 ...
 */
export
const host: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["host"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: host computer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
