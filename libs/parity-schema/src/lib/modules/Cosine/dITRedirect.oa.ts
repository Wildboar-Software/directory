...
/* START_OF_SYMBOL_DEFINITION dITRedirect */
/**
 * @summary dITRedirect
 * @description
 *
 ...
 */
export
const dITRedirect: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dITRedirect"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: DIT Redirect." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([54,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dITRedirect */
