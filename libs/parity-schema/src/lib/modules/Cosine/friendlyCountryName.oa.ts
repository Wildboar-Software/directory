...
/* START_OF_SYMBOL_DEFINITION friendlyCountryName */
/**
 * @summary friendlyCountryName
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const friendlyCountryName: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["friendlyCountryName","co"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: friendly country name." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([43,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION friendlyCountryName */
