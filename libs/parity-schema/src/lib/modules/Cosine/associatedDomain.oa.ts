 ...
 */
export
const associatedDomain: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["associatedDomain"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([37,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
