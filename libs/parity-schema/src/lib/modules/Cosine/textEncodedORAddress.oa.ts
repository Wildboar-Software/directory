...
/* START_OF_SYMBOL_DEFINITION textEncodedORAddress */
/**
 * @summary textEncodedORAddress
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const textEncodedORAddress: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["textEncodedORAddress"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Text encoding of an X.400 O/R address, as specified in RFC 987." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION textEncodedORAddress */
