 ...
 */
export
const documentVersion: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["documentVersion"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: version of document." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([13,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
