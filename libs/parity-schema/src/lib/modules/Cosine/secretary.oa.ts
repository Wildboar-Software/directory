...
/* START_OF_SYMBOL_DEFINITION secretary */
/**
 * @summary secretary
 * @description
 *
 ...
 */
export
const secretary: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["secretary"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: DN of secretary." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([21,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION secretary */
