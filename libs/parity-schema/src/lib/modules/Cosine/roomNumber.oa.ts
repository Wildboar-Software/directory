...
/* START_OF_SYMBOL_DEFINITION roomNumber */
/**
 * @summary roomNumber
 * @description
 *
 ...
 */
export
const roomNumber: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["roomNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: room number." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION roomNumber */
