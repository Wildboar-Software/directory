...
/* START_OF_SYMBOL_DEFINITION documentLocation */
/**
 * @summary documentLocation
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const documentLocation: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["documentLocation"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: location of document original." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([15,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION documentLocation */
