...
/* START_OF_SYMBOL_DEFINITION documentIdentifier */
/**
 ...
 */
export
const documentIdentifier: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["documentIdentifier"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: unique identifier of document." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([11,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION documentIdentifier */
