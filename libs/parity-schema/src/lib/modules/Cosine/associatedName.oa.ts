...
/* START_OF_SYMBOL_DEFINITION associatedName */
/**
 * @summary associatedName
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const associatedName: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["associatedName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: DN of entry associated with domain." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([38,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION associatedName */
