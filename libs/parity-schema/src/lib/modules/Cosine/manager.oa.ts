...
/* START_OF_SYMBOL_DEFINITION manager */
/**
 * @summary manager
 * @description
 *
 ...
 */
export
const manager: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["manager"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: DN of manager." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION manager */
