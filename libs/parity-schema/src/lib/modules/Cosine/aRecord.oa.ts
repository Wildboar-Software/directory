...
/* START_OF_SYMBOL_DEFINITION aRecord */
/**
 * @summary aRecord
 * @description
 * 
 ...
 */
export
const aRecord: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["aRecord"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([0, 9, 2342, 19200300, 100, 1, 26,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION aRecord */
