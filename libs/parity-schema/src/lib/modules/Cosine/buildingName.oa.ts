...
/* START_OF_SYMBOL_DEFINITION buildingName */
/**
 ...
 */
export
const buildingName: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["buildingName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: name of building." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([48,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION buildingName */
