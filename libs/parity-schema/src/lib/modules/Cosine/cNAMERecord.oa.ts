...
/* START_OF_SYMBOL_DEFINITION cNAMERecord */
/**
 * @summary cNAMERecord
 * @description
 * 
 ...
 */
export
const cNAMERecord: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["cNAMERecord"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([0, 9, 2342, 19200300, 100, 1, 31,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION cNAMERecord */
