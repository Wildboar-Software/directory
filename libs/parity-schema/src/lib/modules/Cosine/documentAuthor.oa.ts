...
/* START_OF_SYMBOL_DEFINITION documentAuthor */
/**
 * @summary documentAuthor
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const documentAuthor: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["documentAuthor"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC1274: DN of author of document." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([14,], pilotAttributeType) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION documentAuthor */
