...
export { id_at_defaultChargingReference } from "../UPT-DataModel/id-at-defaultChargingReference.va";


/* START_OF_SYMBOL_DEFINITION defaultChargingReference */
/**
 * @summary defaultChargingReference
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const defaultChargingReference: ATTRIBUTE<IsdnAddress> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_at_defaultChargingReference /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION defaultChargingReference */
