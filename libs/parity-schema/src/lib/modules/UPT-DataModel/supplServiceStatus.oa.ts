...
import { SupplServiceStatus, SupplServiceStatus_provisioned /* IMPORTED_LONG_NAMED_BIT */, provisioned /* IMPORTED_SHORT_NAMED_BIT */, SupplServiceStatus_registered /* IMPORTED_LONG_NAMED_BIT */, registered /* IMPORTED_SHORT_NAMED_BIT */, SupplServiceStatus_activated /* IMPORTED_LONG_NAMED_BIT */, activated /* IMPORTED_SHORT_NAMED_BIT */, _decode_SupplServiceStatus, _encode_SupplServiceStatus } from "../UPT-DataModel/SupplServiceStatus.ta";
export { SupplServiceStatus, SupplServiceStatus_provisioned /* IMPORTED_LONG_NAMED_BIT */, provisioned /* IMPORTED_SHORT_NAMED_BIT */, SupplServiceStatus_registered /* IMPORTED_LONG_NAMED_BIT */, registered /* IMPORTED_SHORT_NAMED_BIT */, SupplServiceStatus_activated /* IMPORTED_LONG_NAMED_BIT */, activated /* IMPORTED_SHORT_NAMED_BIT */, _decode_SupplServiceStatus, _encode_SupplServiceStatus } from "../UPT-DataModel/SupplServiceStatus.ta";
import { id_at_supplServiceStatus } from "../UPT-DataModel/id-at-supplServiceStatus.va";
export { id_at_supplServiceStatus } from "../UPT-DataModel/id-at-supplServiceStatus.va";
 ...
 */
export
const supplServiceStatus: ATTRIBUTE<SupplServiceStatus> = {
    class: "ATTRIBUTE",
    decoderFor: {
