...
import { ub_providerId } from "../UPT-DataModel/ub-providerId.va";
export { ub_providerId } from "../UPT-DataModel/ub-providerId.va";
...
export { id_at_providerId } from "../UPT-DataModel/id-at-providerId.va";
 ...
 */
export
const providerId: ATTRIBUTE<AddressString> = {
    class: "ATTRIBUTE",
    decoderFor: {
