...
import {
    ...
    _decode_Currency,
    _encode_Currency,
} from '../UPT-DataModel/Currency.ta';
...
let _cached_decoder_for_CurrencyValue: $.ASN1Decoder<CurrencyValue> | null =
    null;
 ...
 */
export function _decode_CurrencyValue(el: _Element) {
    if (!_cached_decoder_for_CurrencyValue) {
        _cached_decoder_for_CurrencyValue =
            $._decode_inextensible_choice<CurrencyValue>({
                'CONTEXT 0': [
                    'usDollar',
                    $._decode_implicit<Currency>(() => _decode_Currency),
                ],
                'CONTEXT 1': [
                    'frenchFranc',
                    $._decode_implicit<Currency>(() => _decode_Currency),
...
let _cached_encoder_for_CurrencyValue: $.ASN1Encoder<CurrencyValue> | null =
    null;
 ...
 */
export function _encode_CurrencyValue(
    value: CurrencyValue,
    elGetter: $.ASN1Encoder<CurrencyValue>
) {
    if (!_cached_encoder_for_CurrencyValue) {
        _cached_encoder_for_CurrencyValue = $._encode_choice<CurrencyValue>(
            {
                usDollar: $._encode_implicit(
                    _TagClass.context,
                    0,
                    () => _encode_Currency,
                    $.BER
                ),
                frenchFranc: $._encode_implicit(
                    _TagClass.context,
                    1,
                    () => _encode_Currency,
                    $.BER
                ),
                germanMark: $._encode_implicit(
                    _TagClass.context,
                    2,
                    () => _encode_Currency,
                    $.BER
                ),
                dutchGuilder: $._encode_implicit(
                    _TagClass.context,
                    3,
                    () => _encode_Currency,
                    $.BER
                ),
                italianLira: $._encode_implicit(
                    _TagClass.context,
                    4,
                    () => _encode_Currency,
                    $.BER
                ),
                englishPound: $._encode_implicit(
                    _TagClass.context,
                    5,
                    () => _encode_Currency,
                    $.BER
                ),
                spanishPeseta: $._encode_implicit(
                    _TagClass.context,
                    6,
                    () => _encode_Currency,
                    $.BER
                ),
                swedishKrone: $._encode_implicit(
                    _TagClass.context,
                    7,
                    () => _encode_Currency,
                    $.BER
                ),
                norwegianKrone: $._encode_implicit(
                    _TagClass.context,
                    8,
                    () => _encode_Currency,
                    $.BER
                ),
                japaneseYen: $._encode_implicit(
                    _TagClass.context,
                    9,
                    () => _encode_Currency,
                    $.BER
