 ...
 * ```
 */
export type IsdnAddress = AddressString; // DefinedType
...
export function _decode_IsdnAddress(el: _Element) {
    if (!_cached_decoder_for_IsdnAddress) {
        _cached_decoder_for_IsdnAddress = _decode_AddressString;
    }
...
export function _encode_IsdnAddress(
    ...
    if (!_cached_encoder_for_IsdnAddress) {
        _cached_encoder_for_IsdnAddress = _encode_AddressString;
    }
