...
import { CallInfoRecord, _decode_CallInfoRecord, _encode_CallInfoRecord } from "../UPT-DataModel/CallInfoRecord.ta";
export { CallInfoRecord, _decode_CallInfoRecord, _encode_CallInfoRecord } from "../UPT-DataModel/CallInfoRecord.ta";
 ...
 */
export
const callInfoRecords: ATTRIBUTE<CallInfoRecord> = {
    class: "ATTRIBUTE",
    decoderFor: {
