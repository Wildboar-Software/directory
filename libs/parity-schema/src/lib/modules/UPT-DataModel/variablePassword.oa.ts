...
import { id_at_variablePassword } from '../UPT-DataModel/id-at-variablePassword.va';
...
export { id_at_variablePassword } from '../UPT-DataModel/id-at-variablePassword.va';

/* START_OF_SYMBOL_DEFINITION variablePassword */
/**
 * @summary variablePassword
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const variablePassword: ATTRIBUTE<OCTET_STRING> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_variablePassword /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION variablePassword */
