...
import { ub_pui } from "../UPT-DataModel/ub-pui.va";
export { ub_pui } from "../UPT-DataModel/ub-pui.va";
...
export { id_at_pui } from "../UPT-DataModel/id-at-pui.va";
 ...
 */
export
const pui: ATTRIBUTE<AddressString> = {
    class: "ATTRIBUTE",
    decoderFor: {
