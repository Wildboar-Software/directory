...
import { AddressString, _decode_AddressString, _encode_AddressString } from "../UPT-DataModel/AddressString.ta";
export { AddressString, _decode_AddressString, _encode_AddressString } from "../UPT-DataModel/AddressString.ta";
import { ub_international_isdn_number } from "@wildboar/x500/src/lib/modules/UpperBounds/ub-international-isdn-number.va";
export { ub_international_isdn_number } from "@wildboar/x500/src/lib/modules/UpperBounds/ub-international-isdn-number.va";
...
export { storedPrefixMatch } from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/storedPrefixMatch.oa";
import { id_at_allowedRegistrationAddress } from "../UPT-DataModel/id-at-allowedRegistrationAddress.va";
export { id_at_allowedRegistrationAddress } from "../UPT-DataModel/id-at-allowedRegistrationAddress.va";
 ...
 */
export
const allowedRegistrationAddress: ATTRIBUTE<AddressString> = {
    class: "ATTRIBUTE",
    decoderFor: {
