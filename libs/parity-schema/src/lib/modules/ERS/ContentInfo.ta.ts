...
class ContentInfo {
     ...
     * @returns {ContentInfo}
     */
    public static _from_object (_o: { [_K in keyof (ContentInfo)]: (ContentInfo)[_K] }): ContentInfo {
 ...
 */
export
const _root_component_type_list_1_spec_for_ContentInfo: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ContentInfo: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ContentInfo: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ContentInfo (el: _Element) {
    if (!_cached_decoder_for_ContentInfo) { _cached_decoder_for_ContentInfo = function (el: _Element): ContentInfo {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("ContentInfo contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_ContentInfo (value: ContentInfo, elGetter: $.ASN1Encoder<ContentInfo>) {
    if (!_cached_encoder_for_ContentInfo) { _cached_encoder_for_ContentInfo = function (value: ContentInfo, elGetter: $.ASN1Encoder<ContentInfo>): _Element {
