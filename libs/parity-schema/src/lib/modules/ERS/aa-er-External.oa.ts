...
import { EvidenceRecord, _decode_EvidenceRecord, _encode_EvidenceRecord } from "../ERS/EvidenceRecord.ta";
export { EvidenceRecord, _decode_EvidenceRecord, _encode_EvidenceRecord } from "../ERS/EvidenceRecord.ta";
import { id_aa_er_external } from "../ERS/id-aa-er-external.va";
export { id_aa_er_external } from "../ERS/id-aa-er-external.va";
 ...
 */
export
const aa_er_External: ATTRIBUTE<EvidenceRecord> = {
    class: "ATTRIBUTE",
    decoderFor: {
