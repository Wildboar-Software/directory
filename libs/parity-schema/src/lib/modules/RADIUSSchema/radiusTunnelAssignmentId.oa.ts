...
/* START_OF_SYMBOL_DEFINITION radiusTunnelAssignmentId */
/**
 * @summary radiusTunnelAssignmentId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelAssignmentId ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelAssignmentId" }
 *     ID                          { id-at-freeRadius 4 1 2 1 35 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelAssignmentId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelAssignmentId"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 35,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelAssignmentId */
