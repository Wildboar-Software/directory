...
/* START_OF_SYMBOL_DEFINITION radiusFilterId */
/**
 * @summary radiusFilterId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFilterId ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFilterId" }
 *     LDAP-DESC                   "replyItem: Filter-Id"
 *     ID                          { id-at-freeRadius 4 1 2 1 9 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFilterId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFilterId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Filter-Id" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 9,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFilterId */
