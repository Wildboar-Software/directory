...
/* START_OF_SYMBOL_DEFINITION radiusFramedRoute */
/**
 * @summary radiusFramedRoute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedRoute ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedRoute" }
 *     LDAP-DESC                   "replyItem: Framed-Route"
 *     ID                          { id-at-freeRadius 4 1 2 1 19 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedRoute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedRoute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-Route" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 19,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedRoute */
