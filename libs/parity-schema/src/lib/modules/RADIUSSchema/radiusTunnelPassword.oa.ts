...
/* START_OF_SYMBOL_DEFINITION radiusTunnelPassword */
/**
 * @summary radiusTunnelPassword
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelPassword ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelPassword" }
 *     ID                          { id-at-freeRadius 4 1 2 1 37 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelPassword: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelPassword"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 37,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelPassword */
