...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv6PoolNamePD */
/**
 * @summary freeradiusDhcpv6PoolNamePD
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv6PoolNamePD ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv6PoolNamePD" }
 *     LDAP-DESC                   "DHCPv6 IP PD pool name"
 *     ID                          { id-at-freeRadius 4 3 1 1 4 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv6PoolNamePD: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv6PoolNamePD"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "DHCPv6 IP PD pool name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3, 1, 1, 4,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv6PoolNamePD */
