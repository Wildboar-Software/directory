...
/* START_OF_SYMBOL_DEFINITION radiusNASPortId */
/**
 * @summary radiusNASPortId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusNASPortId ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusNASPortId" }
 *     ID                          { id-at-freeRadius 4 1 3 1 81 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusNASPortId: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusNASPortId"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 81,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusNASPortId */
