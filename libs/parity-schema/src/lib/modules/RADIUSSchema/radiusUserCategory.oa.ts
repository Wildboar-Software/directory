...
/* START_OF_SYMBOL_DEFINITION radiusUserCategory */
/**
 * @summary radiusUserCategory
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusUserCategory ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusUserCategory" }
 *     ID                          { id-at-freeRadius 4 1 2 1 55 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusUserCategory: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusUserCategory"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 55,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusUserCategory */
