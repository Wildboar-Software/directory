...
/* START_OF_SYMBOL_DEFINITION radiusCallbackId */
/**
 * @summary radiusCallbackId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusCallbackId ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusCallbackId" }
 *     LDAP-DESC                   "replyItem: Callback-Id"
 *     ID                          { id-at-freeRadius 4 1 2 1 4 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusCallbackId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusCallbackId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Callback-Id" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 4,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusCallbackId */
