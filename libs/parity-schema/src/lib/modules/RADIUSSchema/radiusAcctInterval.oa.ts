...
/* START_OF_SYMBOL_DEFINITION radiusAcctInterval */
/**
 * @summary radiusAcctInterval
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctInterval ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctInterval" }
 *     ID                          { id-at-freeRadius 4 1 3 1 68 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctInterval: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctInterval"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 68,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctInterval */
