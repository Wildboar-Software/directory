...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv4PoolName */
/**
 * @summary freeradiusDhcpv4PoolName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv4PoolName ATTRIBUTE ::= {
 ...
 *     LDAP-NAME                   { "freeradiusDhcpv4PoolName" }
 *     LDAP-DESC                   "DHCP IP pool name"
 *     ID                          { id-at-freeRadius 4 2 1 1 3 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv4PoolName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv4PoolName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "DHCP IP pool name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 2, 1, 1, 3,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv4PoolName */
