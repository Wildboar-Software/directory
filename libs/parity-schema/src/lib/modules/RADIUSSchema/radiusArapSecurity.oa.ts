...
/* START_OF_SYMBOL_DEFINITION radiusArapSecurity */
/**
 * @summary radiusArapSecurity
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusArapSecurity ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusArapSecurity" }
 *     ID                          { id-at-freeRadius 4 1 2 1 2 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusArapSecurity: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusArapSecurity"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 2,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusArapSecurity */
