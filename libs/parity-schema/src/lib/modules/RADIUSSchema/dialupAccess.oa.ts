...
/* START_OF_SYMBOL_DEFINITION dialupAccess */
/**
 * @summary dialupAccess
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 *     LDAP-NAME                   { "dialupAccess" }
 *     ID                          { id-at-freeRadius 4 1 2 1 57 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const dialupAccess: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dialupAccess"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 57,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dialupAccess */
