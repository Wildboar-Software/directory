...
/* START_OF_SYMBOL_DEFINITION radiusNASIdentifier */
/**
 * @summary radiusNASIdentifier
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusNASIdentifier ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusNASIdentifier" }
 *     ID                          { id-at-freeRadius 4 1 3 1 79 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusNASIdentifier: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusNASIdentifier"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 79,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusNASIdentifier */
