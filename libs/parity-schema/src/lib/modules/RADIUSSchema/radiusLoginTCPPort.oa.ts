...
/* START_OF_SYMBOL_DEFINITION radiusLoginTCPPort */
/**
 * @summary radiusLoginTCPPort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginTCPPort ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginTCPPort" }
 *     LDAP-DESC                   "replyItem: Login-TCP-Port"
 *     ID                          { id-at-freeRadius 4 1 2 1 28 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginTCPPort: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginTCPPort"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-TCP-Port" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 28,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginTCPPort */
