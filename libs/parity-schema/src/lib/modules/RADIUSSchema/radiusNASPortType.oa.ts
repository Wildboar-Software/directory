...
/* START_OF_SYMBOL_DEFINITION radiusNASPortType */
/**
 * @summary radiusNASPortType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusNASPortType ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusNASPortType" }
 *     ID                          { id-at-freeRadius 4 1 3 1 82 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusNASPortType: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusNASPortType"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 82,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusNASPortType */
