...
/* START_OF_SYMBOL_DEFINITION radiusFramedIPAddress */
/**
 * @summary radiusFramedIPAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedIPAddress ATTRIBUTE ::= {
 ...
 *     LDAP-NAME                   { "radiusFramedIPAddress" }
 *     LDAP-DESC                   "replyItem: Framed-IP-Address"
 *     ID                          { id-at-freeRadius 4 1 2 1 14 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedIPAddress: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedIPAddress"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-IP-Address" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 14,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedIPAddress */
