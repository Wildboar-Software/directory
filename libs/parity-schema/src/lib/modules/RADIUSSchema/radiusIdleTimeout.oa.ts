...
/* START_OF_SYMBOL_DEFINITION radiusIdleTimeout */
/**
 * @summary radiusIdleTimeout
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusIdleTimeout ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusIdleTimeout" }
 *     LDAP-DESC                   "replyItem: Idle-Timeout"
 *     ID                          { id-at-freeRadius 4 1 2 1 21 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusIdleTimeout: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusIdleTimeout"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Idle-Timeout" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 21,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusIdleTimeout */
