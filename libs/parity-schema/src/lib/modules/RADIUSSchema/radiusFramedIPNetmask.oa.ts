...
/* START_OF_SYMBOL_DEFINITION radiusFramedIPNetmask */
/**
 * @summary radiusFramedIPNetmask
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 *     LDAP-NAME                   { "radiusFramedIPNetmask" }
 *     LDAP-DESC                   "replyItem: Framed-IP-Netmask"
 *     ID                          { id-at-freeRadius 4 1 2 1 15 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedIPNetmask: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedIPNetmask"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-IP-Netmask" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 15,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedIPNetmask */
