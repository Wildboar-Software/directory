 ...
 */
export
const freeradiusDhcpv6Gateway: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ freeradiusDhcpv6GatewayIdentifier, freeradiusDhcpv6GatewayAddr, freeradiusDhcpv6PoolNameNA, freeradiusDhcpv6PoolNamePD, freeradiusDhcpv6PoolNameTA, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([4, 3, 1, 2, 1,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
