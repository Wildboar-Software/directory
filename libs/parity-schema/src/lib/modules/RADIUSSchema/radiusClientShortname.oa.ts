...
/* START_OF_SYMBOL_DEFINITION radiusClientShortname */
/**
 * @summary radiusClientShortname
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusClientShortname ATTRIBUTE ::= {
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusClientShortname" }
 *     LDAP-DESC                   "Client shortname"
 *     ID                          { id-at-freeRadius 4 1 1 2 4 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusClientShortname: ATTRIBUTE = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": undefined,
    },
    ...
    "&ldapName": ["radiusClientShortname"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Client shortname" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 1, 2, 4,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusClientShortname */
