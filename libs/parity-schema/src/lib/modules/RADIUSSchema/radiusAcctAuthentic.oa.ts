...
/* START_OF_SYMBOL_DEFINITION radiusAcctAuthentic */
/**
 * @summary radiusAcctAuthentic
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctAuthentic ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctAuthentic" }
 *     ID                          { id-at-freeRadius 4 1 3 1 66 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctAuthentic: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctAuthentic"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 66,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctAuthentic */
