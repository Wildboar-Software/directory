...
/* START_OF_SYMBOL_DEFINITION radiusLoginLATGroup */
/**
 * @summary radiusLoginLATGroup
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginLATGroup ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginLATGroup" }
 *     LDAP-DESC                   "replyItem: Login-LAT-Group"
 *     ID                          { id-at-freeRadius 4 1 2 1 23 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginLATGroup: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginLATGroup"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-LAT-Group" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 23,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginLATGroup */
