...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv4Attribute */
/**
 * @summary freeradiusDhcpv4Attribute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv4Attribute ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv4Attribute" }
 *     LDAP-DESC                   "DHCP attribute in format [<list>.]<attr> <op> <value>"
 *     ID                          { id-at-freeRadius 4 2 2 1 4 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv4Attribute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv4Attribute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "DHCP attribute in format [<list>.]<attr> <op> <value>" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 2, 2, 1, 4,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv4Attribute */
