...
/* START_OF_SYMBOL_DEFINITION radiusClientSecret */
/**
 * @summary radiusClientSecret
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusClientSecret ATTRIBUTE ::= {
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusClientSecret" }
 *     LDAP-DESC                   "Client secret"
 *     ID                          { id-at-freeRadius 4 1 1 2 3 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusClientSecret: ATTRIBUTE = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": undefined,
    },
    ...
    "&ldapName": ["radiusClientSecret"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Client secret" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 1, 2, 3,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusClientSecret */
