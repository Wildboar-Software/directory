...
/* START_OF_SYMBOL_DEFINITION radiusAcctStopTime */
/**
 * @summary radiusAcctStopTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctStopTime ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctStopTime" }
 *     ID                          { id-at-freeRadius 4 1 3 1 73 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctStopTime: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctStopTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 73,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctStopTime */
