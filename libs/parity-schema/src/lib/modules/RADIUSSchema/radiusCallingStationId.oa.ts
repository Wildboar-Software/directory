...
/* START_OF_SYMBOL_DEFINITION radiusCallingStationId */
/**
 * @summary radiusCallingStationId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusCallingStationId ATTRIBUTE ::= {
 ...
 *     LDAP-NAME                   { "radiusCallingStationId" }
 *     LDAP-DESC                   "controlItem: Calling-Station-Id"
 *     ID                          { id-at-freeRadius 4 1 2 1 7 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusCallingStationId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusCallingStationId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "controlItem: Calling-Station-Id" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 7,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusCallingStationId */
