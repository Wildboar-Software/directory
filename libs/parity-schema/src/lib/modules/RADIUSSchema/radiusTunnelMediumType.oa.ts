...
/* START_OF_SYMBOL_DEFINITION radiusTunnelMediumType */
/**
 * @summary radiusTunnelMediumType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelMediumType ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelMediumType" }
 *     ID                          { id-at-freeRadius 4 1 2 1 36 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelMediumType: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelMediumType"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 36,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelMediumType */
