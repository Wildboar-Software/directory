...
/* START_OF_SYMBOL_DEFINITION radiusFramedAppleTalkNetwork */
/**
 * @summary radiusFramedAppleTalkNetwork
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedAppleTalkNetwork ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedAppleTalkNetwork" }
 *     LDAP-DESC                   "replyItem: Framed-AppleTalk-Network"
 *     ID                          { id-at-freeRadius 4 1 2 1 11 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedAppleTalkNetwork: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedAppleTalkNetwork"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-AppleTalk-Network" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 11,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedAppleTalkNetwork */
