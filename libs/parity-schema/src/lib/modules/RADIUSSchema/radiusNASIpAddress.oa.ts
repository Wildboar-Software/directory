...
/* START_OF_SYMBOL_DEFINITION radiusNASIpAddress */
/**
 * @summary radiusNASIpAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusNASIpAddress ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusNASIpAddress" }
 *     ID                          { id-at-freeRadius 4 1 2 1 61 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusNASIpAddress: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusNASIpAddress"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 61,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusNASIpAddress */
