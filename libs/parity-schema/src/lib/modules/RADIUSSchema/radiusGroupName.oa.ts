...
/* START_OF_SYMBOL_DEFINITION radiusGroupName */
/**
 * @summary radiusGroupName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusGroupName ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusGroupName" }
 *     ID                          { id-at-freeRadius 4 1 2 1 46 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusGroupName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusGroupName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 46,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusGroupName */
