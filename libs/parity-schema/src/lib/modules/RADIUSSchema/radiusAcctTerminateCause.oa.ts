...
/* START_OF_SYMBOL_DEFINITION radiusAcctTerminateCause */
/**
 * @summary radiusAcctTerminateCause
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctTerminateCause ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctTerminateCause" }
 *     ID                          { id-at-freeRadius 4 1 3 1 74 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctTerminateCause: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctTerminateCause"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 74,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctTerminateCause */
