...
/* START_OF_SYMBOL_DEFINITION radiusAcctSessionTime */
/**
 * @summary radiusAcctSessionTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctSessionTime ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctSessionTime" }
 *     ID                          { id-at-freeRadius 4 1 3 1 71 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctSessionTime: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctSessionTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 71,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctSessionTime */
