...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv4GatewayIdentifier */
/**
 * @summary freeradiusDhcpv4GatewayIdentifier
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv4GatewayIdentifier ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv4GatewayIdentifier" }
 *     LDAP-DESC                   "Usually Option 82 Remote ID"
 *     ID                          { id-at-freeRadius 4 2 1 1 1 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv4GatewayIdentifier: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv4GatewayIdentifier"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Usually Option 82 Remote ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 2, 1, 1, 1,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv4GatewayIdentifier */
