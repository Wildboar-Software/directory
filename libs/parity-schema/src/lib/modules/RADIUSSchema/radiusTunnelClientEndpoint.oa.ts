...
/* START_OF_SYMBOL_DEFINITION radiusTunnelClientEndpoint */
/**
 * @summary radiusTunnelClientEndpoint
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelClientEndpoint ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelClientEndpoint" }
 *     ID                          { id-at-freeRadius 4 1 2 1 43 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelClientEndpoint: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelClientEndpoint"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 43,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelClientEndpoint */
