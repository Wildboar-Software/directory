...
/* START_OF_SYMBOL_DEFINITION radiusTunnelServerEndpoint */
/**
 * @summary radiusTunnelServerEndpoint
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelServerEndpoint ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelServerEndpoint" }
 *     ID                          { id-at-freeRadius 4 1 2 1 40 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelServerEndpoint: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelServerEndpoint"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 40,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelServerEndpoint */
