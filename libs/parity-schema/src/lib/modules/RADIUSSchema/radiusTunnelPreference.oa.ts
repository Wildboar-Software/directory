...
/* START_OF_SYMBOL_DEFINITION radiusTunnelPreference */
/**
 * @summary radiusTunnelPreference
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelPreference ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelPreference" }
 *     ID                          { id-at-freeRadius 4 1 2 1 38 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelPreference: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelPreference"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 38,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelPreference */
