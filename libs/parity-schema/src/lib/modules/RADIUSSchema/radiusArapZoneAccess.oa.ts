...
/* START_OF_SYMBOL_DEFINITION radiusArapZoneAccess */
/**
 * @summary radiusArapZoneAccess
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusArapZoneAccess ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusArapZoneAccess" }
 *     ID                          { id-at-freeRadius 4 1 2 1 3 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusArapZoneAccess: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusArapZoneAccess"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 3,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusArapZoneAccess */
