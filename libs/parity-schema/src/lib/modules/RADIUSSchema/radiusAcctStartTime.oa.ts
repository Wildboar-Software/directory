...
/* START_OF_SYMBOL_DEFINITION radiusAcctStartTime */
/**
 * @summary radiusAcctStartTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctStartTime ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctStartTime" }
 *     ID                          { id-at-freeRadius 4 1 3 1 72 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctStartTime: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctStartTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 72,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctStartTime */
