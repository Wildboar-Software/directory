...
/* START_OF_SYMBOL_DEFINITION radiusSessionTimeout */
/**
 * @summary radiusSessionTimeout
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusSessionTimeout ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusSessionTimeout" }
 *     LDAP-DESC                   "replyItem: Session-Timeout"
 *     ID                          { id-at-freeRadius 4 1 2 1 33 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusSessionTimeout: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusSessionTimeout"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Session-Timeout" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 33,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusSessionTimeout */
