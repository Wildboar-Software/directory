...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv6GatewayAddr */
/**
 * @summary freeradiusDhcpv6GatewayAddr
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv6GatewayAddr ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv6GatewayAddr" }
 *     LDAP-DESC                   "Gateway IP address"
 *     ID                          { id-at-freeRadius 4 3 1 1 2 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv6GatewayAddr: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv6GatewayAddr"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Gateway IP address" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3, 1, 1, 2,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv6GatewayAddr */
