...
/* START_OF_SYMBOL_DEFINITION radiusAcctUpdateTime */
/**
 * @summary radiusAcctUpdateTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctUpdateTime ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctUpdateTime" }
 *     ID                          { id-at-freeRadius 4 1 3 1 76 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctUpdateTime: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctUpdateTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 76,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctUpdateTime */
