...
/* START_OF_SYMBOL_DEFINITION radiusControlAttribute */
/**
 * @summary radiusControlAttribute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusControlAttribute ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusControlAttribute" }
 *     LDAP-DESC                   "controlItem: $GENERIC$"
 *     ID                          { id-at-freeRadius 4 1 2 1 63 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusControlAttribute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusControlAttribute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "controlItem: $GENERIC$" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 63,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusControlAttribute */
