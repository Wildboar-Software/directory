...
/* START_OF_SYMBOL_DEFINITION radiusFramedCompression */
/**
 * @summary radiusFramedCompression
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedCompression ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedCompression" }
 *     LDAP-DESC                   "replyItem: Framed-Compression"
 *     ID                          { id-at-freeRadius 4 1 2 1 13 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedCompression: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedCompression"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-Compression" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 13,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedCompression */
