...
/* START_OF_SYMBOL_DEFINITION radiusLoginLATPort */
/**
 * @summary radiusLoginLATPort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginLATPort ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginLATPort" }
 *     LDAP-DESC                   "replyItem: Login-LAT-Port"
 *     ID                          { id-at-freeRadius 4 1 2 1 25 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginLATPort: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginLATPort"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-LAT-Port" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 25,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginLATPort */
