...
/* START_OF_SYMBOL_DEFINITION radiusLoginIPHost */
/**
 * @summary radiusLoginIPHost
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginIPHost ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginIPHost" }
 *     LDAP-DESC                   "replyItem: Login-IP-Host"
 *     ID                          { id-at-freeRadius 4 1 2 1 22 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginIPHost: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginIPHost"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-IP-Host" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 22,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginIPHost */
