...
/* START_OF_SYMBOL_DEFINITION radiusLoginLATNode */
/**
 * @summary radiusLoginLATNode
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginLATNode ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginLATNode" }
 *     LDAP-DESC                   "replyItem: Login-LAT-Node"
 *     ID                          { id-at-freeRadius 4 1 2 1 24 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginLATNode: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginLATNode"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-LAT-Node" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 24,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginLATNode */
