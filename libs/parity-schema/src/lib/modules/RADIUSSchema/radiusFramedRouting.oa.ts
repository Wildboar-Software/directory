...
/* START_OF_SYMBOL_DEFINITION radiusFramedRouting */
/**
 * @summary radiusFramedRouting
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedRouting ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedRouting" }
 *     LDAP-DESC                   "replyItem: Framed-Routing"
 *     ID                          { id-at-freeRadius 4 1 2 1 20 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedRouting: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedRouting"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-Routing" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 20,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedRouting */
