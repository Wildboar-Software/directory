...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv6GatewayIdentifier */
/**
 * @summary freeradiusDhcpv6GatewayIdentifier
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv6GatewayIdentifier ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv6GatewayIdentifier" }
 *     LDAP-DESC                   "Gateway Identifier"
 *     ID                          { id-at-freeRadius 4 3 1 1 1 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv6GatewayIdentifier: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv6GatewayIdentifier"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Gateway Identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3, 1, 1, 1,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv6GatewayIdentifier */
