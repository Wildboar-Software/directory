...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv4GatewayAddr */
/**
 * @summary freeradiusDhcpv4GatewayAddr
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv4GatewayAddr ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv4GatewayAddr" }
 *     LDAP-DESC                   "Gateway IP address, usually GIADDR"
 *     ID                          { id-at-freeRadius 4 2 1 1 2 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv4GatewayAddr: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv4GatewayAddr"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Gateway IP address, usually GIADDR" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 2, 1, 1, 2,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv4GatewayAddr */
