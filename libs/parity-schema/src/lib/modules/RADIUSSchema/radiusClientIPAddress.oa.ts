...
/* START_OF_SYMBOL_DEFINITION radiusClientIPAddress */
/**
 * @summary radiusClientIPAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusClientIPAddress ATTRIBUTE ::= {
 ...
 *     LDAP-NAME                   { "radiusClientIPAddress" }
 *     ID                          { id-at-freeRadius 4 1 2 1 45 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusClientIPAddress: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusClientIPAddress"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 45,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusClientIPAddress */
