...
/* START_OF_SYMBOL_DEFINITION radiusLoginLATService */
/**
 * @summary radiusLoginLATService
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginLATService ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginLATService" }
 *     LDAP-DESC                   "replyItem: Login-LAT-Service"
 *     ID                          { id-at-freeRadius 4 1 2 1 26 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginLATService: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginLATService"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-LAT-Service" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 26,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginLATService */
