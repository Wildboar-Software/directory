...
/* START_OF_SYMBOL_DEFINITION radiusAcctInputOctets */
/**
 * @summary radiusAcctInputOctets
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctInputOctets ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctInputOctets" }
 *     ID                          { id-at-freeRadius 4 1 3 1 67 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctInputOctets: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctInputOctets"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 67,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctInputOctets */
