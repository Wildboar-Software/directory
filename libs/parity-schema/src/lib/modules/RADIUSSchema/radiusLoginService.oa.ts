...
/* START_OF_SYMBOL_DEFINITION radiusLoginService */
/**
 * @summary radiusLoginService
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginService ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginService" }
 *     LDAP-DESC                   "replyItem: Login-Service"
 *     ID                          { id-at-freeRadius 4 1 2 1 27 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginService: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginService"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Login-Service" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 27,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginService */
