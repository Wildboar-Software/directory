...
/* START_OF_SYMBOL_DEFINITION radiusTunnelType */
/**
 * @summary radiusTunnelType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelType ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelType" }
 *     ID                          { id-at-freeRadius 4 1 2 1 41 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelType: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelType"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 41,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelType */
