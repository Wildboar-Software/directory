...
/* START_OF_SYMBOL_DEFINITION radiusClass */
/**
 * @summary radiusClass
 * @description
 * 
 ...
 * 
 * ```asn1
 * radiusClass ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusClass" }
 *     LDAP-DESC                   "replyItem: Class"
 *     ID                          { id-at-freeRadius 4 1 2 1 8 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusClass: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusClass"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Class" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 8,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusClass */
