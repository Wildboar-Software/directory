...
/* START_OF_SYMBOL_DEFINITION radiusConnectInfoStop */
/**
 * @summary radiusConnectInfoStop
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusConnectInfoStop ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusConnectInfoStop" }
 *     ID                          { id-at-freeRadius 4 1 3 1 78 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusConnectInfoStop: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusConnectInfoStop"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 78,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusConnectInfoStop */
