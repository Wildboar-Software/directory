...
/* START_OF_SYMBOL_DEFINITION radiusPasswordRetry */
/**
 * @summary radiusPasswordRetry
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusPasswordRetry ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusPasswordRetry" }
 *     ID                          { id-at-freeRadius 4 1 2 1 29 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusPasswordRetry: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusPasswordRetry"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 29,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusPasswordRetry */
