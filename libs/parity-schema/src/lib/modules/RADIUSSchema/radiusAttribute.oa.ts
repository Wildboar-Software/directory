...
/* START_OF_SYMBOL_DEFINITION radiusAttribute */
/**
 * @summary radiusAttribute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 *     LDAP-NAME                   { "radiusAttribute" }
 *     LDAP-DESC                   "controlItem: $GENERIC$"
 *     ID                          { id-at-freeRadius 4 1 2 1 59 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAttribute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAttribute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "controlItem: $GENERIC$" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 59,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAttribute */
