...
/* START_OF_SYMBOL_DEFINITION radiusCallbackNumber */
/**
 * @summary radiusCallbackNumber
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusCallbackNumber ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusCallbackNumber" }
 *     LDAP-DESC                   "replyItem: Callback-Number"
 *     ID                          { id-at-freeRadius 4 1 2 1 5 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusCallbackNumber: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusCallbackNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Callback-Number" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 5,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusCallbackNumber */
