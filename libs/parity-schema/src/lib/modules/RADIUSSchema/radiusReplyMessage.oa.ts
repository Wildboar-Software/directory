...
/* START_OF_SYMBOL_DEFINITION radiusReplyMessage */
/**
 * @summary radiusReplyMessage
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusReplyMessage ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusReplyMessage" }
 *     LDAP-DESC                   "replyItem: Reply-Message"
 *     ID                          { id-at-freeRadius 4 1 2 1 62 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusReplyMessage: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusReplyMessage"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Reply-Message" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 62,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusReplyMessage */
