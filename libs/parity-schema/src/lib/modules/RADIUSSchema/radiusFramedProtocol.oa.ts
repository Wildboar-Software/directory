...
/* START_OF_SYMBOL_DEFINITION radiusFramedProtocol */
/**
 * @summary radiusFramedProtocol
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedProtocol ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedProtocol" }
 *     LDAP-DESC                   "replyItem: Framed-Protocol"
 *     ID                          { id-at-freeRadius 4 1 2 1 18 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedProtocol: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedProtocol"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-Protocol" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 18,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedProtocol */
