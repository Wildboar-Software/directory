...
/* START_OF_SYMBOL_DEFINITION radiusConnectInfoStart */
/**
 * @summary radiusConnectInfoStart
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusConnectInfoStart ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusConnectInfoStart" }
 *     ID                          { id-at-freeRadius 4 1 3 1 77 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusConnectInfoStart: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusConnectInfoStart"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 77,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusConnectInfoStart */
