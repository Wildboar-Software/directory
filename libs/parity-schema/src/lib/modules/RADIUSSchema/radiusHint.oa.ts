...
/* START_OF_SYMBOL_DEFINITION radiusHint */
/**
 * @summary radiusHint
 * @description
 * 
 ...
 * 
 * ```asn1
 * radiusHint ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusHint" }
 *     ID                          { id-at-freeRadius 4 1 2 1 47 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusHint: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusHint"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 47,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusHint */
