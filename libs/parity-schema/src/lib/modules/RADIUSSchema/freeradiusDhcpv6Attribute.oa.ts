...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv6Attribute */
/**
 * @summary freeradiusDhcpv6Attribute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv6Attribute ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv6Attribute" }
 *     LDAP-DESC                   "DHCPv6 attribute in format [<list>.]<attr> <op> <value>"
 *     ID                          { id-at-freeRadius 4 3 2 1 1 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv6Attribute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv6Attribute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "DHCPv6 attribute in format [<list>.]<attr> <op> <value>" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3, 2, 1, 1,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv6Attribute */
