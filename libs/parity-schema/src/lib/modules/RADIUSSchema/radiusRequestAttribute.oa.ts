...
/* START_OF_SYMBOL_DEFINITION radiusRequestAttribute */
/**
 * @summary radiusRequestAttribute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusRequestAttribute ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusRequestAttribute" }
 *     LDAP-DESC                   "requestItem: $GENERIC$"
 *     ID                          { id-at-freeRadius 4 1 2 1 65 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusRequestAttribute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusRequestAttribute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "requestItem: $GENERIC$" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 65,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusRequestAttribute */
