...
/* START_OF_SYMBOL_DEFINITION freeradiusDhcpv6PoolNameNA */
/**
 * @summary freeradiusDhcpv6PoolNameNA
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * freeradiusDhcpv6PoolNameNA ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "freeradiusDhcpv6PoolNameNA" }
 *     LDAP-DESC                   "DHCPv6 IP NA pool name"
 *     ID                          { id-at-freeRadius 4 3 1 1 3 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const freeradiusDhcpv6PoolNameNA: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["freeradiusDhcpv6PoolNameNA"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "DHCPv6 IP NA pool name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3, 1, 1, 3,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION freeradiusDhcpv6PoolNameNA */
