...
/* START_OF_SYMBOL_DEFINITION radiusAuthType */
/**
 * @summary radiusAuthType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAuthType ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusAuthType" }
 *     LDAP-DESC                   "controlItem: Auth-Type"
 *     ID                          { id-at-freeRadius 4 1 2 1 44 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAuthType: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAuthType"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "controlItem: Auth-Type" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 44,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAuthType */
