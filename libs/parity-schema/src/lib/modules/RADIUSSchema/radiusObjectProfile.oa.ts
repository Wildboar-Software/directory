 ...
 */
export
const radiusObjectProfile: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ uid, userPassword, description, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["radiusObjectProfile"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A Container Objectclass to be used for creating radius profile object" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3, 2, 2,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
