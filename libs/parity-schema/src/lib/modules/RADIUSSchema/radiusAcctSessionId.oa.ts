...
/* START_OF_SYMBOL_DEFINITION radiusAcctSessionId */
/**
 * @summary radiusAcctSessionId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctSessionId ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctSessionId" }
 *     ID                          { id-at-freeRadius 4 1 3 1 70 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctSessionId: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctSessionId"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 70,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctSessionId */
