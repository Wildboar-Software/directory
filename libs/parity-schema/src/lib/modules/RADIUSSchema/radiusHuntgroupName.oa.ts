...
/* START_OF_SYMBOL_DEFINITION radiusHuntgroupName */
/**
 * @summary radiusHuntgroupName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusHuntgroupName ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusHuntgroupName" }
 *     ID                          { id-at-freeRadius 4 1 2 1 48 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusHuntgroupName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusHuntgroupName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 48,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusHuntgroupName */
