...
/* START_OF_SYMBOL_DEFINITION radiusCalledStationId */
/**
 * @summary radiusCalledStationId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusCalledStationId ATTRIBUTE ::= {
 ...
 *     LDAP-NAME                   { "radiusCalledStationId" }
 *     LDAP-DESC                   "controlItem: Called-Station-Id"
 *     ID                          { id-at-freeRadius 4 1 2 1 6 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusCalledStationId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusCalledStationId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "controlItem: Called-Station-Id" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 6,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusCalledStationId */
