...
/* START_OF_SYMBOL_DEFINITION radiusTerminationAction */
/**
 * @summary radiusTerminationAction
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTerminationAction ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTerminationAction" }
 *     LDAP-DESC                   "replyItem: Termination-Action"
 *     ID                          { id-at-freeRadius 4 1 2 1 34 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTerminationAction: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTerminationAction"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Termination-Action" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 34,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTerminationAction */
