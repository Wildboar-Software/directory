...
/* START_OF_SYMBOL_DEFINITION radiusPrompt */
/**
 * @summary radiusPrompt
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusPrompt ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusPrompt" }
 *     ID                          { id-at-freeRadius 4 1 2 1 31 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusPrompt: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusPrompt"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 31,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusPrompt */
