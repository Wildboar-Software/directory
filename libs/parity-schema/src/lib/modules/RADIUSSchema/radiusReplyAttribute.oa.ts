...
/* START_OF_SYMBOL_DEFINITION radiusReplyAttribute */
/**
 * @summary radiusReplyAttribute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusReplyAttribute ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SUBSTRINGS MATCHING RULE    caseIgnoreSubstringsMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusReplyAttribute" }
 *     LDAP-DESC                   "replyItem: $GENERIC$"
 *     ID                          { id-at-freeRadius 4 1 2 1 64 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusReplyAttribute: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusReplyAttribute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: $GENERIC$" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 64,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusReplyAttribute */
