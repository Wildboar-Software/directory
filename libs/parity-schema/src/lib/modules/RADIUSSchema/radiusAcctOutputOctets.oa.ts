...
/* START_OF_SYMBOL_DEFINITION radiusAcctOutputOctets */
/**
 * @summary radiusAcctOutputOctets
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusAcctOutputOctets ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusAcctOutputOctets" }
 *     ID                          { id-at-freeRadius 4 1 3 1 69 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusAcctOutputOctets: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusAcctOutputOctets"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 69,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusAcctOutputOctets */
