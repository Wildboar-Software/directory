 ...
 */
export
const freeradiusDhcpv4Profile: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ freeradiusDhcpv4Attribute, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["freeradiusDhcpv4Profile"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 2, 2, 2, 2,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
