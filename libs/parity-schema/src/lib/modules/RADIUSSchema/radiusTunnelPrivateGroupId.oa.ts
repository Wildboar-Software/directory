...
/* START_OF_SYMBOL_DEFINITION radiusTunnelPrivateGroupId */
/**
 * @summary radiusTunnelPrivateGroupId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusTunnelPrivateGroupId ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusTunnelPrivateGroupId" }
 *     ID                          { id-at-freeRadius 4 1 2 1 39 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusTunnelPrivateGroupId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusTunnelPrivateGroupId"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 39,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusTunnelPrivateGroupId */
