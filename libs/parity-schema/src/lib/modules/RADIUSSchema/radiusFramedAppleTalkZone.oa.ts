...
/* START_OF_SYMBOL_DEFINITION radiusFramedAppleTalkZone */
/**
 * @summary radiusFramedAppleTalkZone
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedAppleTalkZone ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedAppleTalkZone" }
 *     LDAP-DESC                   "replyItem: Framed-AppleTalk-Zone"
 *     ID                          { id-at-freeRadius 4 1 2 1 12 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedAppleTalkZone: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedAppleTalkZone"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-AppleTalk-Zone" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 12,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedAppleTalkZone */
