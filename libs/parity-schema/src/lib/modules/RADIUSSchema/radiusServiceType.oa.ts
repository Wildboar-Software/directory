...
/* START_OF_SYMBOL_DEFINITION radiusServiceType */
/**
 * @summary radiusServiceType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusServiceType ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusServiceType" }
 *     LDAP-DESC                   "replyItem: Service-Type"
 *     ID                          { id-at-freeRadius 4 1 2 1 32 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusServiceType: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusServiceType"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Service-Type" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 32,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusServiceType */
