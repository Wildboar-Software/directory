...
/* START_OF_SYMBOL_DEFINITION radiusArapFeatures */
/**
 * @summary radiusArapFeatures
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusArapFeatures ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusArapFeatures" }
 *     ID                          { id-at-freeRadius 4 1 2 1 1 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusArapFeatures: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusArapFeatures"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 1,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusArapFeatures */
