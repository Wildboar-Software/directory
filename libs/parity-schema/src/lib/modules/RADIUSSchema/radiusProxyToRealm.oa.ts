...
/* START_OF_SYMBOL_DEFINITION radiusProxyToRealm */
/**
 * @summary radiusProxyToRealm
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusProxyToRealm ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusProxyToRealm" }
 *     ID                          { id-at-freeRadius 4 1 2 1 50 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusProxyToRealm: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusProxyToRealm"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 50,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusProxyToRealm */
