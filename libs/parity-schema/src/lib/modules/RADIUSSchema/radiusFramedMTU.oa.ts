...
/* START_OF_SYMBOL_DEFINITION radiusFramedMTU */
/**
 * @summary radiusFramedMTU
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedMTU ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedMTU" }
 *     ID                          { id-at-freeRadius 4 1 2 1 17 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedMTU: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedMTU"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 17,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedMTU */
