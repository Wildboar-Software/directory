...
/* START_OF_SYMBOL_DEFINITION radiusNASPort */
/**
 * @summary radiusNASPort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusNASPort ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusNASPort" }
 *     ID                          { id-at-freeRadius 4 1 3 1 80 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusNASPort: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusNASPort"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 80,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusNASPort */
