...
/* START_OF_SYMBOL_DEFINITION radiusRealm */
/**
 * @summary radiusRealm
 * @description
 * 
 ...
 * 
 * ```asn1
 * radiusRealm ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusRealm" }
 *     ID                          { id-at-freeRadius 4 1 2 1 52 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusRealm: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusRealm"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 52,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusRealm */
