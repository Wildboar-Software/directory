...
/* START_OF_SYMBOL_DEFINITION radiusReplicateToRealm */
/**
 * @summary radiusReplicateToRealm
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusReplicateToRealm ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusReplicateToRealm" }
 *     ID                          { id-at-freeRadius 4 1 2 1 51 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusReplicateToRealm: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusReplicateToRealm"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 51,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusReplicateToRealm */
