...
/* START_OF_SYMBOL_DEFINITION radiusFramedIPXNetwork */
/**
 * @summary radiusFramedIPXNetwork
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusFramedIPXNetwork ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusFramedIPXNetwork" }
 *     LDAP-DESC                   "replyItem: Framed-IPX-Network"
 *     ID                          { id-at-freeRadius 4 1 2 1 16 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusFramedIPXNetwork: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusFramedIPXNetwork"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Framed-IPX-Network" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 16,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusFramedIPXNetwork */
