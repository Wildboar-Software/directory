...
/* START_OF_SYMBOL_DEFINITION radiusLoginTime */
/**
 * @summary radiusLoginTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusLoginTime ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusLoginTime" }
 *     ID                          { id-at-freeRadius 4 1 2 1 54 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusLoginTime: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusLoginTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 54,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusLoginTime */
