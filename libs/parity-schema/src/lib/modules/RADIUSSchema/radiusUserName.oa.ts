...
/* START_OF_SYMBOL_DEFINITION radiusUserName */
/**
 * @summary radiusUserName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusUserName ATTRIBUTE ::= {
 *     WITH SYNTAX                 IA5String
 *     EQUALITY MATCHING RULE      caseIgnoreIA5Match
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 ia5String.&id
 *     LDAP-NAME                   { "radiusUserName" }
 *     ID                          { id-at-freeRadius 4 1 3 1 83 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusUserName: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusUserName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 3, 1, 83,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusUserName */
