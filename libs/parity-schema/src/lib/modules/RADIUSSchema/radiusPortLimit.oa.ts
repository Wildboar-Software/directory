...
/* START_OF_SYMBOL_DEFINITION radiusPortLimit */
/**
 * @summary radiusPortLimit
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * radiusPortLimit ATTRIBUTE ::= {
 *     WITH SYNTAX                 UnboundedDirectoryString
 *     EQUALITY MATCHING RULE      caseIgnoreMatch
 *     SINGLE VALUE                TRUE
 *     USAGE                       userApplications
 *     LDAP-SYNTAX                 directoryString.&id
 *     LDAP-NAME                   { "radiusPortLimit" }
 *     LDAP-DESC                   "replyItem: Port-Limit"
 *     ID                          { id-at-freeRadius 4 1 2 1 30 }
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const radiusPortLimit: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["radiusPortLimit"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "replyItem: Port-Limit" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 1, 2, 1, 30,], id_at_freeRadius) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION radiusPortLimit */
