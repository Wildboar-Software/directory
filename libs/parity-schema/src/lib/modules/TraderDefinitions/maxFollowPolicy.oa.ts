...
import { id_trader_at_maxFollowPolicy } from "../TraderDefinitions/id-trader-at-maxFollowPolicy.va";
export { id_trader_at_maxFollowPolicy } from "../TraderDefinitions/id-trader-at-maxFollowPolicy.va";


/* START_OF_SYMBOL_DEFINITION maxFollowPolicy */
/**
 * @summary maxFollowPolicy
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const maxFollowPolicy: ATTRIBUTE<FollowOption> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_maxFollowPolicy /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION maxFollowPolicy */
