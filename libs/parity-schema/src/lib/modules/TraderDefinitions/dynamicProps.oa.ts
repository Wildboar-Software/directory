 ...
 */
export
const dynamicProps: ATTRIBUTE<DynamicPropValue[]> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeSequenceOf<DynamicPropValue>(() => _decode_DynamicPropValue),
    },
    encoderFor: {
        "&Type": $._encodeSequenceOf<DynamicPropValue>(() => _encode_DynamicPropValue, $.BER),
    },
