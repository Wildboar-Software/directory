...
import { ub_interface_id } from "../TraderDefinitions/ub-interface-id.va";
 ...
 */
export
type InterfaceId = DirectoryString; // DefinedType
 ...
 */
export
function _decode_InterfaceId (el: _Element) {
    if (!_cached_decoder_for_InterfaceId) { _cached_decoder_for_InterfaceId = _decode_DirectoryString; }
 ...
 */
export
function _encode_InterfaceId (value: InterfaceId, elGetter: $.ASN1Encoder<InterfaceId>) {
    if (!_cached_encoder_for_InterfaceId) { _cached_encoder_for_InterfaceId = _encode_DirectoryString; }
