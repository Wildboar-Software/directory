...
import { InterfaceId, _decode_InterfaceId, _encode_InterfaceId } from "../TraderDefinitions/InterfaceId.ta";
export { InterfaceId, _decode_InterfaceId, _encode_InterfaceId } from "../TraderDefinitions/InterfaceId.ta";
...
export { id_trader_at_interfaceReference } from "../TraderDefinitions/id-trader-at-interfaceReference.va";
 ...
 */
export
const interfaceReference: ATTRIBUTE<InterfaceId> = {
    class: "ATTRIBUTE",
    decoderFor: {
