 ...
 */
export
const traderLinkEntry: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ linkName, linkId, targetTraderInterfaceId, defPassOnFollowRule, limitingFollowRule, ] /* OBJECT_FIELD_SETTING */,
