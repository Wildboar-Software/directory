...
import { FollowOption, _enum_for_FollowOption, FollowOption_localOnly /* IMPORTED_LONG_ENUMERATION_ITEM */, localOnly /* IMPORTED_SHORT_ENUMERATION_ITEM */, FollowOption_ifNoLocal /* IMPORTED_LONG_ENUMERATION_ITEM */, ifNoLocal /* IMPORTED_SHORT_ENUMERATION_ITEM */, FollowOption_always /* IMPORTED_LONG_ENUMERATION_ITEM */, always /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_FollowOption, _encode_FollowOption } from "../TraderDefinitions/FollowOption.ta";
export { FollowOption, _enum_for_FollowOption, FollowOption_localOnly /* IMPORTED_LONG_ENUMERATION_ITEM */, localOnly /* IMPORTED_SHORT_ENUMERATION_ITEM */, FollowOption_ifNoLocal /* IMPORTED_LONG_ENUMERATION_ITEM */, ifNoLocal /* IMPORTED_SHORT_ENUMERATION_ITEM */, FollowOption_always /* IMPORTED_LONG_ENUMERATION_ITEM */, always /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_FollowOption, _encode_FollowOption } from "../TraderDefinitions/FollowOption.ta";
...
import { id_trader_at_maxLinkFollowPolicy } from "../TraderDefinitions/id-trader-at-maxLinkFollowPolicy.va";
export { id_trader_at_maxLinkFollowPolicy } from "../TraderDefinitions/id-trader-at-maxLinkFollowPolicy.va";


/* START_OF_SYMBOL_DEFINITION maxLinkFollowPolicy */
/**
 * @summary maxLinkFollowPolicy
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const maxLinkFollowPolicy: ATTRIBUTE<FollowOption> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_maxLinkFollowPolicy /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION maxLinkFollowPolicy */
