...
export { policySpecificationMatch } from "../TraderDefinitions/policySpecificationMatch.oa";
import { id_trader_at_typeManagementConstraint } from "../TraderDefinitions/id-trader-at-typeManagementConstraint.va";
export { id_trader_at_typeManagementConstraint } from "../TraderDefinitions/id-trader-at-typeManagementConstraint.va";
 ...
 */
export
const typeManagementConstraint: ATTRIBUTE<PolicySpecification> = {
    class: "ATTRIBUTE",
    decoderFor: {
