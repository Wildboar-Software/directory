...
import { id_trader_at_defPassOnFollowRule } from "../TraderDefinitions/id-trader-at-defPassOnFollowRule.va";
export { id_trader_at_defPassOnFollowRule } from "../TraderDefinitions/id-trader-at-defPassOnFollowRule.va";


/* START_OF_SYMBOL_DEFINITION defPassOnFollowRule */
/**
 * @summary defPassOnFollowRule
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const defPassOnFollowRule: ATTRIBUTE<FollowOption> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_defPassOnFollowRule /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION defPassOnFollowRule */
