...
import { ub_constraint_recipe } from "../TraderDefinitions/ub-constraint-recipe.va";
export { ub_constraint_recipe } from "../TraderDefinitions/ub-constraint-recipe.va";
...
import { id_trader_at_constraintRecipe } from "../TraderDefinitions/id-trader-at-constraintRecipe.va";
export { id_trader_at_constraintRecipe } from "../TraderDefinitions/id-trader-at-constraintRecipe.va";


/* START_OF_SYMBOL_DEFINITION constraintRecipe */
/**
 * @summary constraintRecipe
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const constraintRecipe: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_constraintRecipe /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION constraintRecipe */
