 ...
 */
export
const proxyOfferEntry: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ proxyOfferId, proxyLookUpInterfaceId, hasDynamicProperties, hasModifiableProperties, ifMatchAll, constraintRecipe, ] /* OBJECT_FIELD_SETTING */,
