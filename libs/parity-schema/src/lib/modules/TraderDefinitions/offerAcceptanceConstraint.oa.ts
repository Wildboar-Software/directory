...
export { id_trader_at_offerAcceptanceConstraint } from "../TraderDefinitions/id-trader-at-offerAcceptanceConstraint.va";
 ...
 */
export
const offerAcceptanceConstraint: ATTRIBUTE<PolicySpecification> = {
    class: "ATTRIBUTE",
    decoderFor: {
