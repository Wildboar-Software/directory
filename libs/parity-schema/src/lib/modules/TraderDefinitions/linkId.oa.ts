...
import { ub_link_id } from "../TraderDefinitions/ub-link-id.va";
export { ub_link_id } from "../TraderDefinitions/ub-link-id.va";
...
import { id_trader_at_linkId } from "../TraderDefinitions/id-trader-at-linkId.va";
export { id_trader_at_linkId } from "../TraderDefinitions/id-trader-at-linkId.va";
 ...
 */
export
const linkId: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_linkId /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
