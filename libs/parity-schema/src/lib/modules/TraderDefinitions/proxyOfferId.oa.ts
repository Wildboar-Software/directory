...
import { ub_proxy_offer_id } from "../TraderDefinitions/ub-proxy-offer-id.va";
export { ub_proxy_offer_id } from "../TraderDefinitions/ub-proxy-offer-id.va";
...
import { id_trader_at_proxyOfferId } from "../TraderDefinitions/id-trader-at-proxyOfferId.va";
export { id_trader_at_proxyOfferId } from "../TraderDefinitions/id-trader-at-proxyOfferId.va";


/* START_OF_SYMBOL_DEFINITION proxyOfferId */
/**
 * @summary proxyOfferId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const proxyOfferId: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_proxyOfferId /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION proxyOfferId */
