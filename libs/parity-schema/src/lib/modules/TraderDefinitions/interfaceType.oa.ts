...
import { InterfaceTypeName, _decode_InterfaceTypeName, _encode_InterfaceTypeName } from "../TraderDefinitions/InterfaceTypeName.ta";
export { InterfaceTypeName, _decode_InterfaceTypeName, _encode_InterfaceTypeName } from "../TraderDefinitions/InterfaceTypeName.ta";
...
export { id_trader_at_interfaceType } from "../TraderDefinitions/id-trader-at-interfaceType.va";
 ...
 */
export
const interfaceType: ATTRIBUTE<InterfaceTypeName> = {
    class: "ATTRIBUTE",
    decoderFor: {
