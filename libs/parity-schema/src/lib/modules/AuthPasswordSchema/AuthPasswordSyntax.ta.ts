...
import { PlaintextPasswordSyntax, _decode_PlaintextPasswordSyntax, _encode_PlaintextPasswordSyntax } from "../AuthPasswordSchema/PlaintextPasswordSyntax.ta";
export { PlaintextPasswordSyntax, _decode_PlaintextPasswordSyntax, _encode_PlaintextPasswordSyntax } from "../AuthPasswordSchema/PlaintextPasswordSyntax.ta";
...
class AuthPasswordSyntax {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AuthPasswordSyntax)]: (AuthPasswordSyntax)[_K] }): AuthPasswordSyntax {
        return new AuthPasswordSyntax(_o.algorithmIdentifier, _o.hashValue, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_AuthPasswordSyntax: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_AuthPasswordSyntax: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AuthPasswordSyntax: $.ComponentSpec[] = [
...
let _cached_decoder_for_AuthPasswordSyntax: $.ASN1Decoder<AuthPasswordSyntax> | null = null;
 ...
 */
export
function _decode_AuthPasswordSyntax (el: _Element) {
    if (!_cached_decoder_for_AuthPasswordSyntax) { _cached_decoder_for_AuthPasswordSyntax = function (el: _Element): AuthPasswordSyntax {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("AuthPasswordSyntax contained only " + sequence.length.toString() + " elements.");
    }
...
let _cached_encoder_for_AuthPasswordSyntax: $.ASN1Encoder<AuthPasswordSyntax> | null = null;
 ...
 */
export
function _encode_AuthPasswordSyntax (value: AuthPasswordSyntax, elGetter: $.ASN1Encoder<AuthPasswordSyntax>) {
    if (!_cached_encoder_for_AuthPasswordSyntax) { _cached_encoder_for_AuthPasswordSyntax = function (value: AuthPasswordSyntax, elGetter: $.ASN1Encoder<AuthPasswordSyntax>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.algorithmIdentifier, $.BER),
            /* REQUIRED   */ _encode_PlaintextPasswordSyntax(value.hashValue, $.BER)
        ],
