 ...
 */
export
const supportedAuthPasswordSchemes: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "supported password storage schemes" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([3, 3,], id_at_openldap_schema) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
