...
import { id_at_maildest } from "../InetMailSchema/id-at-maildest.va";
export { id_at_maildest } from "../InetMailSchema/id-at-maildest.va";


/* START_OF_SYMBOL_DEFINITION maildest */
/**
 * @summary maildest
 * @description
 * 
 ...
 */
export
const maildest: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["maildest"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Restricted to send only to local network" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_maildest /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION maildest */
