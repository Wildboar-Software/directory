...
import { id_at_mailaccess } from "../InetMailSchema/id-at-mailaccess.va";
export { id_at_mailaccess } from "../InetMailSchema/id-at-mailaccess.va";


/* START_OF_SYMBOL_DEFINITION mailaccess */
/**
 * @summary mailaccess
 * @description
 * 
 ...
 */
export
const mailaccess: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mailaccess"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Can be mailed to restricted groups" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_mailaccess /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailaccess */
