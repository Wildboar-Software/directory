...
/* START_OF_SYMBOL_DEFINITION javaReferenceAddress */
/**
 * @summary javaReferenceAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const javaReferenceAddress: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["javaReferenceAddress"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Addresses associated with a JNDI Reference" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 42, 2, 27, 4, 1, 11,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION javaReferenceAddress */
