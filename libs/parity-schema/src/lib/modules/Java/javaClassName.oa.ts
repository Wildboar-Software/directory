...
/* START_OF_SYMBOL_DEFINITION javaClassName */
/**
 * @summary javaClassName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const javaClassName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["javaClassName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fully qualified name of distinguished Java class or interface" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 42, 2, 27, 4, 1, 6,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION javaClassName */
