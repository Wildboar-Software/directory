...
/* START_OF_SYMBOL_DEFINITION javaCodebase */
/**
 * @summary javaCodebase
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const javaCodebase: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["javaCodebase"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "URL(s) specifying the location of class definition" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 42, 2, 27, 4, 1, 7,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION javaCodebase */
