...
/* START_OF_SYMBOL_DEFINITION javaDoc */
/**
 * @summary javaDoc
 * @description
 * 
 ...
 */
export
const javaDoc: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["javaDoc"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Java documentation for the class" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 42, 2, 27, 4, 1, 12,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION javaDoc */
