...
/* START_OF_SYMBOL_DEFINITION javaFactory */
/**
 * @summary javaFactory
 * @description
 * 
 ...
 */
export
const javaFactory: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["javaFactory"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fully qualified Java class name of a JNDI object factory" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 42, 2, 27, 4, 1, 10,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION javaFactory */
