 ...
 */
export const apacheDnsSoaMName: ATTRIBUTE<IA5String> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'The domain name of the name server that was the primary source of data for this zone' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 6,
