...
/* START_OF_SYMBOL_DEFINITION apacheDnsSoaRefresh */
/**
 * @summary apacheDnsSoaRefresh
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsSoaRefresh: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsSoaRefresh"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A 32 bit time interval before the zone should be refreshed" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 9,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsSoaRefresh */
