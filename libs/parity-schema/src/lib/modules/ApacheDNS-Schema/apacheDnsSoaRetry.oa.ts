...
/* START_OF_SYMBOL_DEFINITION apacheDnsSoaRetry */
/**
 * @summary apacheDnsSoaRetry
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsSoaRetry: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsSoaRetry"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A 32 bit time interval that should elapse before a failed refresh should be retired" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 10,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsSoaRetry */
