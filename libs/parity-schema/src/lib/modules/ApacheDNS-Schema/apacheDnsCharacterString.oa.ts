...
/* START_OF_SYMBOL_DEFINITION apacheDnsCharacterString */
/**
 * @summary apacheDnsCharacterString
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsCharacterString: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["apacheDnsCharacterString"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A string up to 256 characters in length" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 4,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsCharacterString */
