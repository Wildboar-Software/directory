...
/* START_OF_SYMBOL_DEFINITION apacheDnsIpAddress */
/**
 * @summary apacheDnsIpAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsIpAddress: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["apacheDnsIpAddress"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A 4 octet IP address" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 5,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsIpAddress */
