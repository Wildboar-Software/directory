...
/* START_OF_SYMBOL_DEFINITION apacheDnsSoaExpire */
/**
 * @summary apacheDnsSoaExpire
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsSoaExpire: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsSoaExpire"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A 32 bit time value that specifies the upper limit on the time interval that can elapse before" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 11,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsSoaExpire */
