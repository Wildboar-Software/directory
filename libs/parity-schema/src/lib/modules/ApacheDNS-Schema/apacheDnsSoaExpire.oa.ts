 ...
 */
export const apacheDnsSoaExpire: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapDesc':
        'A 32 bit time value that specifies the upper limit on the time interval that can elapse before' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 11,
