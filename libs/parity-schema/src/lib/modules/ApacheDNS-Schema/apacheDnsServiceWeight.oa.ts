...
/* START_OF_SYMBOL_DEFINITION apacheDnsServiceWeight */
/**
 * @summary apacheDnsServiceWeight
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsServiceWeight: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsServiceWeight"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The unsigned 16 bit weight specifying a relative weight for entries with the same priority" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 15,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsServiceWeight */
