 ...
 */
export
const apacheDnsReferralAddress: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ apacheDnsDomainName, apacheDnsIpAddress, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["apacheDnsReferralAddress"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A non-authoritative referral or glue address record" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 3, 11,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
