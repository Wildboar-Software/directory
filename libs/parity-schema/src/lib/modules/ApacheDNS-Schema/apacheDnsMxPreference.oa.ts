...
/* START_OF_SYMBOL_DEFINITION apacheDnsMxPreference */
/**
 * @summary apacheDnsMxPreference
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsMxPreference: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsMxPreference"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "An integer denoting the mail exchange preference" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 13,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsMxPreference */
