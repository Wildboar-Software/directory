...
/* START_OF_SYMBOL_DEFINITION apacheDnsServicePort */
/**
 * @summary apacheDnsServicePort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsServicePort: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsServicePort"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The unsigned 16 bit port on this target host of this service" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 16,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsServicePort */
