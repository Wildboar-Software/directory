...
/* START_OF_SYMBOL_DEFINITION apacheDnsServicePriority */
/**
 * @summary apacheDnsServicePriority
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsServicePriority: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsServicePriority"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The unsigned 16 bit priority of this target host" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 14,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsServicePriority */
