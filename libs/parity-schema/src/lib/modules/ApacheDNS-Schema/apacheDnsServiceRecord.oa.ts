 ...
 */
export
const apacheDnsServiceRecord: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ apacheDnsServicePriority, apacheDnsServiceWeight, apacheDnsServicePort, apacheDnsDomainName, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["apacheDnsServiceRecord"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A service SRV record" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 3, 9,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
