...
/* START_OF_SYMBOL_DEFINITION apacheDnsSoaMinimum */
/**
 * @summary apacheDnsSoaMinimum
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsSoaMinimum: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsSoaMinimum"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The unsigned 32 bit minimum TTL field that should be exported with any RR from this zone." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 12,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsSoaMinimum */
