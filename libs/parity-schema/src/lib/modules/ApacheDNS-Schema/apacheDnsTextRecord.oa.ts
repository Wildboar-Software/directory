...
export { apacheDnsCharacterString } from "../ApacheDNS-Schema/apacheDnsCharacterString.oa";
 ...
 */
export
const apacheDnsTextRecord: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ apacheDnsCharacterString, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["apacheDnsTextRecord"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A text TXT record" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 3, 8,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
