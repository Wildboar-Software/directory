...
/* START_OF_SYMBOL_DEFINITION apacheDnsSoaSerial */
/**
 * @summary apacheDnsSoaSerial
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsSoaSerial: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["apacheDnsSoaSerial"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The unsigned 32 bit version number of the original copy of the zone" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 8,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsSoaSerial */
