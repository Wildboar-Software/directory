...
/* START_OF_SYMBOL_DEFINITION apacheDnsDomainName */
/**
 * @summary apacheDnsDomainName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const apacheDnsDomainName: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["apacheDnsDomainName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A domain name represented as a sequence of labels" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 2, 3,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION apacheDnsDomainName */
