 ...
 */
export
const apacheDnsMailExchangeRecord: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ apacheDnsMxPreference, apacheDnsDomainName, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["apacheDnsMailExchangeRecord"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A mail exchange MX record" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 2, 3, 7,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
