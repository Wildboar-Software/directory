...
export class MethodIdentifier {
    ...
    public static _from_object(_o: {
        [_K in keyof MethodIdentifier]: MethodIdentifier[_K];
    }): MethodIdentifier {
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_MethodIdentifier: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'methodid',
            false,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_MethodIdentifier: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_MethodIdentifier: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_MethodIdentifier: $.ASN1Decoder<MethodIdentifier> | null =
    null;
 ...
 */
export function _decode_MethodIdentifier(el: _Element) {
    if (!_cached_decoder_for_MethodIdentifier) {
        _cached_decoder_for_MethodIdentifier = function (
            el: _Element
        ): MethodIdentifier {
            ...
            const callbacks: $.DecodingMap = {
                methodid: (_el: _Element): void => {
                    methodid = $._decodeObjectIdentifier(_el);
                },
                inputAttributes: (_el: _Element): void => {
                    inputAttributes = $._decodeSetOf<_Element>(
                        () => $._decodeAny
                    )(_el);
                },
                'specific-Input': (_el: _Element): void => {
                    specific_Input = $._decode_explicit<_Element>(
                        () => $._decodeAny
                    )(_el);
                },
            };
...
let _cached_encoder_for_MethodIdentifier: $.ASN1Encoder<MethodIdentifier> | null =
    null;
 ...
 */
export function _encode_MethodIdentifier(
    value: MethodIdentifier,
    elGetter: $.ASN1Encoder<MethodIdentifier>
) {
    if (!_cached_encoder_for_MethodIdentifier) {
        _cached_encoder_for_MethodIdentifier = function (
            value: MethodIdentifier,
            elGetter: $.ASN1Encoder<MethodIdentifier>
        ): _Element {
            return $._encodeSequence(
                ([] as (_Element | undefined)[])
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.inputAttributes === undefined
                            ? undefined
                            : $._encodeSetOf<_Element>(
                                  () => $._encodeAny,
                                  $.BER
                              )(value.inputAttributes, $.BER),
                        /* IF_ABSENT  */ value.specific_Input === undefined
                            ? undefined
                            : $._encode_explicit(
                                  _TagClass.context,
                                  0,
