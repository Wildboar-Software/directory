...
import { identifierList_Type, _decode_identifierList_Type, _encode_identifierList_Type } from "../IN-CS3-SCF-SDF-datatypes/identifierList-Type.ta";
export { identifierList_Type, _decode_identifierList_Type, _encode_identifierList_Type } from "../IN-CS3-SCF-SDF-datatypes/identifierList-Type.ta";
 ...
 */
export
const identifierList: ATTRIBUTE<identifierList_Type> = {
    class: "ATTRIBUTE",
    decoderFor: {
