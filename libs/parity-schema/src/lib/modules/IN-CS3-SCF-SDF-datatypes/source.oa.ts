...
import { SourceType, _decode_SourceType, _encode_SourceType } from "../IN-CS3-SCF-SDF-datatypes/SourceType.ta";
export { SourceType, _decode_SourceType, _encode_SourceType } from "../IN-CS3-SCF-SDF-datatypes/SourceType.ta";
import { id_at_source } from "../IN-CS3-object-identifiers/id-at-source.va";
export { id_at_source } from "../IN-CS3-object-identifiers/id-at-source.va";
 ...
 */
export
const source: ATTRIBUTE<SourceType> = {
    class: "ATTRIBUTE",
    decoderFor: {
