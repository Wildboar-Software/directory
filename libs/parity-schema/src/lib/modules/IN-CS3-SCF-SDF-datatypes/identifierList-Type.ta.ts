...
import { MethodIdentifier, _decode_MethodIdentifier, _encode_MethodIdentifier } from "../IN-CS3-SCF-SDF-datatypes/MethodIdentifier.ta";
export { MethodIdentifier, _decode_MethodIdentifier, _encode_MethodIdentifier } from "../IN-CS3-SCF-SDF-datatypes/MethodIdentifier.ta";
...
class identifierList_Type {
     ...
     */
    public static _from_object (_o: { [_K in keyof (identifierList_Type)]: (identifierList_Type)[_K] }): identifierList_Type {
        return new identifierList_Type(_o.conformMethodIdentifier, _o.fillMethodIdentifier, _o.oneToOneAlgorithm, _o.oneToTwoAlgorithm);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_identifierList_Type: $.ComponentSpec[] = [
    new $.ComponentSpec("conformMethodIdentifier", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("fillMethodIdentifier", false, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("oneToOneAlgorithm", false, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("oneToTwoAlgorithm", false, $.hasTag(_TagClass.context, 4), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_identifierList_Type: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_identifierList_Type: $.ComponentSpec[] = [
...
let _cached_decoder_for_identifierList_Type: $.ASN1Decoder<identifierList_Type> | null = null;
 ...
 */
export
function _decode_identifierList_Type (el: _Element) {
    if (!_cached_decoder_for_identifierList_Type) { _cached_decoder_for_identifierList_Type = function (el: _Element): identifierList_Type {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new _ConstructionError("identifierList-Type contained only " + sequence.length.toString() + " elements.");
    }
    ...
    conformMethodIdentifier = $._decode_explicit<MethodIdentifier>(() => _decode_MethodIdentifier)(sequence[0]);
    fillMethodIdentifier = $._decode_explicit<MethodIdentifier>(() => _decode_MethodIdentifier)(sequence[1]);
    oneToOneAlgorithm = $._decode_explicit<AlgorithmIdentifier>(() => _decode_AlgorithmIdentifier)(sequence[2]);
    oneToTwoAlgorithm = $._decode_explicit<AlgorithmIdentifier>(() => _decode_AlgorithmIdentifier)(sequence[3]);
...
let _cached_encoder_for_identifierList_Type: $.ASN1Encoder<identifierList_Type> | null = null;
 ...
 */
export
function _encode_identifierList_Type (value: identifierList_Type, elGetter: $.ASN1Encoder<identifierList_Type>) {
    if (!_cached_encoder_for_identifierList_Type) { _cached_encoder_for_identifierList_Type = function (value: identifierList_Type, elGetter: $.ASN1Encoder<identifierList_Type>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => _encode_MethodIdentifier, $.BER)(value.conformMethodIdentifier, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 2, () => _encode_MethodIdentifier, $.BER)(value.fillMethodIdentifier, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 3, () => _encode_AlgorithmIdentifier, $.BER)(value.oneToOneAlgorithm, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 4, () => _encode_AlgorithmIdentifier, $.BER)(value.oneToTwoAlgorithm, $.BER)
        ],
