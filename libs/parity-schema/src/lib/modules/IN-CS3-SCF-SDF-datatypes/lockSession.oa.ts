...
import { LockSession, _decode_LockSession, _encode_LockSession } from "../IN-CS3-SCF-SDF-datatypes/LockSession.ta";
export { LockSession, _decode_LockSession, _encode_LockSession } from "../IN-CS3-SCF-SDF-datatypes/LockSession.ta";
 ...
 */
export
const lockSession: ATTRIBUTE<LockSession> = {
    class: "ATTRIBUTE",
    decoderFor: {
