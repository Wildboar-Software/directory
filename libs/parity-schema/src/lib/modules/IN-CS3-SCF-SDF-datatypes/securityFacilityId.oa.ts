...
import { SF_CODE, _decode_SF_CODE, _encode_SF_CODE } from "../IN-CS3-SCF-SDF-datatypes/SF-CODE.ta";
export { SF_CODE, _decode_SF_CODE, _encode_SF_CODE } from "../IN-CS3-SCF-SDF-datatypes/SF-CODE.ta";
...
export { id_at_securityFacilityId } from "../IN-CS3-object-identifiers/id-at-securityFacilityId.va";
 ...
 */
export
const securityFacilityId: ATTRIBUTE<SF_CODE> = {
    class: "ATTRIBUTE",
    decoderFor: {
