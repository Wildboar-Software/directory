...
import { DT_Code, _decode_DT_Code, _encode_DT_Code } from "../IN-CS3-SCF-SDF-datatypes/DT-Code.ta";
export { DT_Code, _decode_DT_Code, _encode_DT_Code } from "../IN-CS3-SCF-SDF-datatypes/DT-Code.ta";
...
export { id_at_stockId } from "../IN-CS3-object-identifiers/id-at-stockId.va";
 ...
 */
export
const stockId: ATTRIBUTE<DT_Code> = {
    class: "ATTRIBUTE",
    decoderFor: {
