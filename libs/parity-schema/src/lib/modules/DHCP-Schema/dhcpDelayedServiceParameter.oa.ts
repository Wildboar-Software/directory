...
/* START_OF_SYMBOL_DEFINITION dhcpDelayedServiceParameter */
/**
 * @summary dhcpDelayedServiceParameter
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpDelayedServiceParameter: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["dhcpDelayedServiceParameter"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 36,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpDelayedServiceParameter */
