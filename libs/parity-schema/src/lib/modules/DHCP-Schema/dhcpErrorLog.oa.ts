...
/* START_OF_SYMBOL_DEFINITION dhcpErrorLog */
/**
 * @summary dhcpErrorLog
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpErrorLog: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpErrorLog"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 39,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpErrorLog */
