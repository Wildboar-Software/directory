...
const dhcpServer: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ commonName, dhcpServiceDN, ] /* OBJECT_FIELD_SETTING */,
    "&OptionalAttributes": [ dhcpVersion, dhcpImplementation, dhcpHashBucketAssignment, dhcpDelayedServiceParameter, dhcpMaxClientLeadTime, dhcpFailOverEndpointState, dhcpStatements, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["dhcpServer"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "DHCP Server Object" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 6, 12,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
