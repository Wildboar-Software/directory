...
/* START_OF_SYMBOL_DEFINITION dhcpLeaseDN */
/**
 * @summary dhcpLeaseDN
 * @description
 * 
 ...
 */
export
const dhcpLeaseDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpLeaseDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The distinguished name of a client address." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 14,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpLeaseDN */
