...
/* START_OF_SYMBOL_DEFINITION dhcpPrimaryDN */
/**
 * @summary dhcpPrimaryDN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpPrimaryDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpPrimaryDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The DN of the dhcpServer which is the primary server for the configuration." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 1,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpPrimaryDN */
