...
/* START_OF_SYMBOL_DEFINITION dhcpGroupDN */
/**
 * @summary dhcpGroupDN
 * @description
 * 
 ...
 */
export
const dhcpGroupDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpGroupDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The distinguished name(s)   of the groups." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 12,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpGroupDN */
