...
const dhcpPool: OBJECT_CLASS = {
    ...
    "&OptionalAttributes": [ dhcpClassesDN, dhcpPermitList, dhcpLeasesDN, dhcpOptionsDN, dhcpStatements, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["dhcpPool"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "This stores configuration information about a pool." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 6, 4,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
