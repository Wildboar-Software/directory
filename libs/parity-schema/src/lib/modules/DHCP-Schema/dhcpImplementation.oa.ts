...
/* START_OF_SYMBOL_DEFINITION dhcpImplementation */
/**
 * @summary dhcpImplementation
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpImplementation: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpImplementation"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Description of the DHCP Server implementation e.g. DHCP Servers vendor." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 21,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpImplementation */
