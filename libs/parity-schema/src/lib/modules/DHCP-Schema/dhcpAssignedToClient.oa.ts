...
/* START_OF_SYMBOL_DEFINITION dhcpAssignedToClient */
/**
 * @summary dhcpAssignedToClient
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpAssignedToClient: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpAssignedToClient"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 32,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpAssignedToClient */
