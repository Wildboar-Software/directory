...
/* START_OF_SYMBOL_DEFINITION dhcpLeasesDN */
/**
 * @summary dhcpLeasesDN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpLeasesDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpLeasesDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The distinguished name(s) client addresses." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 15,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpLeasesDN */
