...
/* START_OF_SYMBOL_DEFINITION dhcpFailOverEndpointState */
/**
 * @summary dhcpFailOverEndpointState
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpFailOverEndpointState: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpFailOverEndpointState"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 38,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpFailOverEndpointState */
