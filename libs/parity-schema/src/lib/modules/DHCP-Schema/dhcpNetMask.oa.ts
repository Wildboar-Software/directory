...
/* START_OF_SYMBOL_DEFINITION dhcpNetMask */
/**
 * @summary dhcpNetMask
 * @description
 * 
 ...
 */
export
const dhcpNetMask: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["dhcpNetMask"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The subnet mask length for the subnet.  The mask can be easily computed from this length." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 6,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpNetMask */
