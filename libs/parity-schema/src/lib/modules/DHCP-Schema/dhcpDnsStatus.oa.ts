...
/* START_OF_SYMBOL_DEFINITION dhcpDnsStatus */
/**
 * @summary dhcpDnsStatus
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpDnsStatus: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["dhcpDnsStatus"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 28,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpDnsStatus */
