...
const dhcpSubnet: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ commonName, dhcpNetMask, ] /* OBJECT_FIELD_SETTING */,
    "&OptionalAttributes": [ dhcpRange, dhcpPoolDN, dhcpGroupDN, dhcpHostDN, dhcpClassesDN, dhcpLeasesDN, dhcpOptionsDN, dhcpStatements, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["dhcpSubnet"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "This class defines a subnet. This is a container object." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 6, 3,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
