...
/* START_OF_SYMBOL_DEFINITION dhcpSharedNetworkDN */
/**
 * @summary dhcpSharedNetworkDN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpSharedNetworkDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpSharedNetworkDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The distinguished name(s) of sharedNetworks." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 18,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpSharedNetworkDN */
