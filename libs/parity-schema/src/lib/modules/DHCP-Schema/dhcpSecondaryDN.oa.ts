...
/* START_OF_SYMBOL_DEFINITION dhcpSecondaryDN */
/**
 * @summary dhcpSecondaryDN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpSecondaryDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpSecondaryDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The DN of dhcpServer(s) which provide backup service for the configuration." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 2,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpSecondaryDN */
