 ...
 */
export const dhcpSecondaryDN: ATTRIBUTE<DistinguishedName> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'The DN of dhcpServer(s) which provide backup service for the configuration.' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
