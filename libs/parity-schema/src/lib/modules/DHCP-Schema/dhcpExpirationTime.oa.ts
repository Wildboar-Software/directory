...
/* START_OF_SYMBOL_DEFINITION dhcpExpirationTime */
/**
 * @summary dhcpExpirationTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpExpirationTime: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpExpirationTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "This is the time the current lease for an address expires." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 23,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpExpirationTime */
