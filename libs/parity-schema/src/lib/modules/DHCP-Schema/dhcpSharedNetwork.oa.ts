 ...
 */
export
const dhcpSharedNetwork: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ dhcpSubnetDN, dhcpPoolDN, dhcpOptionsDN, dhcpStatements, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["dhcpSharedNetwork"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "This stores configuration information for a shared network." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 6, 2,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
