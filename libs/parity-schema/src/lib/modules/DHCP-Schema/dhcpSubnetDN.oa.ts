...
/* START_OF_SYMBOL_DEFINITION dhcpSubnetDN */
/**
 * @summary dhcpSubnetDN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpSubnetDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpSubnetDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The distinguished name(s) of the subnets." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 13,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpSubnetDN */
