...
/* START_OF_SYMBOL_DEFINITION dhcpPermitList */
/**
 * @summary dhcpPermitList
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpPermitList: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpPermitList"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 5,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpPermitList */
