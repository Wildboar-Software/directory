...
/* START_OF_SYMBOL_DEFINITION dhcpClassesDN */
/**
 * @summary dhcpClassesDN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhcpClassesDN: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dhcpClassesDN"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The distinguished name(s) of a class(es) in a subclass." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113719, 1, 203, 4, 16,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dhcpClassesDN */
