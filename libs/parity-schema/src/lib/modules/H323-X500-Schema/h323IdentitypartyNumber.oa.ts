...
/* START_OF_SYMBOL_DEFINITION h323IdentitypartyNumber */
/**
 * @summary h323IdentitypartyNumber
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323IdentitypartyNumber: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([7,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323IdentitypartyNumber */
