 ...
 */
export
const genericIdentity: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ genericIdentityProtocolIdentifier, genericIdentityMessage, ] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], gi_oc) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
