...
/* START_OF_SYMBOL_DEFINITION h323IdentityEndpointType */
/**
 * @summary h323IdentityEndpointType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323IdentityEndpointType: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([9,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323IdentityEndpointType */
