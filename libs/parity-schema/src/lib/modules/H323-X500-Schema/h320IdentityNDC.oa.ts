...
/* START_OF_SYMBOL_DEFINITION h320IdentityNDC */
/**
 * @summary h320IdentityNDC
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h320IdentityNDC: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([4,], h320_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h320IdentityNDC */
