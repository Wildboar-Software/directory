...
/* START_OF_SYMBOL_DEFINITION commPrivate */
/**
 * @summary commPrivate
 * @description
 * 
 ...
 */
export
const commPrivate: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([3,], co_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION commPrivate */
