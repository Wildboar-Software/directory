...
/* START_OF_SYMBOL_DEFINITION h323Identityemail_ID */
/**
 * @summary h323Identityemail_ID
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323Identityemail_ID: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([4,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323Identityemail_ID */
