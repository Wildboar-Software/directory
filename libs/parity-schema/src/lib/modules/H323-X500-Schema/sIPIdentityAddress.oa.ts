...
/* START_OF_SYMBOL_DEFINITION sIPIdentityAddress */
/**
 * @summary sIPIdentityAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sIPIdentityAddress: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([4,], sip_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sIPIdentityAddress */
