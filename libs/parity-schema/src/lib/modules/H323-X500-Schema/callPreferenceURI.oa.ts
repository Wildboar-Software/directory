...
import { call_id_at } from "../H323-X500-Schema/call-id-at.va";
export { call_id_at } from "../H323-X500-Schema/call-id-at.va";


/* START_OF_SYMBOL_DEFINITION callPreferenceURI */
/**
 * @summary callPreferenceURI
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const callPreferenceURI: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([1,], call_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION callPreferenceURI */
