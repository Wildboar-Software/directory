...
/* START_OF_SYMBOL_DEFINITION h320IdentitySN */
/**
 * @summary h320IdentitySN
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h320IdentitySN: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([5,], h320_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h320IdentitySN */
