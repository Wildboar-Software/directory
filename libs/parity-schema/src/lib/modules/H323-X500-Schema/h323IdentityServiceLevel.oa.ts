...
/* START_OF_SYMBOL_DEFINITION h323IdentityServiceLevel */
/**
 * @summary h323IdentityServiceLevel
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323IdentityServiceLevel: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([10,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323IdentityServiceLevel */
