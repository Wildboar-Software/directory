...
/* START_OF_SYMBOL_DEFINITION h323IdentitytransportID */
/**
 * @summary h323IdentitytransportID
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323IdentitytransportID: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([6,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323IdentitytransportID */
