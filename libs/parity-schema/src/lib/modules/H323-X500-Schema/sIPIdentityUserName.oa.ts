...
/* START_OF_SYMBOL_DEFINITION sIPIdentityUserName */
/**
 * @summary sIPIdentityUserName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sIPIdentityUserName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([6,], sip_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sIPIdentityUserName */
