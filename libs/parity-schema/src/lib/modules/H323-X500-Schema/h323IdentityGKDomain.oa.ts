...
/* START_OF_SYMBOL_DEFINITION h323IdentityGKDomain */
/**
 * @summary h323IdentityGKDomain
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323IdentityGKDomain: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([1,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323IdentityGKDomain */
