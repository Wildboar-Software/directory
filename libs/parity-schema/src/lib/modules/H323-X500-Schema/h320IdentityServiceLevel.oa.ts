...
/* START_OF_SYMBOL_DEFINITION h320IdentityServiceLevel */
/**
 * @summary h320IdentityServiceLevel
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h320IdentityServiceLevel: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([2,], h320_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h320IdentityServiceLevel */
