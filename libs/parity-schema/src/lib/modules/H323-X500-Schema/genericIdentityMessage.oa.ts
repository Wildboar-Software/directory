...
export { gi_at } from "../H323-X500-Schema/gi-at.va";


/* START_OF_SYMBOL_DEFINITION genericIdentityMessage */
/**
 * @summary genericIdentityMessage
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const genericIdentityMessage: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([2,], gi_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION genericIdentityMessage */
