...
/**
 * @summary sIPIdentityProxyAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sIPIdentityProxyAddress: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([3,], sip_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sIPIdentityProxyAddress */
