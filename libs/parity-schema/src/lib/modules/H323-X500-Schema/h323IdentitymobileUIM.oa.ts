...
/* START_OF_SYMBOL_DEFINITION h323IdentitymobileUIM */
/**
 * @summary h323IdentitymobileUIM
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323IdentitymobileUIM: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([8,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323IdentitymobileUIM */
