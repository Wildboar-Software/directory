...
/* START_OF_SYMBOL_DEFINITION h323Identityh323_ID */
/**
 * @summary h323Identityh323_ID
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h323Identityh323_ID: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([2,], h323_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h323Identityh323_ID */
