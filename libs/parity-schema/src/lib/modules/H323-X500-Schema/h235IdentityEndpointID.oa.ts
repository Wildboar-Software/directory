...
import { h235_id_at } from "../H323-X500-Schema/h235-id-at.va";
export { h235_id_at } from "../H323-X500-Schema/h235-id-at.va";


/* START_OF_SYMBOL_DEFINITION h235IdentityEndpointID */
/**
 * @summary h235IdentityEndpointID
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h235IdentityEndpointID: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([1,], h235_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h235IdentityEndpointID */
