...
/* START_OF_SYMBOL_DEFINITION commUniqueId */
/**
 * @summary commUniqueId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const commUniqueId: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([1,], co_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION commUniqueId */
