...
/* START_OF_SYMBOL_DEFINITION h235IdentityPassword */
/**
 * @summary h235IdentityPassword
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const h235IdentityPassword: ATTRIBUTE<OCTET_STRING> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([2,], h235_id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION h235IdentityPassword */
