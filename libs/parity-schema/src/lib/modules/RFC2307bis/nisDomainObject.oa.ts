 ...
 */
export
const nisDomainObject: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&ldapDesc": "Associates a NIS domain with a naming context" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 1, 1, 2, 15,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
