...
/* START_OF_SYMBOL_DEFINITION nisDomain */
/**
 * @summary nisDomain
 * @description
 * 
 ...
 */
export
const nisDomain: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["nisDomain"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NIS domain" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 1, 1, 1, 30,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION nisDomain */
