...
/* START_OF_SYMBOL_DEFINITION automountMapName */
/**
 * @summary automountMapName
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const automountMapName: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["automountMapName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "automount Map Name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 1, 1, 1, 31,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION automountMapName */
