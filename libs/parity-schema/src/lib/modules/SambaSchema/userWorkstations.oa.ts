...
/* START_OF_SYMBOL_DEFINITION userWorkstations */
/**
 * @summary userWorkstations
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const userWorkstations: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["userWorkstations"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "userWorkstations" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([13,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION userWorkstations */
