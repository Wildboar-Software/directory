...
/* START_OF_SYMBOL_DEFINITION rid */
/**
 * @summary rid
 * @description
 * 
...
const rid: ATTRIBUTE<INTEGER> = {
    ...
    "&ldapName": ["rid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NT rid" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([14,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
