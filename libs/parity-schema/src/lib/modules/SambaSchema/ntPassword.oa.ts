...
/* START_OF_SYMBOL_DEFINITION ntPassword */
/**
 * @summary ntPassword
 * @description
 * 
 ...
 */
export
const ntPassword: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ntPassword"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NT Passwd" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ntPassword */
