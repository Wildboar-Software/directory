...
/* START_OF_SYMBOL_DEFINITION lmPassword */
/**
 * @summary lmPassword
 * @description
 * 
 ...
 */
export
const lmPassword: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["lmPassword"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "LanManager Passwd" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION lmPassword */
