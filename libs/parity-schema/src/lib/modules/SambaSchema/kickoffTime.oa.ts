...
/* START_OF_SYMBOL_DEFINITION kickoffTime */
/**
 * @summary kickoffTime
 * @description
 * 
 ...
 */
export
const kickoffTime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["kickoffTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NT kickoffTime" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([7,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION kickoffTime */
