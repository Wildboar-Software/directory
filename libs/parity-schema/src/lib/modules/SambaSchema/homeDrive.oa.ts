...
/* START_OF_SYMBOL_DEFINITION homeDrive */
/**
 * @summary homeDrive
 * @description
 * 
 ...
 */
export
const homeDrive: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["homeDrive"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NT homeDrive" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION homeDrive */
