 ...
 */
export
const pwdMustChange: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapDesc": "NT pwdMustChange" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
