...
/* START_OF_SYMBOL_DEFINITION smbHome */
/**
 * @summary smbHome
 * @description
 * 
 ...
 */
export
const smbHome: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["smbHome"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "smbHome" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([17,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION smbHome */
