...
/* START_OF_SYMBOL_DEFINITION logoffTime */
/**
 * @summary logoffTime
 * @description
 * 
 ...
 */
export
const logoffTime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["logoffTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NT logoffTime" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6,], id_samba_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION logoffTime */
