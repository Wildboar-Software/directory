...
const mailHost: ATTRIBUTE<IA5String> = {
    ...
    "&ldapDesc": "FQDN of the SMTP/MTA of this recipient" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 18,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
