...
/* START_OF_SYMBOL_DEFINITION mailLocalAddress */
/**
 * @summary mailLocalAddress
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mailLocalAddress: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mailLocalAddress"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC822 email address of this recipient" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 13,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailLocalAddress */
