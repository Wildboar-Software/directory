...
/* START_OF_SYMBOL_DEFINITION authorizedService */
/**
 * @summary authorizedService
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const authorizedService: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["authorizedService"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "IANA GSS-API authorized service name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 17, 2, 1,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION authorizedService */
