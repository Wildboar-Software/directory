 ...
 */
export
const sabayonProfile: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ sabayonProfileURL, description, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["sabayonProfile"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "sabayon profile" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 2312, 4, 3, 4, 1,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
