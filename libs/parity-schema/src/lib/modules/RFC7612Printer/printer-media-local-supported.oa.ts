 ...
 */
export const printer_media_local_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'One of the site-specific media supported by this Printer.' /* OBJECT_FIELD_SETTING */,
        '&id': _OID.fromParts([
            1, 3, 18, 0, 2, 4, 1117,
