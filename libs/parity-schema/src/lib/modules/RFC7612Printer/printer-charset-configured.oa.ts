...
/* START_OF_SYMBOL_DEFINITION printer_charset_configured */
/**
 * @summary printer_charset_configured
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_charset_configured: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-charset-configured"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The configured charset for IPP protocol values of error and status messages generated by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1109,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_charset_configured */
