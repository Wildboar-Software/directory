...
/* START_OF_SYMBOL_DEFINITION printer_uuid */
/**
 * @summary printer_uuid
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_uuid: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-uuid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A URN specifying the UUID of this Printer (print service) instance on this Imaging Device (host system)." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 24, 46, 1, 104,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_uuid */
