 ...
 */
export const printer_uuid: ATTRIBUTE<UnboundedDirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'A URN specifying the UUID of this Printer (print service) instance on this Imaging Device (host system).' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
