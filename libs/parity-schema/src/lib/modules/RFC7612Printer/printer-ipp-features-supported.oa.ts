 ...
 */
export const printer_ipp_features_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'Comma-delimited list of IPP protocol features that this Printer supports.' /* OBJECT_FIELD_SETTING */,
        '&id': _OID.fromParts([
