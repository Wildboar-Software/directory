...
/* START_OF_SYMBOL_DEFINITION printer_ipp_features_supported */
/**
 * @summary printer_ipp_features_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_ipp_features_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-ipp-features-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Comma-delimited list of IPP protocol features that this Printer supports." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 24, 46, 1, 108,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_ipp_features_supported */
