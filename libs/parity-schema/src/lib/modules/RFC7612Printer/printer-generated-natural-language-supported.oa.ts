...
/* START_OF_SYMBOL_DEFINITION printer_generated_natural_language_supported */
/**
 * @summary printer_generated_natural_language_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_generated_natural_language_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-generated-natural-language-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "One of the natural languages supported for LDAP attributes of syntax DirectoryString (UTF-8) in this directory entry." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1137,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_generated_natural_language_supported */
