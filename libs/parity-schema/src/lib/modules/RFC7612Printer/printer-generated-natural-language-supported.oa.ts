 ...
 */
export const printer_generated_natural_language_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'One of the natural languages supported for LDAP attributes of syntax DirectoryString (UTF-8) in this directory entry.' /* OBJECT_FIELD_SETTING */,
        '&id': _OID.fromParts([
            1, 3, 18, 0, 2, 4, 1137,
