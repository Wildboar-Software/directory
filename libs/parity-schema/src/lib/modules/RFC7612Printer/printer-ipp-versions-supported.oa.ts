 ...
 */
export const printer_ipp_versions_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'Comma-delimited list of IPP versions supported by this Printer.' /* OBJECT_FIELD_SETTING */,
        '&id': _OID.fromParts([
            1, 3, 18, 0, 2, 4, 1133,
