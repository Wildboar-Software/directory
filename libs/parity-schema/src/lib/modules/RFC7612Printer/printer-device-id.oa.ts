...
/* START_OF_SYMBOL_DEFINITION printer_device_id */
/**
 * @summary printer_device_id
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_device_id: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-device-id"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The IEEE 1284 Device ID for this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 24, 46, 1, 101,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_device_id */
