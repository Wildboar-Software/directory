...
/* START_OF_SYMBOL_DEFINITION printer_service_person */
/**
 * @summary printer_service_person
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_service_person: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-service-person"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The identity of the current human service person responsible for servicing this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1113,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_service_person */
