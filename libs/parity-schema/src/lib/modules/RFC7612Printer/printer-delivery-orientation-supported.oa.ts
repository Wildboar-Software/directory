...
/* START_OF_SYMBOL_DEFINITION printer_delivery_orientation_supported */
/**
 * @summary printer_delivery_orientation_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_delivery_orientation_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-delivery-orientation-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Comma-delimited list of delivery orientations of pages as they are printed and ejected supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1114,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_delivery_orientation_supported */
