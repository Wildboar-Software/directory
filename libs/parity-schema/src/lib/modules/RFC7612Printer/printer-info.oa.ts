...
/* START_OF_SYMBOL_DEFINITION printer_info */
/**
 * @summary printer_info
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_info: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-info"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Descriptive information about this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1139,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_info */
