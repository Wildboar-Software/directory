...
import {
    slpService,
} from "../RFC2926ServiceLocationProtocolSchema/slpService.oa";
 ...
 */
export
const slpServicePrinter: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&ldapDesc": "Service Location Protocol (SLP) information." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 6, 254,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
