...
/* START_OF_SYMBOL_DEFINITION printer_multiple_document_jobs_supported */
/**
 * @summary printer_multiple_document_jobs_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_multiple_document_jobs_supported: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["printer-multiple-document-jobs-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Indicates whether or not this Printer supports more than one document per job." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1132,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_multiple_document_jobs_supported */
