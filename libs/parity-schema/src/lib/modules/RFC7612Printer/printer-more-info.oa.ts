...
/* START_OF_SYMBOL_DEFINITION printer_more_info */
/**
 * @summary printer_more_info
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_more_info: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-more-info"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A URI for more information about this specific Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1134,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_more_info */
