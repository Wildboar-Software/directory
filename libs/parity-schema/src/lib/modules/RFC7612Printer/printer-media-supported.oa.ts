...
/* START_OF_SYMBOL_DEFINITION printer_media_supported */
/**
 * @summary printer_media_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_media_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-media-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "One of the names/sizes/types/colors of the media supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1122,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_media_supported */
