...
/* START_OF_SYMBOL_DEFINITION printer_pages_per_minute_color */
/**
 * @summary printer_pages_per_minute_color
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_pages_per_minute_color: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["printer-pages-per-minute-color"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The nominal number of color pages per minute that can be output by this Printer.." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1126,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_pages_per_minute_color */
