 ...
 */
export const printer_pages_per_minute_color: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapDesc':
        'The nominal number of color pages per minute that can be output by this Printer..' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
        1, 3, 18, 0, 2, 4, 1126,
