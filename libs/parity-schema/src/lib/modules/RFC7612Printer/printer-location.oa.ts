...
/* START_OF_SYMBOL_DEFINITION printer_location */
/**
 * @summary printer_location
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_location: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-location"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The physical location of this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1136,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_location */
