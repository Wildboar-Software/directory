 ...
 */
export
const printer_natural_language_configured: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-natural-language-configured"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The configured natural language for LDAP attributes of syntax DirectoryString (UTF-8) in this directory entry." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1119,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
