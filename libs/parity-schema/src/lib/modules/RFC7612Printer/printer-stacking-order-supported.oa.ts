...
/* START_OF_SYMBOL_DEFINITION printer_stacking_order_supported */
/**
 * @summary printer_stacking_order_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_stacking_order_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-stacking-order-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Comma-delimited list of stacking orders of pages as they are printed and ejected supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1115,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_stacking_order_supported */
