 ...
 */
export const printer_stacking_order_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'Comma-delimited list of stacking orders of pages as they are printed and ejected supported by this Printer.' /* OBJECT_FIELD_SETTING */,
        '&id': _OID.fromParts([
            1, 3, 18, 0, 2, 4, 1115,
