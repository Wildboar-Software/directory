...
/* START_OF_SYMBOL_DEFINITION printer_charge_info_uri */
/**
 * @summary printer_charge_info_uri
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_charge_info_uri: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-charge-info-uri"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A URI for a human-readable Web page for paid printing services for this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 24, 46, 1, 106,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_charge_info_uri */
