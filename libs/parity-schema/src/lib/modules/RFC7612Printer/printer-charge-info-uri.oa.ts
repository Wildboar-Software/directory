 ...
 */
export const printer_charge_info_uri: ATTRIBUTE<UnboundedDirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'A URI for a human-readable Web page for paid printing services for this Printer.' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
