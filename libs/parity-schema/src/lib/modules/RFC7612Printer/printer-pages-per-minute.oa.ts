...
/* START_OF_SYMBOL_DEFINITION printer_pages_per_minute */
/**
 * @summary printer_pages_per_minute
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_pages_per_minute: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["printer-pages-per-minute"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The nominal number of pages per minute that can be output by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1127,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_pages_per_minute */
