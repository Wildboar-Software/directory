...
/* START_OF_SYMBOL_DEFINITION printer_job_priority_supported */
/**
 * @summary printer_job_priority_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_job_priority_supported: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["printer-job-priority-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Indicates the number of job priority levels supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1110,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_job_priority_supported */
