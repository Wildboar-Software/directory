...
/* START_OF_SYMBOL_DEFINITION printer_charset_supported */
/**
 * @summary printer_charset_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_charset_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-charset-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "One of the charsets supported for IPP protocol values of IPP string attributes that correspond to attributes of syntax DirectoryString (UTF-8) for this directory entry." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1131,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_charset_supported */
