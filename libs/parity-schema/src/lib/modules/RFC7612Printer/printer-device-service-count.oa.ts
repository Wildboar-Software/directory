 ...
 */
export const printer_device_service_count: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapDesc':
        'The number of Printer (print service) instances configured on this Imaging Device (host system).' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
