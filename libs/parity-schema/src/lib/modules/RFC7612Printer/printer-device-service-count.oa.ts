...
/* START_OF_SYMBOL_DEFINITION printer_device_service_count */
/**
 * @summary printer_device_service_count
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_device_service_count: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["printer-device-service-count"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of Printer (print service) instances configured on this Imaging Device (host system)." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 24, 46, 1, 102,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_device_service_count */
