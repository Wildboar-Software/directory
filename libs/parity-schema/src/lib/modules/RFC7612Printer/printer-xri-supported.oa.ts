...
/* START_OF_SYMBOL_DEFINITION printer_xri_supported */
/**
 * @summary printer_xri_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_xri_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-xri-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "An XRI (extended resource identifier) supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1107,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_xri_supported */
