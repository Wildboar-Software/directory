...
/* START_OF_SYMBOL_DEFINITION printer_resolution_supported */
/**
 * @summary printer_resolution_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_resolution_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-resolution-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "One of the resolutions supported for printing documents by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1121,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_resolution_supported */
