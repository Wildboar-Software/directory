 ...
 */
export const printer_resolution_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'One of the resolutions supported for printing documents by this Printer.' /* OBJECT_FIELD_SETTING */,
        '&id': new _OID([
            1, 3, 18, 0, 2, 4, 1121,
