...
/* START_OF_SYMBOL_DEFINITION printer_color_supported */
/**
 * @summary printer_color_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_color_supported: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["printer-color-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Indicates whether or not this Printer is capable of any type of color printing at all, including highlight color." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1129,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_color_supported */
