...
/* START_OF_SYMBOL_DEFINITION printer_current_operator */
/**
 * @summary printer_current_operator
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_current_operator: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-current-operator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The identity of the current human operator responsible for operating this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1112,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_current_operator */
