 ...
 */
export const printer_sides_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'Comma-delimited list of impression sides (one or two) and the two-sided impression rotations supported by this Printer.' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
        1, 3, 18, 0, 2, 4, 1123,
