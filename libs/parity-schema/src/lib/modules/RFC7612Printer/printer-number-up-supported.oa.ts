 ...
 */
export const printer_number_up_supported: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapDesc':
        'Maximum number of print-stream pages that can be imposed upon a single side of an instance of a selected medium by this Printer.' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
        1, 3, 18, 0, 2, 4, 1124,
