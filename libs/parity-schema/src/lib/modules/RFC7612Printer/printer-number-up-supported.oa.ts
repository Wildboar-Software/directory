...
/* START_OF_SYMBOL_DEFINITION printer_number_up_supported */
/**
 * @summary printer_number_up_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_number_up_supported: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["printer-number-up-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Maximum number of print-stream pages that can be imposed upon a single side of an instance of a selected medium by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1124,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_number_up_supported */
