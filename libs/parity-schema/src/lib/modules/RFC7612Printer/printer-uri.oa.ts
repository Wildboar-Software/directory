...
/* START_OF_SYMBOL_DEFINITION printer_uri */
/**
 * @summary printer_uri
 * @description
 * 
 ...
 */
export
const printer_uri: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-uri"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A URI supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1140,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_uri */
