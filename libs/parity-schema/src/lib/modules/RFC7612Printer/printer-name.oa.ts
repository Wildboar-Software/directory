...
/* START_OF_SYMBOL_DEFINITION printer_name */
/**
 * @summary printer_name
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_name: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-name"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The site-specific administrative name of this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1135,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_name */
