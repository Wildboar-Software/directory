 ...
 */
export const printer_finishings_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'Comma-delimited list of finishing operations supported by this Printer.' /* OBJECT_FIELD_SETTING */,
        '&id': new _OID([
            1, 3, 18, 0, 2, 4, 1125,
