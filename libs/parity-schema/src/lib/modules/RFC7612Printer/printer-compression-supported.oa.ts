...
/* START_OF_SYMBOL_DEFINITION printer_compression_supported */
/**
 * @summary printer_compression_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_compression_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-compression-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Comma-delimited list of compression algorithms supported by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1128,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_compression_supported */
