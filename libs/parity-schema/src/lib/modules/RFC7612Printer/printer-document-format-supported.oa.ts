...
/* START_OF_SYMBOL_DEFINITION printer_document_format_supported */
/**
 * @summary printer_document_format_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_document_format_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-document-format-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "One of the source document formats that can be interpreted and printed by this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1130,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_document_format_supported */
