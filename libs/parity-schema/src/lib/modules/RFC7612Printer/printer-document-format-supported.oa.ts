 ...
 */
export const printer_document_format_supported: ATTRIBUTE<UnboundedDirectoryString> =
    {
        class: 'ATTRIBUTE',
        decoderFor: {
        ...
        '&ldapDesc':
            'One of the source document formats that can be interpreted and printed by this Printer.' /* OBJECT_FIELD_SETTING */,
        '&id': new _OID([
            1, 3, 18, 0, 2, 4, 1130,
