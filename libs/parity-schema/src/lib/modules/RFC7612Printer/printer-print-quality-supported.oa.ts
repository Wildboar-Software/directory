 ...
 */
export
const printer_print_quality_supported: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-print-quality-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Comma-delimited list of print qualities supported for printing documents on this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1120,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
