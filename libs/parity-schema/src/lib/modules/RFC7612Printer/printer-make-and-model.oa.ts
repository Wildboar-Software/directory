...
/* START_OF_SYMBOL_DEFINITION printer_make_and_model */
/**
 * @summary printer_make_and_model
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_make_and_model: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-make-and-model"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Make and model of this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1138,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_make_and_model */
