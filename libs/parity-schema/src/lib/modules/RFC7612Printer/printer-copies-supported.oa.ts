...
/* START_OF_SYMBOL_DEFINITION printer_copies_supported */
/**
 * @summary printer_copies_supported
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_copies_supported: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["printer-copies-supported"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The maximum number of copies of a document that can be printed as a single job on this Printer." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1118,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_copies_supported */
