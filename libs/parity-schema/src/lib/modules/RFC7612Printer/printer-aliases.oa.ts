...
/* START_OF_SYMBOL_DEFINITION printer_aliases */
/**
 * @summary printer_aliases
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const printer_aliases: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["printer-aliases"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "One of the site-specific administrative names of this Printer in addition to the value specified for printer-name." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 18, 0, 2, 4, 1108,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION printer_aliases */
