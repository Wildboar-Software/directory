...
/* START_OF_SYMBOL_DEFINITION service_advert_attribute_authenticator */
/**
 * @summary service_advert_attribute_authenticator
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const service_advert_attribute_authenticator: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["service-advert-attribute-authenticator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The authenticator for the attribute list, null if none." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 7,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION service_advert_attribute_authenticator */
