 ...
 */
export
const service_advert_scopes: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "A list of scopes for a service advertisement." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 5,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
