 ...
 */
export
const service_advert_url_authenticator: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["service-advert-url-authenticator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The authenticator for the URL, null if none." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 6,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
