 ...
 */
export
const template_major_version_number: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapDesc": "The major version number of the service type template" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 1,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
