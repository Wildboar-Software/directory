 ...
 */
export
const service_advert_service_type: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "The service type of the service advertisement, including the 'service:' prefix." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 4,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
