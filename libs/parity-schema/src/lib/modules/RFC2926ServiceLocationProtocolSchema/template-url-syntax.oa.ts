 ...
 */
export
const template_url_syntax: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "An ABNF grammar describing the service type specific part of the service URL" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 3,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
