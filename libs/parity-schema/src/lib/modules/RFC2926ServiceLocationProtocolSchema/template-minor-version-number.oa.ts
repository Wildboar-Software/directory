...
/* START_OF_SYMBOL_DEFINITION template_minor_version_number */
/**
 * @summary template_minor_version_number
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const template_minor_version_number: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["template-minor-version-number"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The minor version number of the service type template" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 27, 6, 1, 2,], id_james_kempf) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION template_minor_version_number */
