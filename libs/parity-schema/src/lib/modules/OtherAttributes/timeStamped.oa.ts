...
import { TimeStamped, _decode_TimeStamped, _encode_TimeStamped } from "../OtherAutomaticallyTaggedTypes/TimeStamped.ta";
export { TimeStamped, _decode_TimeStamped, _encode_TimeStamped } from "../OtherAutomaticallyTaggedTypes/TimeStamped.ta";
import { id_timeStamped } from "../OtherAttributes/id-timeStamped.va";
export { id_timeStamped } from "../OtherAttributes/id-timeStamped.va";
 ...
 */
export
const timeStamped: ATTRIBUTE<TimeStamped> = {
    class: "ATTRIBUTE",
    decoderFor: {
