...
import { TargetHardwareIdentifiers, _decode_TargetHardwareIdentifiers, _encode_TargetHardwareIdentifiers } from "../OtherImplicitlyTaggedTypes/TargetHardwareIdentifiers.ta";
export { TargetHardwareIdentifiers, _decode_TargetHardwareIdentifiers, _encode_TargetHardwareIdentifiers } from "../OtherImplicitlyTaggedTypes/TargetHardwareIdentifiers.ta";
import { id_aa_targetHardwareIDs } from "../OtherAttributes/id-aa-targetHardwareIDs.va";
export { id_aa_targetHardwareIDs } from "../OtherAttributes/id-aa-targetHardwareIDs.va";
