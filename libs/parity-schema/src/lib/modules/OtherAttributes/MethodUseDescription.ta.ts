...
import { ub_schema } from "@wildboar/x500/src/lib/modules/UpperBounds/ub-schema.va";
...
class MethodUseDescription {
    ...
    public static _from_object (_o: { [_K in keyof (MethodUseDescription)]: (MethodUseDescription)[_K] }): MethodUseDescription {
        return new MethodUseDescription(_o.identifier, _o.name, _o.description, _o.obsolete, _o.information, _o._unrecognizedExtensionsList);
    }
