...
import { URIs, _decode_URIs, _encode_URIs } from "../OtherAutomaticallyTaggedTypes/URIs.ta";
export { URIs, _decode_URIs, _encode_URIs } from "../OtherAutomaticallyTaggedTypes/URIs.ta";
 ...
 */
export
const contentLocations: ATTRIBUTE<URIs> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_URIs,
    },
