...
import { Sidechains, _decode_Sidechains, _encode_Sidechains } from "../OtherAutomaticallyTaggedTypes/Sidechains.ta";
export { Sidechains, _decode_Sidechains, _encode_Sidechains } from "../OtherAutomaticallyTaggedTypes/Sidechains.ta";
import { id_sidechains } from "../OtherAttributes/id-sidechains.va";
export { id_sidechains } from "../OtherAttributes/id-sidechains.va";
 ...
 */
export
const sidechains: ATTRIBUTE<Sidechains> = {
    class: "ATTRIBUTE",
    decoderFor: {
