...
import { SSIDList, _decode_SSIDList, _encode_SSIDList } from "../OtherImplicitlyTaggedTypes/SSIDList.ta";
export { SSIDList, _decode_SSIDList, _encode_SSIDList } from "../OtherImplicitlyTaggedTypes/SSIDList.ta";
import { id_aca_wlanSSID } from "../OtherAttributes/id-aca-wlanSSID.va";
export { id_aca_wlanSSID } from "../OtherAttributes/id-aca-wlanSSID.va";
 ...
 */
export
const wlanSSID: ATTRIBUTE<SSIDList> = {
    class: "ATTRIBUTE",
    decoderFor: {
