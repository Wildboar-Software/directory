...
import { PBKDF2_params_salt, _decode_PBKDF2_params_salt, _encode_PBKDF2_params_salt } from "../OtherAttributes/PBKDF2-params-salt.ta";
export { PBKDF2_params_salt, _decode_PBKDF2_params_salt, _encode_PBKDF2_params_salt } from "../OtherAttributes/PBKDF2-params-salt.ta";
...
class PBKDF2_params {
     ...
     */
    public static _from_object (_o: { [_K in keyof (PBKDF2_params)]: (PBKDF2_params)[_K] }): PBKDF2_params {
        return new PBKDF2_params(_o.salt, _o.iterationCount, _o.keyLength, _o.prf, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PBKDF2_params: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("prf", false, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_PBKDF2_params: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PBKDF2_params: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PBKDF2_params (el: _Element) {
    if (!_cached_decoder_for_PBKDF2_params) { _cached_decoder_for_PBKDF2_params = function (el: _Element): PBKDF2_params {
    ...
    const callbacks: $.DecodingMap = {
        "salt": (_el: _Element): void => { salt = _decode_PBKDF2_params_salt(_el); },
        "iterationCount": (_el: _Element): void => { iterationCount = $._decodeInteger(_el); },
        "keyLength": (_el: _Element): void => { keyLength = $._decodeInteger(_el); },
        "prf": (_el: _Element): void => { prf = _decode_AlgorithmIdentifier(_el); }
    };
 ...
 */
export
function _encode_PBKDF2_params (value: PBKDF2_params, elGetter: $.ASN1Encoder<PBKDF2_params>) {
    if (!_cached_encoder_for_PBKDF2_params) { _cached_encoder_for_PBKDF2_params = function (value: PBKDF2_params, elGetter: $.ASN1Encoder<PBKDF2_params>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.prf, $.BER)
        ],
