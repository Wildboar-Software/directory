...
import { AccessService, _decode_AccessService, _encode_AccessService } from "../OtherImplicitlyTaggedTypes/AccessService.ta";
export { AccessService, _decode_AccessService, _encode_AccessService } from "../OtherImplicitlyTaggedTypes/AccessService.ta";
 ...
 */
export
const accessService: ATTRIBUTE<AccessService> = {
    class: "ATTRIBUTE",
    decoderFor: {
