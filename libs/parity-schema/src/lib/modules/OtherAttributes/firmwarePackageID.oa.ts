...
import {
    ...
    _decode_FirmwarePackageIdentifier,
    _encode_FirmwarePackageIdentifier,
} from '../OtherImplicitlyTaggedTypes/FirmwarePackageIdentifier.ta';
 ...
 */
export const firmwarePackageID: ATTRIBUTE<FirmwarePackageIdentifier> = {
    class: 'ATTRIBUTE',
    decoderFor: {
