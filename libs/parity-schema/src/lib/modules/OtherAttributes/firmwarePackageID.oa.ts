...
import { FirmwarePackageIdentifier, _decode_FirmwarePackageIdentifier, _encode_FirmwarePackageIdentifier } from "../OtherImplicitlyTaggedTypes/FirmwarePackageIdentifier.ta";
export { FirmwarePackageIdentifier, _decode_FirmwarePackageIdentifier, _encode_FirmwarePackageIdentifier } from "../OtherImplicitlyTaggedTypes/FirmwarePackageIdentifier.ta";
import { id_aa_firmwarePackageID } from "../OtherAttributes/id-aa-firmwarePackageID.va";
export { id_aa_firmwarePackageID } from "../OtherAttributes/id-aa-firmwarePackageID.va";
