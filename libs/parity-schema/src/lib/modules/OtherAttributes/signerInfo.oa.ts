...
import { SignerInfo, _decode_SignerInfo, _encode_SignerInfo } from "@wildboar/cms/src/lib/modules/CryptographicMessageSyntax-2010/SignerInfo.ta";
export { SignerInfo, _decode_SignerInfo, _encode_SignerInfo } from "@wildboar/cms/src/lib/modules/CryptographicMessageSyntax-2010/SignerInfo.ta";
 ...
 */
export
const signerInfo: ATTRIBUTE<SignerInfo> = {
    class: "ATTRIBUTE",
    decoderFor: {
