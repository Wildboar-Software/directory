...
import { ub_clearance_sponsor } from "../OtherImplicitlyTaggedTypes/ub-clearance-sponsor.va";
export { ub_clearance_sponsor } from "../OtherImplicitlyTaggedTypes/ub-clearance-sponsor.va";
...
export { id_clearanceSponsor } from "../OtherAttributes/id-clearanceSponsor.va";
 ...
 */
export
const clearanceSponsor: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "IETF RFC 5917: The sponsor of the clearance of the subject with which this attribute is associated" /* OBJECT_FIELD_SETTING */,
