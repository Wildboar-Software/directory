...
export { id_pda_dateOfBirth } from "../OtherAttributes/id-pda-dateOfBirth.va";
 ...
 */
export
const dateOfBirth: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "IETF RFC 3739: Date of birth of the subject" /* OBJECT_FIELD_SETTING */,
