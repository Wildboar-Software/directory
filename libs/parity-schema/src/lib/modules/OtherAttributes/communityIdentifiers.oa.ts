...
import { CommunityIdentifiers, _decode_CommunityIdentifiers, _encode_CommunityIdentifiers } from "../OtherImplicitlyTaggedTypes/CommunityIdentifiers.ta";
export { CommunityIdentifiers, _decode_CommunityIdentifiers, _encode_CommunityIdentifiers } from "../OtherImplicitlyTaggedTypes/CommunityIdentifiers.ta";
import { id_aa_communityIdentifiers } from "../OtherAttributes/id-aa-communityIdentifiers.va";
export { id_aa_communityIdentifiers } from "../OtherAttributes/id-aa-communityIdentifiers.va";
