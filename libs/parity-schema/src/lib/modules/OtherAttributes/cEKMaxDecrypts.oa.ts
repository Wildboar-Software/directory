...
import { CEKMaxDecrypts, _decode_CEKMaxDecrypts, _encode_CEKMaxDecrypts } from "../OtherAttributes/CEKMaxDecrypts.ta";
export { CEKMaxDecrypts, _decode_CEKMaxDecrypts, _encode_CEKMaxDecrypts } from "../OtherAttributes/CEKMaxDecrypts.ta";
...
export { id_aa_CEKReference } from "../OtherAttributes/id-aa-CEKReference.va";
 ...
 */
export
const cEKMaxDecrypts: ATTRIBUTE<CEKMaxDecrypts> = {
    class: "ATTRIBUTE",
    decoderFor: {
