...
import { ExtensionReq, _decode_ExtensionReq, _encode_ExtensionReq } from "../OtherImplicitlyTaggedTypes/ExtensionReq.ta";
export { ExtensionReq, _decode_ExtensionReq, _encode_ExtensionReq } from "../OtherImplicitlyTaggedTypes/ExtensionReq.ta";
import { id_ExtensionReq } from "../OtherAttributes/id-ExtensionReq.va";
export { id_ExtensionReq } from "../OtherAttributes/id-ExtensionReq.va";
 ...
 */
export
const extension_req: ATTRIBUTE<ExtensionReq> = {
    class: "ATTRIBUTE",
    decoderFor: {
