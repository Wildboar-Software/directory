 ...
 */
export
function _decode_PBKDF2_params_salt (el: _Element) {
    if (!_cached_decoder_for_PBKDF2_params_salt) { _cached_decoder_for_PBKDF2_params_salt = $._decode_extensible_choice<PBKDF2_params_salt>({
 ...
 */
export
function _encode_PBKDF2_params_salt (value: PBKDF2_params_salt, elGetter: $.ASN1Encoder<PBKDF2_params_salt>) {
    if (!_cached_encoder_for_PBKDF2_params_salt) { _cached_encoder_for_PBKDF2_params_salt = $._encode_choice<PBKDF2_params_salt>({
