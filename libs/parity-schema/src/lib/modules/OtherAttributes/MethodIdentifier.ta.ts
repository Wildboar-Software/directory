...
import { METHOD } from "../OtherAttributes/METHOD.oca";
...
class MethodIdentifier {
    ...
    public static _from_object (_o: { [_K in keyof (MethodIdentifier)]: (MethodIdentifier)[_K] }): MethodIdentifier {
        return new MethodIdentifier(_o.methodid, _o.inputAttributes, _o.specific_Input, _o._unrecognizedExtensionsList);
    }
