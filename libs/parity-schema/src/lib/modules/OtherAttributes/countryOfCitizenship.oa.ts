...
export { id_pda_countryOfCitizenship } from "../OtherAttributes/id-pda-countryOfCitizenship.va";
 ...
 */
export
const countryOfCitizenship: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "IETF RFC 3739: Country of citizenship of the subject" /* OBJECT_FIELD_SETTING */,
