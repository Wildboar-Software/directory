...
import { ImplementedCompressAlgorithms, _decode_ImplementedCompressAlgorithms, _encode_ImplementedCompressAlgorithms } from "../OtherImplicitlyTaggedTypes/ImplementedCompressAlgorithms.ta";
export { ImplementedCompressAlgorithms, _decode_ImplementedCompressAlgorithms, _encode_ImplementedCompressAlgorithms } from "../OtherImplicitlyTaggedTypes/ImplementedCompressAlgorithms.ta";
import { id_aa_implCompressAlgs } from "../OtherAttributes/id-aa-implCompressAlgs.va";
export { id_aa_implCompressAlgs } from "../OtherAttributes/id-aa-implCompressAlgs.va";
