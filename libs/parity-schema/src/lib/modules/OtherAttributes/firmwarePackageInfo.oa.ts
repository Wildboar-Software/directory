...
import { FirmwarePackageInfo, _decode_FirmwarePackageInfo, _encode_FirmwarePackageInfo } from "../OtherImplicitlyTaggedTypes/FirmwarePackageInfo.ta";
export { FirmwarePackageInfo, _decode_FirmwarePackageInfo, _encode_FirmwarePackageInfo } from "../OtherImplicitlyTaggedTypes/FirmwarePackageInfo.ta";
import { id_aa_firmwarePackageInfo } from "../OtherAttributes/id-aa-firmwarePackageInfo.va";
export { id_aa_firmwarePackageInfo } from "../OtherAttributes/id-aa-firmwarePackageInfo.va";
