...
import { CMCUnsignedData, _decode_CMCUnsignedData, _encode_CMCUnsignedData } from "../OtherImplicitlyTaggedTypes/CMCUnsignedData.ta";
export { CMCUnsignedData, _decode_CMCUnsignedData, _encode_CMCUnsignedData } from "../OtherImplicitlyTaggedTypes/CMCUnsignedData.ta";
import { id_aa_cmc_unsignedData } from "../OtherAttributes/id-aa-cmc-unsignedData.va";
export { id_aa_cmc_unsignedData } from "../OtherAttributes/id-aa-cmc-unsignedData.va";
 ...
 */
export
const unsignedData: ATTRIBUTE<CMCUnsignedData> = {
    class: "ATTRIBUTE",
    decoderFor: {
