...
import { Tokenized, _decode_Tokenized, _encode_Tokenized } from "../OtherAutomaticallyTaggedTypes/Tokenized.ta";
export { Tokenized, _decode_Tokenized, _encode_Tokenized } from "../OtherAutomaticallyTaggedTypes/Tokenized.ta";
 ...
 */
export
const tokenizedParts: ATTRIBUTE<Tokenized> = {
    class: "ATTRIBUTE",
    decoderFor: {
