...
import { SignerInfos, _decode_SignerInfos, _encode_SignerInfos } from "@wildboar/cms/src/lib/modules/CryptographicMessageSyntax-2010/SignerInfos.ta";
export { SignerInfos, _decode_SignerInfos, _encode_SignerInfos } from "@wildboar/cms/src/lib/modules/CryptographicMessageSyntax-2010/SignerInfos.ta";
 ...
 */
export
const signerInfos: ATTRIBUTE<SignerInfos> = {
    class: "ATTRIBUTE",
    decoderFor: {
