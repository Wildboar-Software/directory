...
import { SMIMECapabilities, _decode_SMIMECapabilities, _encode_SMIMECapabilities } from "../OtherAttributes/SMIMECapabilities.ta";
export { SMIMECapabilities, _decode_SMIMECapabilities, _encode_SMIMECapabilities } from "../OtherAttributes/SMIMECapabilities.ta";
import { id_smimeCapabilities } from "../OtherAttributes/id-smimeCapabilities.va";
export { id_smimeCapabilities } from "../OtherAttributes/id-smimeCapabilities.va";
 ...
 */
export
const smimeCapabilities: ATTRIBUTE<SMIMECapabilities> = {
    class: "ATTRIBUTE",
    decoderFor: {
