...
import { SigncryptedKey, _decode_SigncryptedKey, _encode_SigncryptedKey } from "../OtherAutomaticallyTaggedTypes/SigncryptedKey.ta";
export { SigncryptedKey, _decode_SigncryptedKey, _encode_SigncryptedKey } from "../OtherAutomaticallyTaggedTypes/SigncryptedKey.ta";
import { signcrypted_envelope } from "../OtherAttributes/signcrypted-envelope.va";
export { signcrypted_envelope } from "../OtherAttributes/signcrypted-envelope.va";
 ...
 */
export
const signcryptedEnvelope: ATTRIBUTE<SigncryptedKey> = {
    class: "ATTRIBUTE",
    decoderFor: {
