...
import { SvceAuthInfo, _decode_SvceAuthInfo, _encode_SvceAuthInfo } from "../OtherImplicitlyTaggedTypes/SvceAuthInfo.ta";
export { SvceAuthInfo, _decode_SvceAuthInfo, _encode_SvceAuthInfo } from "../OtherImplicitlyTaggedTypes/SvceAuthInfo.ta";
import { id_aca } from "./id-aca.va";

/* START_OF_SYMBOL_DEFINITION accesIdentity */
/**
 * @summary accesIdentity
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const accesIdentity: ATTRIBUTE<SvceAuthInfo> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([ 2 ], id_aca) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION accesIdentity */
