...
import { CEKReference, _decode_CEKReference, _encode_CEKReference } from "../OtherAttributes/CEKReference.ta";
export { CEKReference, _decode_CEKReference, _encode_CEKReference } from "../OtherAttributes/CEKReference.ta";
 ...
 */
export
const cEKReference: ATTRIBUTE<CEKReference> = {
    class: "ATTRIBUTE",
    decoderFor: {
