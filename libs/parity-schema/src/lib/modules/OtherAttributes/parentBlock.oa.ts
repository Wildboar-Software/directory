...
import { ParentBlock, _decode_ParentBlock, _encode_ParentBlock } from "../OtherAutomaticallyTaggedTypes/ParentBlock.ta";
export { ParentBlock, _decode_ParentBlock, _encode_ParentBlock } from "../OtherAutomaticallyTaggedTypes/ParentBlock.ta";
import { id_parentBlock } from "../OtherAttributes/id-parentBlock.va";
export { id_parentBlock } from "../OtherAttributes/id-parentBlock.va";
 ...
 */
export
const parentBlock: ATTRIBUTE<ParentBlock> = {
    class: "ATTRIBUTE",
    decoderFor: {
