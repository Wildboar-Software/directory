...
import { id_pda_gender } from "../OtherAttributes/id-pda-gender.va";
export { id_pda_gender } from "../OtherAttributes/id-pda-gender.va";
 ...
 */
export
const gender: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["gender"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "IETF RFC 3739: Gender of the subject" /* OBJECT_FIELD_SETTING */,
