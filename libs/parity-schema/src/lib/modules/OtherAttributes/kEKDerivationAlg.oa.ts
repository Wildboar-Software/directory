...
import { KEKDerivationAlgorithm, _decode_KEKDerivationAlgorithm, _encode_KEKDerivationAlgorithm } from "../OtherAttributes/KEKDerivationAlgorithm.ta";
export { KEKDerivationAlgorithm, _decode_KEKDerivationAlgorithm, _encode_KEKDerivationAlgorithm } from "../OtherAttributes/KEKDerivationAlgorithm.ta";
 ...
 */
export
const kEKDerivationAlg: ATTRIBUTE<KEKDerivationAlgorithm> = {
    class: "ATTRIBUTE",
    decoderFor: {
