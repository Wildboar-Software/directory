...
import { MultipleSignatures, _decode_MultipleSignatures, _encode_MultipleSignatures } from "../OtherImplicitlyTaggedTypes/MultipleSignatures.ta";
export { MultipleSignatures, _decode_MultipleSignatures, _encode_MultipleSignatures } from "../OtherImplicitlyTaggedTypes/MultipleSignatures.ta";
 ...
 */
export
const multipleSignatures: ATTRIBUTE<MultipleSignatures> = {
    class: "ATTRIBUTE",
    decoderFor: {
