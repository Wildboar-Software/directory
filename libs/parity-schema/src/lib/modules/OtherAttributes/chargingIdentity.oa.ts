...
import { IetfAttrSyntax, _decode_IetfAttrSyntax, _encode_IetfAttrSyntax } from "../OtherImplicitlyTaggedTypes/IetfAttrSyntax.ta";
export { IetfAttrSyntax, _decode_IetfAttrSyntax, _encode_IetfAttrSyntax } from "../OtherImplicitlyTaggedTypes/IetfAttrSyntax.ta";
 ...
 */
export
const chargingIdentity: ATTRIBUTE<IetfAttrSyntax> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([ 3 ], id_aca) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
