...
/* START_OF_SYMBOL_DEFINITION rfc822member */
/**
 * @summary rfc822member
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const rfc822member: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["rfc822member"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Group member specified as normal rf822 email address." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION rfc822member */
