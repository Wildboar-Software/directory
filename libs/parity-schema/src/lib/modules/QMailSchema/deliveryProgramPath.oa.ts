 ...
 */
export
const deliveryProgramPath: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Program to execute for all incoming mails." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
