...
import {
    caseExactIA5Match,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/caseExactIA5Match.oa";


/* START_OF_SYMBOL_DEFINITION mailMessageStore */
/**
 * @summary mailMessageStore
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const mailMessageStore: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mailMessageStore"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Path to the maildir/mbox on the mail system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([3,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailMessageStore */
