...
/* START_OF_SYMBOL_DEFINITION dnmember */
/**
 * @summary dnmember
 * @description
 * 
 ...
 */
export
const dnmember: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["dnmember"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Group member specified as distinguished name." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION dnmember */
