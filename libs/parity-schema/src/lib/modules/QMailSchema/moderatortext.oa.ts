...
/* START_OF_SYMBOL_DEFINITION moderatortext */
/**
 * @summary moderatortext
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const moderatortext: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["moderatortext"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Text that will be sent with request for moderation email." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION moderatortext */
