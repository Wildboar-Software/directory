 ...
 */
export
const filtermember: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Group member specified as ldap search filter." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([3,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
