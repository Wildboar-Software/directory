...
/* START_OF_SYMBOL_DEFINITION mailQuotaCount */
/**
 * @summary mailQuotaCount
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mailQuotaCount: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["mailQuotaCount"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of messages the user can have until further messages get bounced." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([16,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailQuotaCount */
