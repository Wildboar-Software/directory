...
/* START_OF_SYMBOL_DEFINITION mailReplyText */
/**
 * @summary mailReplyText
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mailReplyText: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mailReplyText"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A reply text for every incoming message" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([11,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailReplyText */
