 ...
 */
export
const senderconfirm: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Sender to Group has to answer confirmation email." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
