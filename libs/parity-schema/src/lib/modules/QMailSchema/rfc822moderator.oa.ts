...
/* START_OF_SYMBOL_DEFINITION rfc822moderator */
/**
 * @summary rfc822moderator
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const rfc822moderator: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["rfc822moderator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Group moderator specified as normal rfc822 email address." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION rfc822moderator */
