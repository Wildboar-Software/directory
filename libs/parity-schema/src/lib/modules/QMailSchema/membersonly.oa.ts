 ...
 */
export
const membersonly: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Sender to Group must be group member itself." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([5,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
