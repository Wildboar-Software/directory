...
/* START_OF_SYMBOL_DEFINITION qlaUidPrefix */
/**
 * @summary qlaUidPrefix
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qlaUidPrefix: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["qlaUidPrefix"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qlaUidPrefix" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([3,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qlaUidPrefix */
