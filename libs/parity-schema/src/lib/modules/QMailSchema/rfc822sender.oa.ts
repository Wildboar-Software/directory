...
/* START_OF_SYMBOL_DEFINITION rfc822sender */
/**
 * @summary rfc822sender
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const rfc822sender: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["rfc822sender"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Allowed sender specified as normal rf822 email address." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([11,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION rfc822sender */
