...
/* START_OF_SYMBOL_DEFINITION deliveryMode */
/**
 ...
 */
export
const deliveryMode: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["deliveryMode"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "multi field entries of: nolocal, noforward, noprogram, reply" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION deliveryMode */
