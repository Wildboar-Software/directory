...
/* START_OF_SYMBOL_DEFINITION mailHost */
/**
 * @summary mailHost
 * @description
 * 
 ...
 */
export
const mailHost: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mailHost"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "On which qmail server the messagestore of this user is located." /* OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailHost */
