 ...
 */
export
const dnmoderator: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Group moderator specified as Distinguished name." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([7,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
