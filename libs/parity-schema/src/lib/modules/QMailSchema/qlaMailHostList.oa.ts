...
/* START_OF_SYMBOL_DEFINITION qlaMailHostList */
/**
 * @summary qlaMailHostList
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qlaMailHostList: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["qlaMailHostList"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qlaMailHostList" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qlaMailHostList */
