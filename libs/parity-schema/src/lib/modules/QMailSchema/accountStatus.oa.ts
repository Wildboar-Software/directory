 ...
 */
export
const accountStatus: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "The status of a user account: active, noaccess, disabled, deleted" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([12,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
