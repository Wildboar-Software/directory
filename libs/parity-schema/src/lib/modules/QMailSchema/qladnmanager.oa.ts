...
/* START_OF_SYMBOL_DEFINITION qladnmanager */
/**
 * @summary qladnmanager
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qladnmanager: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["qladnmanager"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qladnmanager" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qladnmanager */
