...
/* START_OF_SYMBOL_DEFINITION mailQuotaSize */
/**
 * @summary mailQuotaSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mailQuotaSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["mailQuotaSize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The size of space the user can have until further messages get bounced." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([15,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailQuotaSize */
