...
/* START_OF_SYMBOL_DEFINITION qlaQmailUid */
/**
 * @summary qlaQmailUid
 * @description
 * 
 ...
 */
export
const qlaQmailUid: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["qlaQmailUid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qlaQmailUid" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qlaQmailUid */
