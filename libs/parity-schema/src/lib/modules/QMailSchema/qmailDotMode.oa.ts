...
/* START_OF_SYMBOL_DEFINITION qmailDotMode */
/**
 * @summary qmailDotMode
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qmailDotMode: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["qmailDotMode"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Interpretation of .qmail files: both, dotonly, ldaponly, ldapwithprog" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qmailDotMode */
