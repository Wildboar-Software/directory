...
/* START_OF_SYMBOL_DEFINITION mailSizeMax */
/**
 * @summary mailSizeMax
 * @description
 * 
 ...
 */
export
const mailSizeMax: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["mailSizeMax"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The maximum size of a single messages the user accepts." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([17,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailSizeMax */
