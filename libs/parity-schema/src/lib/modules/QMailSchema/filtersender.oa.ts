...
/* START_OF_SYMBOL_DEFINITION filtersender */
/**
 * @summary filtersender
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const filtersender: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["filtersender"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Allowed sender specified as ldap search filter." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([12,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION filtersender */
