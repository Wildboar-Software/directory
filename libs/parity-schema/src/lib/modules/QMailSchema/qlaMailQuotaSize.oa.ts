...
/* START_OF_SYMBOL_DEFINITION qlaMailQuotaSize */
/**
 * @summary qlaMailQuotaSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qlaMailQuotaSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["qlaMailQuotaSize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qlaMailQuotaSize" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([7,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qlaMailQuotaSize */
