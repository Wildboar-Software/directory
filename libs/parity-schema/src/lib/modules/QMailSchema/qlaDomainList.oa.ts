...
/* START_OF_SYMBOL_DEFINITION qlaDomainList */
/**
 * @summary qlaDomainList
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qlaDomainList: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["qlaDomainList"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qlaDomainList" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qlaDomainList */
