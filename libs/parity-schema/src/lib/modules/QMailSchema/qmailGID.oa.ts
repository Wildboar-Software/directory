...
/* START_OF_SYMBOL_DEFINITION qmailGID */
/**
 * @summary qmailGID
 * @description
 * 
 ...
 */
export
const qmailGID: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["qmailGID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "GID of the user on the mailsystem" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qmailGID */
