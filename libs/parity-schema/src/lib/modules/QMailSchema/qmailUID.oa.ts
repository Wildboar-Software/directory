...
/* START_OF_SYMBOL_DEFINITION qmailUID */
/**
 * @summary qmailUID
 * @description
 * 
 ...
 */
export
const qmailUID: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["qmailUID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UID of the user on the mailsystem" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qmailUID */
