...
export { id_at3 } from "../QMailSchema/id-at3.va";


/* START_OF_SYMBOL_DEFINITION qlaMailMStorePrefix */
/**
 * @summary qlaMailMStorePrefix
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const qlaMailMStorePrefix: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["qlaMailMStorePrefix"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "qlaMailMStorePrefix" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6,], id_at3) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION qlaMailMStorePrefix */
