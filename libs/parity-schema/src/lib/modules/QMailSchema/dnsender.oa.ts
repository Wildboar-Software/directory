 ...
 */
export
const dnsender: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Allowed sender specified as distinguished name." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10,], id_at2) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
