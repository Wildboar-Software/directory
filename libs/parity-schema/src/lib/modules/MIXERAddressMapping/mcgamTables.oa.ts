 ...
 */
export
const mcgamTables: ATTRIBUTE<DistinguishedName[]> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeSequenceOf<DistinguishedName>(() => _decode_DistinguishedName),
    },
    encoderFor: {
        "&Type": $._encodeSequenceOf<DistinguishedName>(() => _encode_DistinguishedName, $.BER),
    },
