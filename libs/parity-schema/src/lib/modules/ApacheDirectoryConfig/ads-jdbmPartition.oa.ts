 ...
 */
export
const ads_jdbmPartition: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ ads_partitionCacheSize, ads_jdbmPartitionOptimizerEnabled, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["ads-jdbmPartition"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A JDBM partition" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 151,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
