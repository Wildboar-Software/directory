 ...
 */
export
const ads_authenticator: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ ads_authenticatorId, ads_baseDn, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["ads-authenticator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A generic authenticator" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 901,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
