...
/* START_OF_SYMBOL_DEFINITION ads_journalFileName */
/**
 * @summary ads_journalFileName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_journalFileName: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-journalFileName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The journal file name." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 143,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_journalFileName */
