...
/* START_OF_SYMBOL_DEFINITION ads_replSearchSizeLimit */
/**
 * @summary ads_replSearchSizeLimit
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replSearchSizeLimit: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-replSearchSizeLimit"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "size limit imposed during replication refreshOnly phase" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 829,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replSearchSizeLimit */
