...
/* START_OF_SYMBOL_DEFINITION ads_authenticatorId */
/**
 * @summary ads_authenticatorId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_authenticatorId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-authenticatorId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Authenticator Id" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 930,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_authenticatorId */
