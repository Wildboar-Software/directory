...
/* START_OF_SYMBOL_DEFINITION ads_krbBodyChecksumVerified */
/**
 * @summary ads_krbBodyChecksumVerified
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbBodyChecksumVerified: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-krbBodyChecksumVerified"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Whether to verify the body checksum" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 412,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbBodyChecksumVerified */
