...
/* START_OF_SYMBOL_DEFINITION ads_delegateTls */
/**
 * @summary ads_delegateTls
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_delegateTls: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-delegateTls"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if the authenticator will use StartTLS" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 936,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_delegateTls */
