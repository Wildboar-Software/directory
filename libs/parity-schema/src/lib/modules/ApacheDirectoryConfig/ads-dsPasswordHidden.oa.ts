...
/* START_OF_SYMBOL_DEFINITION ads_dsPasswordHidden */
/**
 * @summary ads_dsPasswordHidden
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsPasswordHidden: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-dsPasswordHidden"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if the password is stored encrypted even for PLAIN authentication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 104,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsPasswordHidden */
