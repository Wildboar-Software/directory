 ...
 */
export const ads_dsPasswordHidden: ATTRIBUTE<BOOLEAN> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeBoolean,
    },
    ...
    '&ldapDesc':
        'Tells if the password is stored encrypted even for PLAIN authentication' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 104,
