...
/* START_OF_SYMBOL_DEFINITION ads_dsSyncPeriodMillis */
/**
 * @summary ads_dsSyncPeriodMillis
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsSyncPeriodMillis: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-dsSyncPeriodMillis"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Define the duration between two flushes on disk" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 111,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsSyncPeriodMillis */
