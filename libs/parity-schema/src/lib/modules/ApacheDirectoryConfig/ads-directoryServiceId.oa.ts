...
/* START_OF_SYMBOL_DEFINITION ads_directoryServiceId */
/**
 * @summary ads_directoryServiceId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_directoryServiceId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-directoryServiceId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The DirectoryService ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 100,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_directoryServiceId */
