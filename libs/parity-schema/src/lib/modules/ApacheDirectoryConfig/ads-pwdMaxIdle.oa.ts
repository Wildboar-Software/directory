...
/* START_OF_SYMBOL_DEFINITION ads_pwdMaxIdle */
/**
 * @summary ads_pwdMaxIdle
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_pwdMaxIdle: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-pwdMaxIdle"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 919,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_pwdMaxIdle */
