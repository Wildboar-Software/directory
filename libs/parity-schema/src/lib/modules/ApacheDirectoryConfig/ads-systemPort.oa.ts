...
/* START_OF_SYMBOL_DEFINITION ads_systemPort */
/**
 * @summary ads_systemPort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_systemPort: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-systemPort"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Port number on system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 812,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_systemPort */
