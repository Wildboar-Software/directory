...
/* START_OF_SYMBOL_DEFINITION ads_interceptorOrder */
/**
 * @summary ads_interceptorOrder
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_interceptorOrder: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-interceptorOrder"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Interceptor order number" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 131,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_interceptorOrder */
