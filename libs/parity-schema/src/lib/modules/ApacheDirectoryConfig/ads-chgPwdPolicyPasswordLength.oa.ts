...
/* START_OF_SYMBOL_DEFINITION ads_chgPwdPolicyPasswordLength */
/**
 * @summary ads_chgPwdPolicyPasswordLength
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_chgPwdPolicyPasswordLength: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-chgPwdPolicyPasswordLength"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The policy minimum password length" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 801,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_chgPwdPolicyPasswordLength */
