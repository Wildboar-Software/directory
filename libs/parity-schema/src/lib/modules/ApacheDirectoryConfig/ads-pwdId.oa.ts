...
/* START_OF_SYMBOL_DEFINITION ads_pwdId */
/**
 * @summary ads_pwdId
 * @description
 * 
 ...
 */
export
const ads_pwdId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-pwdId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "an ID used to identify the passwordPolicy configuration" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 921,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_pwdId */
