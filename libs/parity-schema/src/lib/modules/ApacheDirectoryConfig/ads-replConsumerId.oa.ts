...
/* START_OF_SYMBOL_DEFINITION ads_replConsumerId */
/**
 * @summary ads_replConsumerId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replConsumerId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-replConsumerId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The replication consumer ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 837,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replConsumerId */
