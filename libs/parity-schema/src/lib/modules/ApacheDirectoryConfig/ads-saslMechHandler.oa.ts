 ...
 */
export
const ads_saslMechHandler: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ ads_saslMechName, ads_saslMechClassName, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 801,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
