...
/* START_OF_SYMBOL_DEFINITION ads_changeLogId */
/**
 * @summary ads_changeLogId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_changeLogId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-changeLogId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The ChangeLog identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 120,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_changeLogId */
