...
/* START_OF_SYMBOL_DEFINITION ads_delegateTlsTrustManager */
/**
 * @summary ads_delegateTlsTrustManager
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_delegateTlsTrustManager: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-delegateTlsTrustManager"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "FQCN of the TrustManager to use to validate the startTls communication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 938,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_delegateTlsTrustManager */
