...
/* START_OF_SYMBOL_DEFINITION ads_extendedOpId */
/**
 * @summary ads_extendedOpId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_extendedOpId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-extendedOpId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "an ID used for ExtendeOpertion names" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 253,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_extendedOpId */
