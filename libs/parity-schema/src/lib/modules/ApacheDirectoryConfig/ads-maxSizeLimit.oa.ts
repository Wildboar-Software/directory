...
/* START_OF_SYMBOL_DEFINITION ads_maxSizeLimit */
/**
 * @summary ads_maxSizeLimit
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_maxSizeLimit: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-maxSizeLimit"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The maximum number of entries to return" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 302,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_maxSizeLimit */
