...
/* START_OF_SYMBOL_DEFINITION ads_httpConfFile */
/**
 * @summary ads_httpConfFile
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_httpConfFile: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-httpConfFile"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Jetty web server config file path" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 816,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_httpConfFile */
