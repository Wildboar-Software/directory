...
/* START_OF_SYMBOL_DEFINITION ads_pwdValidator */
/**
 * @summary ads_pwdValidator
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_pwdValidator: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-pwdValidator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "FQCN of password validator" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 925,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_pwdValidator */
