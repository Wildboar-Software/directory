...
/* START_OF_SYMBOL_DEFINITION ads_saslMechClassName */
/**
 * @summary ads_saslMechClassName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_saslMechClassName: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-saslMechClassName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fully qualified class name of SASL mechanism implementation" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 810,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_saslMechClassName */
