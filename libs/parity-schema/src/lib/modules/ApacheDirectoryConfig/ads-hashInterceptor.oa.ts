 ...
 */
export
const ads_hashInterceptor: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ ads_hashAlgorithm, ads_hashAttribute, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["ads-hashInterceptor"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The HashInterceptor ObjectClass" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 132,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
