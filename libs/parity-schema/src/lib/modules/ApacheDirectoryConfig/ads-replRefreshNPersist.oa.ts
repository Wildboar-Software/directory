...
/* START_OF_SYMBOL_DEFINITION ads_replRefreshNPersist */
/**
 * @summary ads_replRefreshNPersist
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replRefreshNPersist: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-replRefreshNPersist"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "flag indicating refreshAndPersist mode of replication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 822,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replRefreshNPersist */
