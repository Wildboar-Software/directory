 ...
 */
export
const ads_directoryService: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ ads_directoryServiceId, ads_dsReplicaId, ads_dsAccessControlEnabled, ads_dsAllowAnonymousAccess, ads_dsDenormalizeOpAttrsEnabled, ads_dsPasswordHidden, ads_dsSyncPeriodMillis, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 100,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
