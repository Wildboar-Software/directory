 ...
 */
export const ads_krbPaEncTimestampRequired: ATTRIBUTE<BOOLEAN> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeBoolean,
    },
    ...
    '&ldapDesc':
        'Whether pre-authentication by encrypted timestamp is required' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 404,
