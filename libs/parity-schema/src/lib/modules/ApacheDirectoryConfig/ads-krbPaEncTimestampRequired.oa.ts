...
/* START_OF_SYMBOL_DEFINITION ads_krbPaEncTimestampRequired */
/**
 * @summary ads_krbPaEncTimestampRequired
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbPaEncTimestampRequired: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-krbPaEncTimestampRequired"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Whether pre-authentication by encrypted timestamp is required" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 404,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbPaEncTimestampRequired */
