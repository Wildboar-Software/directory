...
/* START_OF_SYMBOL_DEFINITION ads_replSearchTimeOut */
/**
 * @summary ads_replSearchTimeOut
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replSearchTimeOut: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-replSearchTimeOut"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "search timeout imposed during replication refreshOnly phase" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 830,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replSearchTimeOut */
