...
/* START_OF_SYMBOL_DEFINITION ads_replConsumerImpl */
/**
 * @summary ads_replConsumerImpl
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replConsumerImpl: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-replConsumerImpl"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The FQCN of the replication consumer/client handler" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 310,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replConsumerImpl */
