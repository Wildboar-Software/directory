...
const ads_index: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ ads_indexAttributeId, ads_indexHasReverse, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["ads-index"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A generic indexed attribute" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 160,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
