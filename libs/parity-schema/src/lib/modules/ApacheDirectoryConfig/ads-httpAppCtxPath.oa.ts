...
/* START_OF_SYMBOL_DEFINITION ads_httpAppCtxPath */
/**
 * @summary ads_httpAppCtxPath
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_httpAppCtxPath: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-httpAppCtxPath"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A web app context path" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 814,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_httpAppCtxPath */
