...
/* START_OF_SYMBOL_DEFINITION ads_replStrictCertValidation */
/**
 * @summary ads_replStrictCertValidation
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replStrictCertValidation: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-replStrictCertValidation"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "flag to indicate strict certificate validation" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 834,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replStrictCertValidation */
