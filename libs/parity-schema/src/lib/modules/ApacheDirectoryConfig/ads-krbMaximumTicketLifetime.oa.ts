...
/* START_OF_SYMBOL_DEFINITION ads_krbMaximumTicketLifetime */
/**
 * @summary ads_krbMaximumTicketLifetime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbMaximumTicketLifetime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-krbMaximumTicketLifetime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The maximum ticket lifetime" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 410,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbMaximumTicketLifetime */
