...
/* START_OF_SYMBOL_DEFINITION ads_indexNumDupLimit */
/**
 * @summary ads_indexNumDupLimit
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_indexNumDupLimit: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-indexNumDupLimit"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of duplicated element we allow before switching to a secondary tree" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 163,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_indexNumDupLimit */
