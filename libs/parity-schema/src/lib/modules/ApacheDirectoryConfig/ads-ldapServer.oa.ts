 ...
 */
export
const ads_ldapServer: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ ads_confidentialityRequired, ads_maxSizeLimit, ads_maxTimeLimit, ads_maxPDUSize, ads_saslHost, ads_saslPrincipal, ads_saslRealms, ads_replEnabled, ads_replPingerSleep, ] /* OBJECT_FIELD_SETTING */,
    "&OptionalAttributes": [ ads_keystoreFile, ads_certificatePassword, ads_replReqHandler, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["ads-ldapServer"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The LdapServer ObjectClass" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 300,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
