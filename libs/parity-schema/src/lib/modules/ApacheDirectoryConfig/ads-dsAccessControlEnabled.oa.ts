...
/* START_OF_SYMBOL_DEFINITION ads_dsAccessControlEnabled */
/**
 * @summary ads_dsAccessControlEnabled
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsAccessControlEnabled: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-dsAccessControlEnabled"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if access control is activated or not" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 101,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsAccessControlEnabled */
