...
/* START_OF_SYMBOL_DEFINITION ads_replSearchFilter */
/**
 * @summary ads_replSearchFilter
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replSearchFilter: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-replSearchFilter"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Search filter used in replication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 817,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replSearchFilter */
