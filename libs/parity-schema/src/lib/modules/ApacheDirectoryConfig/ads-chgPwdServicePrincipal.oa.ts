...
/* START_OF_SYMBOL_DEFINITION ads_chgPwdServicePrincipal */
/**
 * @summary ads_chgPwdServicePrincipal
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_chgPwdServicePrincipal: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-chgPwdServicePrincipal"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Change Password service principal" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 803,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_chgPwdServicePrincipal */
