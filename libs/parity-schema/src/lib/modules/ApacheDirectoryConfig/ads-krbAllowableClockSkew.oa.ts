...
/* START_OF_SYMBOL_DEFINITION ads_krbAllowableClockSkew */
/**
 * @summary ads_krbAllowableClockSkew
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbAllowableClockSkew: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-krbAllowableClockSkew"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The allowable clock skew" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 400,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbAllowableClockSkew */
