...
/* START_OF_SYMBOL_DEFINITION ads_dsTestEntries */
/**
 * @summary ads_dsTestEntries
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsTestEntries: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-dsTestEntries"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The set of entries to inject at startup (may be obsolete)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 113,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsTestEntries */
