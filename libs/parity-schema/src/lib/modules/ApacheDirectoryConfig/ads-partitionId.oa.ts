...
/* START_OF_SYMBOL_DEFINITION ads_partitionId */
/**
 * @summary ads_partitionId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_partitionId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-partitionId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Partition identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 150,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_partitionId */
