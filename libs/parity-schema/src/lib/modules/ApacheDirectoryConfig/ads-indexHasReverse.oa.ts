...
/* START_OF_SYMBOL_DEFINITION ads_indexHasReverse */
/**
 * @summary ads_indexHasReverse
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_indexHasReverse: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-indexHasReverse"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A flag telling if the index has a reverse table" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 165,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_indexHasReverse */
