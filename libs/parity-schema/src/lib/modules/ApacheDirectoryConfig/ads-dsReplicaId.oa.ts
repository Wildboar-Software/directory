...
/* START_OF_SYMBOL_DEFINITION ads_dsReplicaId */
/**
 * @summary ads_dsReplicaId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsReplicaId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-dsReplicaId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The server identifier, used for replication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 112,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsReplicaId */
