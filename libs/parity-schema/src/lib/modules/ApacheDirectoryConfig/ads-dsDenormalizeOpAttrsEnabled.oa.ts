...
/* START_OF_SYMBOL_DEFINITION ads_dsDenormalizeOpAttrsEnabled */
/**
 * @summary ads_dsDenormalizeOpAttrsEnabled
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsDenormalizeOpAttrsEnabled: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-dsDenormalizeOpAttrsEnabled"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if the operational attributes are denormalized or not" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 103,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsDenormalizeOpAttrsEnabled */
