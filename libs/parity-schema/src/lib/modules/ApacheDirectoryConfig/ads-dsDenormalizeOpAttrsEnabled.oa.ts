 ...
 */
export const ads_dsDenormalizeOpAttrsEnabled: ATTRIBUTE<BOOLEAN> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeBoolean,
    },
    ...
    '&ldapDesc':
        'Tells if the operational attributes are denormalized or not' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 103,
