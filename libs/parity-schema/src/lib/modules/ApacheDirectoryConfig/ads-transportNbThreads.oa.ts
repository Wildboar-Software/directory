...
/* START_OF_SYMBOL_DEFINITION ads_transportNbThreads */
/**
 * @summary ads_transportNbThreads
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_transportNbThreads: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-transportNbThreads"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of threads to use for the Acceptor" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 64,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_transportNbThreads */
