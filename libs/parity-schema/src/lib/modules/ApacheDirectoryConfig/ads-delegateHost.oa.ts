...
/* START_OF_SYMBOL_DEFINITION ads_delegateHost */
/**
 * @summary ads_delegateHost
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_delegateHost: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-delegateHost"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "an external host handling delegate authentication" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 931,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_delegateHost */
