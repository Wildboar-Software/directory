...
/* START_OF_SYMBOL_DEFINITION ads_chgPwdPolicyCategoryCount */
/**
 * @summary ads_chgPwdPolicyCategoryCount
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_chgPwdPolicyCategoryCount: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-chgPwdPolicyCategoryCount"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The policy category count" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 800,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_chgPwdPolicyCategoryCount */
