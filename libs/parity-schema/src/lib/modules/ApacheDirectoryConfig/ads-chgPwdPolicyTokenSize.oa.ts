...
/* START_OF_SYMBOL_DEFINITION ads_chgPwdPolicyTokenSize */
/**
 * @summary ads_chgPwdPolicyTokenSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_chgPwdPolicyTokenSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-chgPwdPolicyTokenSize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The policy token size" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 802,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_chgPwdPolicyTokenSize */
