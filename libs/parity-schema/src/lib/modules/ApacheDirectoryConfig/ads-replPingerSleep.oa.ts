...
/* START_OF_SYMBOL_DEFINITION ads_replPingerSleep */
/**
 * @summary ads_replPingerSleep
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replPingerSleep: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-replPingerSleep"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "the time interval(in seconds) between subsequent pings to each re" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 923,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replPingerSleep */
