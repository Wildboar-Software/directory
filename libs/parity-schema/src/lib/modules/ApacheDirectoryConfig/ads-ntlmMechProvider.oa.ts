...
/* START_OF_SYMBOL_DEFINITION ads_ntlmMechProvider */
/**
 * @summary ads_ntlmMechProvider
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_ntlmMechProvider: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-ntlmMechProvider"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fully qualified class name of SASL NTLM provider" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 809,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_ntlmMechProvider */
