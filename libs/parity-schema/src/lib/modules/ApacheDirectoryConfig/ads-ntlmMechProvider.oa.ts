 ...
 */
export const ads_ntlmMechProvider: ATTRIBUTE<PrintableString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'Fully qualified class name of SASL NTLM provider' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 809,
