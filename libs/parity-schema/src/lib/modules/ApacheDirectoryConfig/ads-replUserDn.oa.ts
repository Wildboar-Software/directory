...
/* START_OF_SYMBOL_DEFINITION ads_replUserDn */
/**
 * @summary ads_replUserDn
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replUserDn: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-replUserDn"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "user DN used for authenticating with replication provider" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 825,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replUserDn */
