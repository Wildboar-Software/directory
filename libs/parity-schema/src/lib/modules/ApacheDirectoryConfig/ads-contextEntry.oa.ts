...
/* START_OF_SYMBOL_DEFINITION ads_contextEntry */
/**
 * @summary ads_contextEntry
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_contextEntry: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-contextEntry"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Partition context entry" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 154,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_contextEntry */
