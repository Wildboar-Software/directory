...
/* START_OF_SYMBOL_DEFINITION ads_indexFileName */
/**
 * @summary ads_indexFileName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_indexFileName: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-indexFileName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The index file name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 161,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_indexFileName */
