...
/* START_OF_SYMBOL_DEFINITION ads_replUseTls */
/**
 * @summary ads_replUseTls
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replUseTls: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-replUseTls"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "flag to indicate the use of TLS" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 833,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replUseTls */
