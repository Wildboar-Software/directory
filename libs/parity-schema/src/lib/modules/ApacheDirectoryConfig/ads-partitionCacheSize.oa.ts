...
/* START_OF_SYMBOL_DEFINITION ads_partitionCacheSize */
/**
 * @summary ads_partitionCacheSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_partitionCacheSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-partitionCacheSize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of entries in the cache for this partition" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 153,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_partitionCacheSize */
