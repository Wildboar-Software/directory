...
/* START_OF_SYMBOL_DEFINITION ads_krbForwardableAllowed */
/**
 * @summary ads_krbForwardableAllowed
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbForwardableAllowed: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-krbForwardableAllowed"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Whether forwardable addresses are allowed" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 403,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbForwardableAllowed */
