...
/* START_OF_SYMBOL_DEFINITION ads_delegateSsl */
/**
 * @summary ads_delegateSsl
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_delegateSsl: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-delegateSsl"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if the delegatedAuthenticator uses SSL" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 933,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_delegateSsl */
