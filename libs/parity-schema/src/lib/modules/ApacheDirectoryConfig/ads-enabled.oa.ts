...
/* START_OF_SYMBOL_DEFINITION ads_enabled */
/**
 * @summary ads_enabled
 * @description
 * 
 ...
 */
export
const ads_enabled: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-enabled"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "specifies whether a config element is enabled or not, default is true" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 805,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_enabled */
