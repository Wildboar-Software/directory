...
/* START_OF_SYMBOL_DEFINITION ads_krbPostdatedAllowed */
/**
 * @summary ads_krbPostdatedAllowed
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbPostdatedAllowed: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-krbPostdatedAllowed"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Whether postdated tickets are allowed" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 405,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbPostdatedAllowed */
