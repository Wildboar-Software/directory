...
/* START_OF_SYMBOL_DEFINITION ads_replLogMaxIdle */
/**
 * @summary ads_replLogMaxIdle
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replLogMaxIdle: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-replLogMaxIdle"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "the duration(in seconds) of consumer inactivity after which the a" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 920,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replLogMaxIdle */
