...
/* START_OF_SYMBOL_DEFINITION ads_partitionSyncOnWrite */
/**
 * @summary ads_partitionSyncOnWrite
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_partitionSyncOnWrite: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-partitionSyncOnWrite"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "directs a partition to synchronize the underlying storage upon a write operation" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 806,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_partitionSyncOnWrite */
