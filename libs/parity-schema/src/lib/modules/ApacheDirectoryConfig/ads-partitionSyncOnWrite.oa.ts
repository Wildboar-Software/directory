 ...
 */
export const ads_partitionSyncOnWrite: ATTRIBUTE<BOOLEAN> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeBoolean,
    },
    ...
    '&ldapDesc':
        'directs a partition to synchronize the underlying storage upon a write operation' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID([
        1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 806,
