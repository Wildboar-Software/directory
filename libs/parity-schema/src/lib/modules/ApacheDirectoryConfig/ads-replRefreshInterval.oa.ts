...
/* START_OF_SYMBOL_DEFINITION ads_replRefreshInterval */
/**
 * @summary ads_replRefreshInterval
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replRefreshInterval: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-replRefreshInterval"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "time interval between two refreshOnly sessions" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 827,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replRefreshInterval */
