...
/* START_OF_SYMBOL_DEFINITION ads_baseDn */
/**
 * @summary ads_baseDn
 * @description
 * 
 ...
 */
export
const ads_baseDn: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-baseDn"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The base DN from which the authenticator is valid" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 935,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_baseDn */
