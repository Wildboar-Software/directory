 ...
 */
export
const ads_extendedOpHandler: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ ads_extendedOpHandlerClass, ads_extendedOpId, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["ads-extendedOpHandler"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Extended operation handler" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 3, 802,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
