...
/* START_OF_SYMBOL_DEFINITION ads_journalId */
/**
 * @summary ads_journalId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_journalId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-journalId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Journal ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 144,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_journalId */
