...
/* START_OF_SYMBOL_DEFINITION ads_interceptorClassName */
/**
 * @summary ads_interceptorClassName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_interceptorClassName: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-interceptorClassName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fully qualified class name of the interceptor" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 804,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_interceptorClassName */
