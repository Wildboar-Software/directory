...
/* START_OF_SYMBOL_DEFINITION ads_maxPDUSize */
/**
 * @summary ads_maxPDUSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_maxPDUSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-maxPDUSize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Gives the maximum size of a PDU" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 110,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_maxPDUSize */
