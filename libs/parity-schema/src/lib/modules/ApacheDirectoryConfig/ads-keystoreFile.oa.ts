...
/* START_OF_SYMBOL_DEFINITION ads_keystoreFile */
/**
 * @summary ads_keystoreFile
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_keystoreFile: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-keystoreFile"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The keystore file to use to store certificates" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 308,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_keystoreFile */
