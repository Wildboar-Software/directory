...
/* START_OF_SYMBOL_DEFINITION ads_Id */
/**
 * @summary ads_Id
 * @description
 * 
 ...
 */
export
const ads_Id: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-Id"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "a generic ID which can be used in any configuration entry DN" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 252,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_Id */
