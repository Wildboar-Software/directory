...
/* START_OF_SYMBOL_DEFINITION ads_extendedOpHandlerClass */
/**
 * @summary ads_extendedOpHandlerClass
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_extendedOpHandlerClass: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-extendedOpHandlerClass"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Fully qualified class name of the extended operation handler" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 811,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_extendedOpHandlerClass */
