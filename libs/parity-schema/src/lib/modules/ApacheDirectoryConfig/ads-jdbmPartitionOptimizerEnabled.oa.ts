...
/* START_OF_SYMBOL_DEFINITION ads_jdbmPartitionOptimizerEnabled */
/**
 * @summary ads_jdbmPartitionOptimizerEnabled
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_jdbmPartitionOptimizerEnabled: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-jdbmPartitionOptimizerEnabled"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Enables JDBM partition optimizer" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 807,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_jdbmPartitionOptimizerEnabled */
