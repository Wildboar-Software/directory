...
/* START_OF_SYMBOL_DEFINITION ads_replLogPurgeThresholdCount */
/**
 * @summary ads_replLogPurgeThresholdCount
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_replLogPurgeThresholdCount: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-replLogPurgeThresholdCount"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "the minimum number of entries to be present for beginning purging" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 922,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_replLogPurgeThresholdCount */
