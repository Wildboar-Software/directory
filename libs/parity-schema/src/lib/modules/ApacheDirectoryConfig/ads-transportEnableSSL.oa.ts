...
/* START_OF_SYMBOL_DEFINITION ads_transportEnableSSL */
/**
 * @summary ads_transportEnableSSL
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_transportEnableSSL: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-transportEnableSSL"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if this transport support SSL." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 63,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_transportEnableSSL */
