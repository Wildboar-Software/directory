...
/* START_OF_SYMBOL_DEFINITION ads_pwdMaxFailure */
/**
 * @summary ads_pwdMaxFailure
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_pwdMaxFailure: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-pwdMaxFailure"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 912,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_pwdMaxFailure */
