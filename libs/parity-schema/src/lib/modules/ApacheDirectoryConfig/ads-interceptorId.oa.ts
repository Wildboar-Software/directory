...
/* START_OF_SYMBOL_DEFINITION ads_interceptorId */
/**
 * @summary ads_interceptorId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_interceptorId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-interceptorId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The Interceptor identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 130,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_interceptorId */
