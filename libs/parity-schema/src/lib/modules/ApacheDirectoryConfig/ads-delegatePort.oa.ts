...
/* START_OF_SYMBOL_DEFINITION ads_delegatePort */
/**
 * @summary ads_delegatePort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_delegatePort: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-delegatePort"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Port number on system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 932,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_delegatePort */
