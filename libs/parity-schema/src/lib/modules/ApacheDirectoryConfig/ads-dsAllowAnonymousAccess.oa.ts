...
/**
 * @summary ads_dsAllowAnonymousAccess
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_dsAllowAnonymousAccess: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Tells if anonymous access are allowed or not" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 102,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_dsAllowAnonymousAccess */
