...
/* START_OF_SYMBOL_DEFINITION ads_transportBacklog */
/**
 * @summary ads_transportBacklog
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_transportBacklog: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-transportBacklog"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of messages waiting to be processed." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 62,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_transportBacklog */
