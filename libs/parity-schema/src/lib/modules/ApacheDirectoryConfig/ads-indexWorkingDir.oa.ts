...
/* START_OF_SYMBOL_DEFINITION ads_indexWorkingDir */
/**
 * @summary ads_indexWorkingDir
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_indexWorkingDir: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-indexWorkingDir"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The place on disk where the index file is stored" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 162,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_indexWorkingDir */
