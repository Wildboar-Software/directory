...
/* START_OF_SYMBOL_DEFINITION ads_serverId */
/**
 * @summary ads_serverId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_serverId: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-serverId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The server ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 250,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_serverId */
