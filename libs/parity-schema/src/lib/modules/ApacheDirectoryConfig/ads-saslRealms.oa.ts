...
/* START_OF_SYMBOL_DEFINITION ads_saslRealms */
/**
 * @summary ads_saslRealms
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_saslRealms: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-saslRealms"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The realms serviced by this SASL host" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 306,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_saslRealms */
