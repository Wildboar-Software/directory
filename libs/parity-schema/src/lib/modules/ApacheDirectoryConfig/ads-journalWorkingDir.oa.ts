...
/* START_OF_SYMBOL_DEFINITION ads_journalWorkingDir */
/**
 * @summary ads_journalWorkingDir
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_journalWorkingDir: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-journalWorkingDir"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The place on disk where the journal is stored." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 142,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_journalWorkingDir */
