...
/* START_OF_SYMBOL_DEFINITION ads_krbPrimaryRealm */
/**
 * @summary ads_krbPrimaryRealm
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbPrimaryRealm: ATTRIBUTE<PrintableString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ads-krbPrimaryRealm"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The primary realm" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 411,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbPrimaryRealm */
