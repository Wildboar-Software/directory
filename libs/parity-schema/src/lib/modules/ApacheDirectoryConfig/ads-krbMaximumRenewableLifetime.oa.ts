...
/* START_OF_SYMBOL_DEFINITION ads_krbMaximumRenewableLifetime */
/**
 * @summary ads_krbMaximumRenewableLifetime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_krbMaximumRenewableLifetime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-krbMaximumRenewableLifetime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The maximum renewable lifetime" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 409,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_krbMaximumRenewableLifetime */
