...
/* START_OF_SYMBOL_DEFINITION ads_needClientAuth */
/**
 * @summary ads_needClientAuth
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_needClientAuth: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ads-needClientAuth"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells if the client auth is needed" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 65,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_needClientAuth */
