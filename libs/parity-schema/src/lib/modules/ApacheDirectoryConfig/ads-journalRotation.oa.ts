...
/* START_OF_SYMBOL_DEFINITION ads_journalRotation */
/**
 * @summary ads_journalRotation
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_journalRotation: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-journalRotation"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The size before a journal rotation occurs." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 141,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_journalRotation */
