...
/* START_OF_SYMBOL_DEFINITION ads_indexCacheSize */
/**
 * @summary ads_indexCacheSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ads_indexCacheSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ads-indexCacheSize"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The number of key we store in the cache for this index" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 18060, 0, 4, 1, 2, 164,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ads_indexCacheSize */
