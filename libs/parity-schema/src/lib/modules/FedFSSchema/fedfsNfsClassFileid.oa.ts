...
/* START_OF_SYMBOL_DEFINITION fedfsNfsClassFileid */
/**
 * @summary fedfsNfsClassFileid
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsClassFileid: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsClassFileid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The fileid class of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 110,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsClassFileid */
