 ...
 */
export
const fedfsNfsGenFlagWritable: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Indicates if the file system is writable" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 104,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
