 ...
 */
export
const fedfsNfsWriteOrder: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapDesc": "The write order of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 117,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
