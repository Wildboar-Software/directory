...
/* START_OF_SYMBOL_DEFINITION fedfsNfsClassReaddir */
/**
 * @summary fedfsNfsClassReaddir
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsClassReaddir: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsClassReaddir"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The readdir class of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 113,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsClassReaddir */
