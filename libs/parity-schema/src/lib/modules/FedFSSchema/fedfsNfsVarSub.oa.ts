...
/* START_OF_SYMBOL_DEFINITION fedfsNfsVarSub */
/**
 * @summary fedfsNfsVarSub
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsVarSub: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["fedfsNfsVarSub"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Indicates if variable substitution is present" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 118,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsVarSub */
