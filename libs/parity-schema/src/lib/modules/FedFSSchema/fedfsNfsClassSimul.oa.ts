...
/* START_OF_SYMBOL_DEFINITION fedfsNfsClassSimul */
/**
 * @summary fedfsNfsClassSimul
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsClassSimul: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsClassSimul"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The simultaneous-use class of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 108,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsClassSimul */
