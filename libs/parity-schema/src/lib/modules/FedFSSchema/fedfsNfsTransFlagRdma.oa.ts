 ...
 */
export
const fedfsNfsTransFlagRdma: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Indicates if the transport supports RDMA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 107,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
