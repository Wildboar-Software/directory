...
const fedfsFsn: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ fedfsFsnUuid, fedfsFsnTTL, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([1, 1002,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
