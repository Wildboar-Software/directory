...
/* START_OF_SYMBOL_DEFINITION fedfsNfsClassChange */
/**
 * @summary fedfsNfsClassChange
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsClassChange: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsClassChange"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The change class of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 112,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsClassChange */
