 ...
 */
export
const fedfsNfsGenFlagGoing: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Indicates if the file system is going" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 105,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
