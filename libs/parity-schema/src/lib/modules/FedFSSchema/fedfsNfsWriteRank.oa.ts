...
/* START_OF_SYMBOL_DEFINITION fedfsNfsWriteRank */
/**
 * @summary fedfsNfsWriteRank
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsWriteRank: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsWriteRank"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The write rank of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 116,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsWriteRank */
