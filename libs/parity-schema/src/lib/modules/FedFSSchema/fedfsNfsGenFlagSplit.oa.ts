 ...
 */
export
const fedfsNfsGenFlagSplit: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Indicates if there are multiple file systems" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 106,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
