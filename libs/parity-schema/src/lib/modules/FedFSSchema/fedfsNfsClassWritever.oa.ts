...
/* START_OF_SYMBOL_DEFINITION fedfsNfsClassWritever */
/**
 * @summary fedfsNfsClassWritever
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsClassWritever: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsClassWritever"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The write-verifier class of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 111,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsClassWritever */
