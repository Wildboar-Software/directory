...
/* START_OF_SYMBOL_DEFINITION fedfsNfsClassHandle */
/**
 * @summary fedfsNfsClassHandle
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsClassHandle: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsClassHandle"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The handle class of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 109,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsClassHandle */
