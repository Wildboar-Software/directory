...
/* START_OF_SYMBOL_DEFINITION fedfsFsnTTL */
/**
 * @summary fedfsFsnTTL
 * @description
 * 
 ...
 */
export
const fedfsFsnTTL: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsFsnTTL"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Time to live of an FSN tree" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 11,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsFsnTTL */
