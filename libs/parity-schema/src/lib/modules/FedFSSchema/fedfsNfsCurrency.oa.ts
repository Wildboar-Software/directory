...
/* START_OF_SYMBOL_DEFINITION fedfsNfsCurrency */
/**
 * @summary fedfsNfsCurrency
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsCurrency: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsCurrency"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "up-to-date measure of the data" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 103,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsCurrency */
