...
/* START_OF_SYMBOL_DEFINITION fedfsNfsReadRank */
/**
 * @summary fedfsNfsReadRank
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const fedfsNfsReadRank: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["fedfsNfsReadRank"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The read rank of the file system" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 114,], daniel_ellard) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION fedfsNfsReadRank */
