...
/* START_OF_SYMBOL_DEFINITION id_contract_scf_scf */
/**
 * @summary id_contract_scf_scf
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_contract_scf_scf: OBJECT_IDENTIFIER = _OID.fromParts(
    [/* scf-scf */ 18],
    id_contract
);
/* END_OF_SYMBOL_DEFINITION id_contract_scf_scf */
