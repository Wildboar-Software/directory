...
/* START_OF_SYMBOL_DEFINITION scf_srf_datatypes */
/**
 * @summary scf_srf_datatypes
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const scf_srf_datatypes: OBJECT_IDENTIFIER = new _OID([
    /* in-cs3-scf-srf-datatypes */ 10,
    /* version1 */ 0,
], modules);
/* END_OF_SYMBOL_DEFINITION scf_srf_datatypes */
