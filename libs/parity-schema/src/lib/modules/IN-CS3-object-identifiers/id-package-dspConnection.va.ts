...
/* START_OF_SYMBOL_DEFINITION id_package_dspConnection */
/**
 ...
 */
export
const id_package_dspConnection: OBJECT_IDENTIFIER = new _OID([
    /* dspConnection */ 47,
], id_package);
/* END_OF_SYMBOL_DEFINITION id_package_dspConnection */
