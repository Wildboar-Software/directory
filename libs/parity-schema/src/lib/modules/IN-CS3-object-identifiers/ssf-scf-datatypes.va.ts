...
/* START_OF_SYMBOL_DEFINITION ssf_scf_datatypes */
/**
 * @summary ssf_scf_datatypes
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ssf_scf_datatypes: OBJECT_IDENTIFIER = new _OID([
    /* in-cs3-ssf-scf-datatypes */ 6,
    /* version1 */ 0,
], modules);
/* END_OF_SYMBOL_DEFINITION ssf_scf_datatypes */
