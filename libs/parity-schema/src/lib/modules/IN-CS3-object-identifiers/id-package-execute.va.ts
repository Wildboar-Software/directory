...
/* START_OF_SYMBOL_DEFINITION id_package_execute */
/**
 * @summary id_package_execute
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_package_execute: OBJECT_IDENTIFIER = _OID.fromParts(
    [/* execute */ 4],
    id_package
);
/* END_OF_SYMBOL_DEFINITION id_package_execute */
