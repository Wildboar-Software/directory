...
import {
    ...
    _decode_ESSCertIDv2,
    _encode_ESSCertIDv2,
} from '../OtherImplicitlyTaggedTypes/ESSCertIDv2.ta';
import {
    SignAttrsHash,
    _decode_SignAttrsHash,
    _encode_SignAttrsHash,
} from '../OtherImplicitlyTaggedTypes/SignAttrsHash.ta';
export {
    ESSCertIDv2,
    _decode_ESSCertIDv2,
    _encode_ESSCertIDv2,
 ...
 * @class
 */
export class MultipleSignatures {
    constructor(
        /**
         * @summary `bodyHashAlg`.
         * @public
    ...
    public static _from_object(_o: {
        [_K in keyof MultipleSignatures]: MultipleSignatures[_K];
    }): MultipleSignatures {
        return new MultipleSignatures(
            _o.bodyHashAlg,
            _o.signAlg,
            _o.signAttrsHash,
            _o.cert,
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_MultipleSignatures: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'bodyHashAlg',
            false,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_MultipleSignatures: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_MultipleSignatures: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_MultipleSignatures: $.ASN1Decoder<MultipleSignatures> | null =
    null;
 ...
 */
export function _decode_MultipleSignatures(el: _Element) {
    if (!_cached_decoder_for_MultipleSignatures) {
        _cached_decoder_for_MultipleSignatures = function (
            el: _Element
        ): MultipleSignatures {
            ...
            const callbacks: $.DecodingMap = {
                bodyHashAlg: (_el: _Element): void => {
                    bodyHashAlg = _decode_AlgorithmIdentifier(_el);
                },
                signAlg: (_el: _Element): void => {
                    signAlg = _decode_AlgorithmIdentifier(_el);
                },
                signAttrsHash: (_el: _Element): void => {
                    signAttrsHash = _decode_SignAttrsHash(_el);
                },
                cert: (_el: _Element): void => {
                    cert = _decode_ESSCertIDv2(_el);
                },
            };
...
let _cached_encoder_for_MultipleSignatures: $.ASN1Encoder<MultipleSignatures> | null =
    null;
 ...
 */
export function _encode_MultipleSignatures(
    value: MultipleSignatures,
    elGetter: $.ASN1Encoder<MultipleSignatures>
) {
    if (!_cached_encoder_for_MultipleSignatures) {
        _cached_encoder_for_MultipleSignatures = function (
            value: MultipleSignatures,
            elGetter: $.ASN1Encoder<MultipleSignatures>
        ): _Element {
                ...
                ([] as (_Element | undefined)[])
                    .concat(
                        [
                            ...
                            /* REQUIRED   */ _encode_SignAttrsHash(
                                value.signAttrsHash,
                                $.BER
                            ),
                            /* IF_ABSENT  */ value.cert === undefined
                                ? undefined
                                : _encode_ESSCertIDv2(value.cert, $.BER),
                        ],
