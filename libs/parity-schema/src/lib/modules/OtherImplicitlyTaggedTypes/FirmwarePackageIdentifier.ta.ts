...
import {
    ...
    _encode_PreferredOrLegacyPackageIdentifier,
} from '../OtherImplicitlyTaggedTypes/PreferredOrLegacyPackageIdentifier.ta';
import {
    PreferredOrLegacyStalePackageIdentifier,
    _decode_PreferredOrLegacyStalePackageIdentifier,
    _encode_PreferredOrLegacyStalePackageIdentifier,
} from '../OtherImplicitlyTaggedTypes/PreferredOrLegacyStalePackageIdentifier.ta';
 ...
 * @class
 */
export class FirmwarePackageIdentifier {
    constructor(
        /**
         * @summary `name`.
         * @public
    ...
    public static _from_object(_o: {
        [_K in keyof FirmwarePackageIdentifier]: FirmwarePackageIdentifier[_K];
    }): FirmwarePackageIdentifier {
        return new FirmwarePackageIdentifier(
            _o.name,
            _o.stale,
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_FirmwarePackageIdentifier: $.ComponentSpec[] =
    [
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_FirmwarePackageIdentifier: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_FirmwarePackageIdentifier: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_FirmwarePackageIdentifier: $.ASN1Decoder<FirmwarePackageIdentifier> | null =
    null;
 ...
 */
export function _decode_FirmwarePackageIdentifier(el: _Element) {
    if (!_cached_decoder_for_FirmwarePackageIdentifier) {
        _cached_decoder_for_FirmwarePackageIdentifier = function (
            el: _Element
        ): FirmwarePackageIdentifier {
            ...
            const callbacks: $.DecodingMap = {
                name: (_el: _Element): void => {
                    name = _decode_PreferredOrLegacyPackageIdentifier(_el);
                },
                stale: (_el: _Element): void => {
                    stale =
                        _decode_PreferredOrLegacyStalePackageIdentifier(_el);
                },
            };
...
let _cached_encoder_for_FirmwarePackageIdentifier: $.ASN1Encoder<FirmwarePackageIdentifier> | null =
    null;
 ...
 */
export function _encode_FirmwarePackageIdentifier(
    value: FirmwarePackageIdentifier,
    elGetter: $.ASN1Encoder<FirmwarePackageIdentifier>
) {
    if (!_cached_encoder_for_FirmwarePackageIdentifier) {
        _cached_encoder_for_FirmwarePackageIdentifier = function (
            value: FirmwarePackageIdentifier,
            elGetter: $.ASN1Encoder<FirmwarePackageIdentifier>
        ): _Element {
            return $._encodeSequence(
                ([] as (_Element | undefined)[])
                    .concat(
                        [
                            /* REQUIRED   */ _encode_PreferredOrLegacyPackageIdentifier(
                                value.name,
                                $.BER
                            ),
                            /* IF_ABSENT  */ value.stale === undefined
                                ? undefined
                                : _encode_PreferredOrLegacyStalePackageIdentifier(
                                      value.stale,
                                      $.BER
