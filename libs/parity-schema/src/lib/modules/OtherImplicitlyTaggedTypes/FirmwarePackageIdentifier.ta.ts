...
import { PreferredOrLegacyPackageIdentifier, _decode_PreferredOrLegacyPackageIdentifier, _encode_PreferredOrLegacyPackageIdentifier } from "../OtherImplicitlyTaggedTypes/PreferredOrLegacyPackageIdentifier.ta";
export { PreferredOrLegacyPackageIdentifier, _decode_PreferredOrLegacyPackageIdentifier, _encode_PreferredOrLegacyPackageIdentifier } from "../OtherImplicitlyTaggedTypes/PreferredOrLegacyPackageIdentifier.ta";
import { PreferredOrLegacyStalePackageIdentifier, _decode_PreferredOrLegacyStalePackageIdentifier, _encode_PreferredOrLegacyStalePackageIdentifier } from "../OtherImplicitlyTaggedTypes/PreferredOrLegacyStalePackageIdentifier.ta";
export { PreferredOrLegacyStalePackageIdentifier, _decode_PreferredOrLegacyStalePackageIdentifier, _encode_PreferredOrLegacyStalePackageIdentifier } from "../OtherImplicitlyTaggedTypes/PreferredOrLegacyStalePackageIdentifier.ta";
...
class FirmwarePackageIdentifier {
    ...
    public static _from_object (_o: { [_K in keyof (FirmwarePackageIdentifier)]: (FirmwarePackageIdentifier)[_K] }): FirmwarePackageIdentifier {
        return new FirmwarePackageIdentifier(_o.name, _o.stale, _o._unrecognizedExtensionsList);
    }
