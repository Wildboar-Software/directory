...
import {
    ...
    _decode_ClassList,
    _encode_ClassList,
} from '../OtherImplicitlyTaggedTypes/ClassList.ta';
import {
    SecurityCategory_rfc3281,
    _decode_SecurityCategory_rfc3281,
    _encode_SecurityCategory_rfc3281,
} from '../OtherImplicitlyTaggedTypes/SecurityCategory-rfc3281.ta';
...
export class Clearance_rfc3281 {
    ...
    public static _from_object(_o: {
        [_K in keyof Clearance_rfc3281]: Clearance_rfc3281[_K];
    }): Clearance_rfc3281 {
        return new Clearance_rfc3281(
            _o.policyId,
            _o.classList,
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_Clearance_rfc3281: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'policyId',
            false,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_Clearance_rfc3281: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_Clearance_rfc3281: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_Clearance_rfc3281: $.ASN1Decoder<Clearance_rfc3281> | null =
    null;
 ...
 */
export function _decode_Clearance_rfc3281(el: _Element) {
        ...
        _cached_decoder_for_Clearance_rfc3281 = function (
            ...
            const callbacks: $.DecodingMap = {
                policyId: (_el: _Element): void => {
                    policyId = $._decode_implicit<OBJECT_IDENTIFIER>(
                        () => $._decodeObjectIdentifier
                    )(_el);
                },
                classList: (_el: _Element): void => {
                    classList = $._decode_implicit<ClassList>(
                        () => _decode_ClassList
                    )(_el);
                },
                securityCategories: (_el: _Element): void => {
                    securityCategories = $._decode_implicit<
                        SecurityCategory_rfc3281[]
                    >(() =>
                        $._decodeSetOf<SecurityCategory_rfc3281>(
                            () => _decode_SecurityCategory_rfc3281
                        )
                    )(_el);
                },
...
let _cached_encoder_for_Clearance_rfc3281: $.ASN1Encoder<Clearance_rfc3281> | null =
    null;
...
export function _encode_Clearance_rfc3281(
    ...
    elGetter: $.ASN1Encoder<Clearance_rfc3281>
) {
                        ...
                        [
                            ...
                            undefined
                                ...
                                : $._encode_implicit(
                                      ...
                                      2,
                                      () =>
                                          $._encodeSetOf<SecurityCategory_rfc3281>(
                                              () =>
                                                  _encode_SecurityCategory_rfc3281,
                                              $.BER
                                          ),
