...
import { HardwareSerialEntry, _decode_HardwareSerialEntry, _encode_HardwareSerialEntry } from "../OtherImplicitlyTaggedTypes/HardwareSerialEntry.ta";
export { HardwareSerialEntry, _decode_HardwareSerialEntry, _encode_HardwareSerialEntry } from "../OtherImplicitlyTaggedTypes/HardwareSerialEntry.ta";
...
class HardwareModules {
     ...
     */
    public static _from_object (_o: { [_K in keyof (HardwareModules)]: (HardwareModules)[_K] }): HardwareModules {
        return new HardwareModules(_o.hwType, _o.hwSerialEntries, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_HardwareModules: $.ComponentSpec[] = [
    new $.ComponentSpec("hwType", false, $.hasTag(_TagClass.universal, 6), undefined, undefined),
    new $.ComponentSpec("hwSerialEntries", false, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_HardwareModules: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_HardwareModules: $.ComponentSpec[] = [
...
let _cached_decoder_for_HardwareModules: $.ASN1Decoder<HardwareModules> | null = null;
 ...
 */
export
function _decode_HardwareModules (el: _Element) {
    if (!_cached_decoder_for_HardwareModules) { _cached_decoder_for_HardwareModules = function (el: _Element): HardwareModules {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("HardwareModules contained only " + sequence.length.toString() + " elements.");
    }
    ...
    hwSerialEntries = $._decodeSequenceOf<HardwareSerialEntry>(() => _decode_HardwareSerialEntry)(sequence[1]);
...
let _cached_encoder_for_HardwareModules: $.ASN1Encoder<HardwareModules> | null = null;
 ...
 */
export
function _encode_HardwareModules (value: HardwareModules, elGetter: $.ASN1Encoder<HardwareModules>) {
    if (!_cached_encoder_for_HardwareModules) { _cached_encoder_for_HardwareModules = function (value: HardwareModules, elGetter: $.ASN1Encoder<HardwareModules>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.hwType, $.BER),
            /* REQUIRED   */ $._encodeSequenceOf<HardwareSerialEntry>(() => _encode_HardwareSerialEntry, $.BER)(value.hwSerialEntries, $.BER)
        ],
