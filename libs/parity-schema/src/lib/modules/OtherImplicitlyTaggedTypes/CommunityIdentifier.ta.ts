...
import { HardwareModules, _decode_HardwareModules, _encode_HardwareModules } from "../OtherImplicitlyTaggedTypes/HardwareModules.ta";
export { HardwareModules, _decode_HardwareModules, _encode_HardwareModules } from "../OtherImplicitlyTaggedTypes/HardwareModules.ta";
...
function _decode_CommunityIdentifier (el: _Element) {
    if (!_cached_decoder_for_CommunityIdentifier) { _cached_decoder_for_CommunityIdentifier = $._decode_extensible_choice<CommunityIdentifier>({
