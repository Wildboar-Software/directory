...
import {
    HardwareModules,
    _decode_HardwareModules,
    _encode_HardwareModules,
} from '../OtherImplicitlyTaggedTypes/HardwareModules.ta';
export {
    HardwareModules,
    _decode_HardwareModules,
    _encode_HardwareModules,
...
let _cached_decoder_for_CommunityIdentifier: $.ASN1Decoder<CommunityIdentifier> | null =
    null;
 ...
 */
export function _decode_CommunityIdentifier(el: _Element) {
    if (!_cached_decoder_for_CommunityIdentifier) {
        _cached_decoder_for_CommunityIdentifier =
            $._decode_extensible_choice<CommunityIdentifier>({
...
let _cached_encoder_for_CommunityIdentifier: $.ASN1Encoder<CommunityIdentifier> | null =
    null;
 ...
 */
export function _encode_CommunityIdentifier(
    value: CommunityIdentifier,
    elGetter: $.ASN1Encoder<CommunityIdentifier>
) {
    if (!_cached_encoder_for_CommunityIdentifier) {
        _cached_encoder_for_CommunityIdentifier =
            $._encode_choice<CommunityIdentifier>(
                {
