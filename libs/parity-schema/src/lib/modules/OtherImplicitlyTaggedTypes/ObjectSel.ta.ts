...
import { ObjectSel_objSelect, _decode_ObjectSel_objSelect, _encode_ObjectSel_objSelect } from "../OtherImplicitlyTaggedTypes/ObjectSel-objSelect.ta";
export { ObjectSel_objSelect, _decode_ObjectSel_objSelect, _encode_ObjectSel_objSelect } from "../OtherImplicitlyTaggedTypes/ObjectSel-objSelect.ta";
...
class ObjectSel {
     ...
     * @returns {ObjectSel}
     */
    public static _from_object (_o: { [_K in keyof (ObjectSel)]: (ObjectSel)[_K] }): ObjectSel {
        return new ObjectSel(_o.objecClass, _o.objSelect, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ObjectSel: $.ComponentSpec[] = [
    new $.ComponentSpec("objecClass", false, $.hasTag(_TagClass.universal, 6), undefined, undefined),
 ...
 */
export
const _root_component_type_list_2_spec_for_ObjectSel: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ObjectSel: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ObjectSel (el: _Element) {
    if (!_cached_decoder_for_ObjectSel) { _cached_decoder_for_ObjectSel = function (el: _Element): ObjectSel {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("ObjectSel contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_ObjectSel (value: ObjectSel, elGetter: $.ASN1Encoder<ObjectSel>) {
    if (!_cached_encoder_for_ObjectSel) { _cached_encoder_for_ObjectSel = function (value: ObjectSel, elGetter: $.ASN1Encoder<ObjectSel>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.objecClass, $.BER),
            /* REQUIRED   */ _encode_ObjectSel_objSelect(value.objSelect, $.BER)
        ],
