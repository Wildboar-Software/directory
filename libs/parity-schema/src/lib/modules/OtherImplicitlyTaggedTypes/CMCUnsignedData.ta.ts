...
import { BodyPartPath, _decode_BodyPartPath, _encode_BodyPartPath } from "../OtherImplicitlyTaggedTypes/BodyPartPath.ta";
export { BodyPartPath, _decode_BodyPartPath, _encode_BodyPartPath } from "../OtherImplicitlyTaggedTypes/BodyPartPath.ta";
...
class CMCUnsignedData {
     ...
     */
    public static _from_object (_o: { [_K in keyof (CMCUnsignedData)]: (CMCUnsignedData)[_K] }): CMCUnsignedData {
        return new CMCUnsignedData(_o.bodyPartPath, _o.identifier, _o.content, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_CMCUnsignedData: $.ComponentSpec[] = [
    new $.ComponentSpec("bodyPartPath", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("identifier", false, $.hasTag(_TagClass.universal, 6), undefined, undefined),
    new $.ComponentSpec("content", false, $.hasAnyTag, undefined, undefined)
];
...
let _cached_decoder_for_CMCUnsignedData: $.ASN1Decoder<CMCUnsignedData> | null = null;
 ...
 */
export
function _decode_CMCUnsignedData (el: _Element) {
    if (!_cached_decoder_for_CMCUnsignedData) { _cached_decoder_for_CMCUnsignedData = function (el: _Element): CMCUnsignedData {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new _ConstructionError("CMCUnsignedData contained only " + sequence.length.toString() + " elements.");
    }
...
let _cached_encoder_for_CMCUnsignedData: $.ASN1Encoder<CMCUnsignedData> | null = null;
 ...
 */
export
function _encode_CMCUnsignedData (value: CMCUnsignedData, elGetter: $.ASN1Encoder<CMCUnsignedData>) {
    if (!_cached_encoder_for_CMCUnsignedData) { _cached_encoder_for_CMCUnsignedData = function (value: CMCUnsignedData, elGetter: $.ASN1Encoder<CMCUnsignedData>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_BodyPartPath(value.bodyPartPath, $.BER),
