 ...
 * @class
 */
export class FirmwarePackageInfo {
    constructor(
        /**
         * @summary `fwPkgType`.
         * @public
    ...
    public static _from_object(_o: {
        [_K in keyof FirmwarePackageInfo]: FirmwarePackageInfo[_K];
    }): FirmwarePackageInfo {
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_FirmwarePackageInfo: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'fwPkgType',
            true,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_FirmwarePackageInfo: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_FirmwarePackageInfo: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_FirmwarePackageInfo: $.ASN1Decoder<FirmwarePackageInfo> | null =
    null;
 ...
 */
export function _decode_FirmwarePackageInfo(el: _Element) {
    if (!_cached_decoder_for_FirmwarePackageInfo) {
        _cached_decoder_for_FirmwarePackageInfo = function (
            el: _Element
        ): FirmwarePackageInfo {
            ...
            const callbacks: $.DecodingMap = {
                fwPkgType: (_el: _Element): void => {
                    fwPkgType = $._decodeInteger(_el);
                },
                dependencies: (_el: _Element): void => {
                    dependencies =
                        $._decodeSequenceOf<PreferredOrLegacyPackageIdentifier>(
                            () => _decode_PreferredOrLegacyPackageIdentifier
                        )(_el);
                },
            };
...
let _cached_encoder_for_FirmwarePackageInfo: $.ASN1Encoder<FirmwarePackageInfo> | null =
    null;
 ...
 */
export function _encode_FirmwarePackageInfo(
    value: FirmwarePackageInfo,
    elGetter: $.ASN1Encoder<FirmwarePackageInfo>
) {
    if (!_cached_encoder_for_FirmwarePackageInfo) {
        _cached_encoder_for_FirmwarePackageInfo = function (
            value: FirmwarePackageInfo,
            elGetter: $.ASN1Encoder<FirmwarePackageInfo>
        ): _Element {
            return $._encodeSequence(
                ([] as (_Element | undefined)[])
                    .concat(
                        [
                            /* IF_ABSENT  */ value.fwPkgType === undefined
                                ? undefined
                                : $._encodeInteger(value.fwPkgType, $.BER),
                            /* IF_ABSENT  */ value.dependencies === undefined
                                ? undefined
                                : $._encodeSequenceOf<PreferredOrLegacyPackageIdentifier>(
                                      () =>
                                          _encode_PreferredOrLegacyPackageIdentifier,
                                      $.BER
                                  )(value.dependencies, $.BER),
                        ],
