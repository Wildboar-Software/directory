...
import { ObjectSel_objSelect_objectNames_Item_object, _decode_ObjectSel_objSelect_objectNames_Item_object, _encode_ObjectSel_objSelect_objectNames_Item_object } from "../OtherImplicitlyTaggedTypes/ObjectSel-objSelect-objectNames-Item-object.ta";
export { ObjectSel_objSelect_objectNames_Item_object, _decode_ObjectSel_objSelect_objectNames_Item_object, _encode_ObjectSel_objSelect_objectNames_Item_object } from "../OtherImplicitlyTaggedTypes/ObjectSel-objSelect-objectNames-Item-object.ta";
 ...
 */
export
class ObjectSel_objSelect_objectNames_Item {
    constructor (
        /**
         * @summary `object`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (ObjectSel_objSelect_objectNames_Item)]: (ObjectSel_objSelect_objectNames_Item)[_K] }): ObjectSel_objSelect_objectNames_Item {
        return new ObjectSel_objSelect_objectNames_Item(_o.object, _o.select, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ObjectSel_objSelect_objectNames_Item: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ObjectSel_objSelect_objectNames_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ObjectSel_objSelect_objectNames_Item: $.ComponentSpec[] = [
...
let _cached_decoder_for_ObjectSel_objSelect_objectNames_Item: $.ASN1Decoder<ObjectSel_objSelect_objectNames_Item> | null = null;
 ...
 */
export
function _decode_ObjectSel_objSelect_objectNames_Item (el: _Element) {
    if (!_cached_decoder_for_ObjectSel_objSelect_objectNames_Item) { _cached_decoder_for_ObjectSel_objSelect_objectNames_Item = function (el: _Element): ObjectSel_objSelect_objectNames_Item {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("ObjectSel-objSelect-objectNames-Item contained only " + sequence.length.toString() + " elements.");
    }
    ...
    object = _decode_ObjectSel_objSelect_objectNames_Item_object(sequence[0]);
...
let _cached_encoder_for_ObjectSel_objSelect_objectNames_Item: $.ASN1Encoder<ObjectSel_objSelect_objectNames_Item> | null = null;
 ...
 */
export
function _encode_ObjectSel_objSelect_objectNames_Item (value: ObjectSel_objSelect_objectNames_Item, elGetter: $.ASN1Encoder<ObjectSel_objSelect_objectNames_Item>) {
    if (!_cached_encoder_for_ObjectSel_objSelect_objectNames_Item) { _cached_encoder_for_ObjectSel_objSelect_objectNames_Item = function (value: ObjectSel_objSelect_objectNames_Item, elGetter: $.ASN1Encoder<ObjectSel_objSelect_objectNames_Item>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ObjectSel_objSelect_objectNames_Item_object(value.object, $.BER),
            /* REQUIRED   */ _encode_TargetSelect(value.select, $.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (_Element | undefined)): c is _Element => (!!c)), $.BER);
}; }
    return _cached_encoder_for_ObjectSel_objSelect_objectNames_Item(value, elGetter);
}
