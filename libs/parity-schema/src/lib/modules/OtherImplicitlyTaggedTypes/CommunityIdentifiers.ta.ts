...
import {
    CommunityIdentifier,
    _decode_CommunityIdentifier,
    _encode_CommunityIdentifier,
} from '../OtherImplicitlyTaggedTypes/CommunityIdentifier.ta';
 ...
 * ```
 */
export type CommunityIdentifiers = CommunityIdentifier[]; // SequenceOfType
/* END_OF_SYMBOL_DEFINITION CommunityIdentifiers */

/* START_OF_SYMBOL_DEFINITION _cached_decoder_for_CommunityIdentifiers */
let _cached_decoder_for_CommunityIdentifiers: $.ASN1Decoder<CommunityIdentifiers> | null =
    null;
 ...
 */
export function _decode_CommunityIdentifiers(el: _Element) {
    if (!_cached_decoder_for_CommunityIdentifiers) {
        _cached_decoder_for_CommunityIdentifiers =
            $._decodeSequenceOf<CommunityIdentifier>(
                () => _decode_CommunityIdentifier
            );
    }
...
let _cached_encoder_for_CommunityIdentifiers: $.ASN1Encoder<CommunityIdentifiers> | null =
    null;
 ...
 */
export function _encode_CommunityIdentifiers(
    value: CommunityIdentifiers,
    elGetter: $.ASN1Encoder<CommunityIdentifiers>
) {
    if (!_cached_encoder_for_CommunityIdentifiers) {
        _cached_encoder_for_CommunityIdentifiers =
            $._encodeSequenceOf<CommunityIdentifier>(
                () => _encode_CommunityIdentifier,
                $.BER
            );
    }
