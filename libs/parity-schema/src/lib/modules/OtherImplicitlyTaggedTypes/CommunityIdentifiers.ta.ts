...
import { CommunityIdentifier, _decode_CommunityIdentifier, _encode_CommunityIdentifier } from "../OtherImplicitlyTaggedTypes/CommunityIdentifier.ta";
export { CommunityIdentifier, _decode_CommunityIdentifier, _encode_CommunityIdentifier } from "../OtherImplicitlyTaggedTypes/CommunityIdentifier.ta";
