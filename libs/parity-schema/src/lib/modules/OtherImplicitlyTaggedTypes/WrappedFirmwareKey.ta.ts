 ...
 * ```
 */
export type WrappedFirmwareKey = EnvelopedData; // DefinedType
/* END_OF_SYMBOL_DEFINITION WrappedFirmwareKey */

/* START_OF_SYMBOL_DEFINITION _cached_decoder_for_WrappedFirmwareKey */
let _cached_decoder_for_WrappedFirmwareKey: $.ASN1Decoder<WrappedFirmwareKey> | null =
    null;
 ...
 */
export function _decode_WrappedFirmwareKey(el: _Element) {
    if (!_cached_decoder_for_WrappedFirmwareKey) {
        _cached_decoder_for_WrappedFirmwareKey = _decode_EnvelopedData;
    }
...
let _cached_encoder_for_WrappedFirmwareKey: $.ASN1Encoder<WrappedFirmwareKey> | null =
    null;
 ...
 */
export function _encode_WrappedFirmwareKey(
    value: WrappedFirmwareKey,
    elGetter: $.ASN1Encoder<WrappedFirmwareKey>
) {
    if (!_cached_encoder_for_WrappedFirmwareKey) {
        _cached_encoder_for_WrappedFirmwareKey = _encode_EnvelopedData;
    }
