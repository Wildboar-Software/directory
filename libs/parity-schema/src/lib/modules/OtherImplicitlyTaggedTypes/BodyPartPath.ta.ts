...
import { BodyPartID, _decode_BodyPartID, _encode_BodyPartID } from "../OtherImplicitlyTaggedTypes/BodyPartID.ta";
export { BodyPartID, _decode_BodyPartID, _encode_BodyPartID } from "../OtherImplicitlyTaggedTypes/BodyPartID.ta";
