 ...
 * ```
 */
export type ImplementedCompressAlgorithms = OBJECT_IDENTIFIER[]; // SequenceOfType
...
let _cached_decoder_for_ImplementedCompressAlgorithms: $.ASN1Decoder<ImplementedCompressAlgorithms> | null =
    null;
 ...
 */
export function _decode_ImplementedCompressAlgorithms(el: _Element) {
    if (!_cached_decoder_for_ImplementedCompressAlgorithms) {
        _cached_decoder_for_ImplementedCompressAlgorithms =
...
let _cached_encoder_for_ImplementedCompressAlgorithms: $.ASN1Encoder<ImplementedCompressAlgorithms> | null =
    null;
 ...
 */
export function _encode_ImplementedCompressAlgorithms(
    value: ImplementedCompressAlgorithms,
    elGetter: $.ASN1Encoder<ImplementedCompressAlgorithms>
) {
    if (!_cached_encoder_for_ImplementedCompressAlgorithms) {
        _cached_encoder_for_ImplementedCompressAlgorithms =
