...
import {
    ...
    _decode_PreferredPackageIdentifier,
    _encode_PreferredPackageIdentifier,
} from '../OtherImplicitlyTaggedTypes/PreferredPackageIdentifier.ta';
export {
    PreferredPackageIdentifier,
    _decode_PreferredPackageIdentifier,
    _encode_PreferredPackageIdentifier,
 ...
 * ```
 */
export type PreferredOrLegacyPackageIdentifier =
...
let _cached_decoder_for_PreferredOrLegacyPackageIdentifier: $.ASN1Decoder<PreferredOrLegacyPackageIdentifier> | null =
    null;
 ...
 */
export function _decode_PreferredOrLegacyPackageIdentifier(el: _Element) {
    if (!_cached_decoder_for_PreferredOrLegacyPackageIdentifier) {
        _cached_decoder_for_PreferredOrLegacyPackageIdentifier =
            $._decode_extensible_choice<PreferredOrLegacyPackageIdentifier>({
                'UNIVERSAL 16': [
                    'preferred',
                    _decode_PreferredPackageIdentifier,
                ],
...
let _cached_encoder_for_PreferredOrLegacyPackageIdentifier: $.ASN1Encoder<PreferredOrLegacyPackageIdentifier> | null =
    null;
 ...
 */
export function _encode_PreferredOrLegacyPackageIdentifier(
    value: PreferredOrLegacyPackageIdentifier,
    elGetter: $.ASN1Encoder<PreferredOrLegacyPackageIdentifier>
) {
    if (!_cached_encoder_for_PreferredOrLegacyPackageIdentifier) {
        _cached_encoder_for_PreferredOrLegacyPackageIdentifier =
            $._encode_choice<PreferredOrLegacyPackageIdentifier>(
                {
    ...
    return _cached_encoder_for_PreferredOrLegacyPackageIdentifier(
        value,
        elGetter
    );
}
