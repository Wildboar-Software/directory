...
import { PreferredPackageIdentifier, _decode_PreferredPackageIdentifier, _encode_PreferredPackageIdentifier } from "../OtherImplicitlyTaggedTypes/PreferredPackageIdentifier.ta";
export { PreferredPackageIdentifier, _decode_PreferredPackageIdentifier, _encode_PreferredPackageIdentifier } from "../OtherImplicitlyTaggedTypes/PreferredPackageIdentifier.ta";
...
function _decode_PreferredOrLegacyPackageIdentifier (el: _Element) {
    if (!_cached_decoder_for_PreferredOrLegacyPackageIdentifier) { _cached_decoder_for_PreferredOrLegacyPackageIdentifier = $._decode_extensible_choice<PreferredOrLegacyPackageIdentifier>({
