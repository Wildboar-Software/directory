/* eslint-disable */
import { ASN1Element as _Element, NULL, OCTET_STRING } from '@wildboar/asn1';
import * as $ from '@wildboar/asn1/functional';
import {
    HardwareSerialEntry_block,
    _decode_HardwareSerialEntry_block,
    _encode_HardwareSerialEntry_block,
} from '../OtherImplicitlyTaggedTypes/HardwareSerialEntry-block.ta';
export {
    HardwareSerialEntry_block,
    _decode_HardwareSerialEntry_block,
    _encode_HardwareSerialEntry_block,
 ...
 * ```
 */
export type HardwareSerialEntry =
...
let _cached_decoder_for_HardwareSerialEntry: $.ASN1Decoder<HardwareSerialEntry> | null =
    null;
 ...
 */
export function _decode_HardwareSerialEntry(el: _Element) {
    if (!_cached_decoder_for_HardwareSerialEntry) {
        _cached_decoder_for_HardwareSerialEntry =
            $._decode_extensible_choice<HardwareSerialEntry>({
...
let _cached_encoder_for_HardwareSerialEntry: $.ASN1Encoder<HardwareSerialEntry> | null =
    null;
 ...
 */
export function _encode_HardwareSerialEntry(
    value: HardwareSerialEntry,
    elGetter: $.ASN1Encoder<HardwareSerialEntry>
) {
    if (!_cached_encoder_for_HardwareSerialEntry) {
        _cached_encoder_for_HardwareSerialEntry =
            $._encode_choice<HardwareSerialEntry>(
                {
                    all: $._encodeNull,
