...
class SvceAuthInfo {
     ...
     */
    public static _from_object (_o: { [_K in keyof (SvceAuthInfo)]: (SvceAuthInfo)[_K] }): SvceAuthInfo {
        return new SvceAuthInfo(_o.service, _o.ident, _o.authInfo, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SvceAuthInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("service", false, $.hasAnyTag, undefined, undefined),
    new $.ComponentSpec("ident", false, $.hasAnyTag, undefined, undefined),
    new $.ComponentSpec("authInfo", true, $.hasTag(_TagClass.universal, 4), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_SvceAuthInfo: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SvceAuthInfo: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SvceAuthInfo (el: _Element) {
    if (!_cached_decoder_for_SvceAuthInfo) { _cached_decoder_for_SvceAuthInfo = function (el: _Element): SvceAuthInfo {
    ...
    const callbacks: $.DecodingMap = {
        "service": (_el: _Element): void => { service = _decode_GeneralName(_el); },
        "ident": (_el: _Element): void => { ident = _decode_GeneralName(_el); },
        "authInfo": (_el: _Element): void => { authInfo = $._decodeOctetString(_el); }
    };
 ...
 */
export
function _encode_SvceAuthInfo (value: SvceAuthInfo, elGetter: $.ASN1Encoder<SvceAuthInfo>) {
    if (!_cached_encoder_for_SvceAuthInfo) { _cached_encoder_for_SvceAuthInfo = function (value: SvceAuthInfo, elGetter: $.ASN1Encoder<SvceAuthInfo>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_GeneralName(value.service, $.BER),
            /* REQUIRED   */ _encode_GeneralName(value.ident, $.BER),
            /* IF_ABSENT  */ ((value.authInfo === undefined) ? undefined : $._encodeOctetString(value.authInfo, $.BER))
        ],
