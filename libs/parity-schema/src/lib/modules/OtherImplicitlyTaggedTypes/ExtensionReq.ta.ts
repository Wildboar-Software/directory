 ...
 */
export
type ExtensionReq = Extensions; // DefinedType
...
function _decode_ExtensionReq (el: _Element) {
    if (!_cached_decoder_for_ExtensionReq) { _cached_decoder_for_ExtensionReq = _decode_Extensions; }
...
function _encode_ExtensionReq (value: ExtensionReq, elGetter: $.ASN1Encoder<ExtensionReq>) {
    if (!_cached_encoder_for_ExtensionReq) { _cached_encoder_for_ExtensionReq = _encode_Extensions; }
