...
/* START_OF_SYMBOL_DEFINITION xmozillanickname */
/**
 * @summary xmozillanickname
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const xmozillanickname: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["xmozillanickname","mozillaNickname"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 1,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION xmozillanickname */
