...
/* START_OF_SYMBOL_DEFINITION mozillaSecondEmail */
/**
 * @summary mozillaSecondEmail
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mozillaSecondEmail: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mozillaSecondEmail"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 3,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mozillaSecondEmail */
