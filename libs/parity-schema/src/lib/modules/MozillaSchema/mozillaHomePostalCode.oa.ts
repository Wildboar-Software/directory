...
/* START_OF_SYMBOL_DEFINITION mozillaHomePostalCode */
/**
 * @summary mozillaHomePostalCode
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mozillaHomePostalCode: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mozillaHomePostalCode"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 8,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mozillaHomePostalCode */
