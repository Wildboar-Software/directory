...
/* START_OF_SYMBOL_DEFINITION mozillaHomeFriendlyCountryName */
/**
 * @summary mozillaHomeFriendlyCountryName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mozillaHomeFriendlyCountryName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mozillaHomeFriendlyCountryName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 10,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mozillaHomeFriendlyCountryName */
