...
/* START_OF_SYMBOL_DEFINITION mozillaHomeState */
/**
 * @summary mozillaHomeState
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mozillaHomeState: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mozillaHomeState"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 7,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mozillaHomeState */
