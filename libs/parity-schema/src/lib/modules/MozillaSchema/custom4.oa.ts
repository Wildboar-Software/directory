...
/* START_OF_SYMBOL_DEFINITION custom4 */
/**
 * @summary custom4
 * @description
 * 
 ...
 */
export
const custom4: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["custom4","mozillaCustom4"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 99,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION custom4 */
