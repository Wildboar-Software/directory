...
/* START_OF_SYMBOL_DEFINITION custom3 */
/**
 * @summary custom3
 * @description
 * 
 ...
 */
export
const custom3: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["custom3","mozillaCustom3"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 98,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION custom3 */
