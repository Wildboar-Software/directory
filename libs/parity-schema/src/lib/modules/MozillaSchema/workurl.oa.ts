...
/* START_OF_SYMBOL_DEFINITION workurl */
/**
 * @summary workurl
 * @description
 * 
 ...
 */
export
const workurl: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["workurl","mozillaWorkUrl"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 12,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION workurl */
