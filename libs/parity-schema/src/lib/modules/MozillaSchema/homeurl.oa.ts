...
/* START_OF_SYMBOL_DEFINITION homeurl */
/**
 * @summary homeurl
 * @description
 * 
 ...
 */
export
const homeurl: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["homeurl","mozillaHomeUrl"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 11,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION homeurl */
