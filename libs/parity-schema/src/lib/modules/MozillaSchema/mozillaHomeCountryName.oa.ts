...
/* START_OF_SYMBOL_DEFINITION mozillaHomeCountryName */
/**
 * @summary mozillaHomeCountryName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const mozillaHomeCountryName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mozillaHomeCountryName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 13769, 2, 1, 9,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mozillaHomeCountryName */
