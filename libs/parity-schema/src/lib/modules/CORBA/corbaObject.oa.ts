 ...
 */
export
const corbaObject: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ corbaRepositoryId, description, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["corbaObject"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "CORBA object representation" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 42, 2, 27, 4, 2, 9,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
