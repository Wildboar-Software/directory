...
/* START_OF_SYMBOL_DEFINITION vPIMRfc822Mailbox */
/**
 * @summary vPIMRfc822Mailbox
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const vPIMRfc822Mailbox: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["vPIMRfc822Mailbox"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 2,], iana_assigned_oid) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION vPIMRfc822Mailbox */
