...
/* START_OF_SYMBOL_DEFINITION vPIMSupportedAudioMediaTypes */
/**
 * @summary vPIMSupportedAudioMediaTypes
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const vPIMSupportedAudioMediaTypes: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["vPIMSupportedAudioMediaTypes"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 5,], iana_assigned_oid) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION vPIMSupportedAudioMediaTypes */
