...
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/integerOrderingMatch.oa";


/* START_OF_SYMBOL_DEFINITION vPIMMaxMessageSize */
/**
 * @summary vPIMMaxMessageSize
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const vPIMMaxMessageSize: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["vPIMMaxMessageSize"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 9,], iana_assigned_oid) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION vPIMMaxMessageSize */
