...
/* START_OF_SYMBOL_DEFINITION vPIMSupportedMessageContext */
/**
 * @summary vPIMSupportedMessageContext
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const vPIMSupportedMessageContext: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["vPIMSupportedMessageContext"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 6,], iana_assigned_oid) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION vPIMSupportedMessageContext */
