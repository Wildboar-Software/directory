...
/* START_OF_SYMBOL_DEFINITION vPIMTextName */
/**
 * @summary vPIMTextName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const vPIMTextName: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["vPIMTextName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 4,], iana_assigned_oid) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION vPIMTextName */
