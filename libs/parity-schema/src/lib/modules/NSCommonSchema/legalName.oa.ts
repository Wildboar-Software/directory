...
/* START_OF_SYMBOL_DEFINITION legalName */
/**
 * @summary legalName
 * @description
 * 
 ...
 */
export
const legalName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["legalName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "An individuals legalName." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([2, 16, 840, 1, 113730, 3, 1, 2343,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION legalName */
