...
/* START_OF_SYMBOL_DEFINITION sambaStringOption */
/**
 * @summary sambaStringOption
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const sambaStringOption: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaStringOption"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A string option" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 45,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaStringOption */
