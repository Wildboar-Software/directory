...
/* START_OF_SYMBOL_DEFINITION sambaLogonHours */
/**
 * @summary sambaLogonHours
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLogonHours: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaLogonHours"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Logon Hours" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 55,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLogonHours */
