...
/* START_OF_SYMBOL_DEFINITION sambaRefuseMachinePwdChange */
/**
 * @summary sambaRefuseMachinePwdChange
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaRefuseMachinePwdChange: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaRefuseMachinePwdChange"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Allow Machine Password changes (default: 0 => off)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 67,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaRefuseMachinePwdChange */
