...
/* START_OF_SYMBOL_DEFINITION sambaAlgorithmicRidBase */
/**
 * @summary sambaAlgorithmicRidBase
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaAlgorithmicRidBase: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaAlgorithmicRidBase"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Base at which the samba RID generation algorithm should operate" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 40,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaAlgorithmicRidBase */
