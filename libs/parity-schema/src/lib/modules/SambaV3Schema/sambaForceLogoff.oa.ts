...
/* START_OF_SYMBOL_DEFINITION sambaForceLogoff */
/**
 * @summary sambaForceLogoff
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaForceLogoff: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaForceLogoff"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Disconnect Users outside logon hours (default: -1 => off, 0 => on)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 66,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaForceLogoff */
