...
/* START_OF_SYMBOL_DEFINITION sambaMinPwdLength */
/**
 * @summary sambaMinPwdLength
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaMinPwdLength: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaMinPwdLength"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Minimal password length (default: 5)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 58,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaMinPwdLength */
