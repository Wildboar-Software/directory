...
/* START_OF_SYMBOL_DEFINITION sambaMaxPwdAge */
/**
 * @summary sambaMaxPwdAge
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaMaxPwdAge: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaMaxPwdAge"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Maximum password age, in seconds (default: -1 => never expire passwords)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 61,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaMaxPwdAge */
