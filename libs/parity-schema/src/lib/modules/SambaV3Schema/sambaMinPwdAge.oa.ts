...
/* START_OF_SYMBOL_DEFINITION sambaMinPwdAge */
/**
 * @summary sambaMinPwdAge
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaMinPwdAge: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaMinPwdAge"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Minimum password age, in seconds (default: 0 => allow immediate password change)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 62,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaMinPwdAge */
