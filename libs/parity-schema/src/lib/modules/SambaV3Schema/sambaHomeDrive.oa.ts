...
/* START_OF_SYMBOL_DEFINITION sambaHomeDrive */
/**
 * @summary sambaHomeDrive
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaHomeDrive: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaHomeDrive"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Driver letter of home directory mapping" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 33,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaHomeDrive */
