...
/* START_OF_SYMBOL_DEFINITION sambaIntegerOption */
/**
 * @summary sambaIntegerOption
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaIntegerOption: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaIntegerOption"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "An integer option" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 44,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaIntegerOption */
