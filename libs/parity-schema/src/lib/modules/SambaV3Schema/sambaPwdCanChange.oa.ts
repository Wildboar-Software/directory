...
/* START_OF_SYMBOL_DEFINITION sambaPwdCanChange */
/**
 * @summary sambaPwdCanChange
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaPwdCanChange: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaPwdCanChange"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Timestamp of when the user is allowed to update the password" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 28,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaPwdCanChange */
