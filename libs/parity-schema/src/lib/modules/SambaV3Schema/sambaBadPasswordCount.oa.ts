...
/* START_OF_SYMBOL_DEFINITION sambaBadPasswordCount */
/**
 * @summary sambaBadPasswordCount
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaBadPasswordCount: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaBadPasswordCount"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Bad password attempt count" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 48,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaBadPasswordCount */
