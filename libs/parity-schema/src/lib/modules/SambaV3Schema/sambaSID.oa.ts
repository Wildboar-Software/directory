...
/* START_OF_SYMBOL_DEFINITION sambaSID */
/**
 * @summary sambaSID
 * @description
 * 
 ...
 */
export
const sambaSID: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaSID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Security ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 20,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaSID */
