...
/* START_OF_SYMBOL_DEFINITION sambaPrivilegeList */
/**
 * @summary sambaPrivilegeList
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaPrivilegeList: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaPrivilegeList"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Privileges List" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 52,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaPrivilegeList */
