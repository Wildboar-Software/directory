...
/* START_OF_SYMBOL_DEFINITION sambaLMPassword */
/**
 * @summary sambaLMPassword
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLMPassword: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaLMPassword"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "LanManager Password" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 24,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLMPassword */
