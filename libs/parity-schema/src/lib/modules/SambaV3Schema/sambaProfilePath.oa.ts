...
/* START_OF_SYMBOL_DEFINITION sambaProfilePath */
/**
 * @summary sambaProfilePath
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaProfilePath: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaProfilePath"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Roaming profile path" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 35,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaProfilePath */
