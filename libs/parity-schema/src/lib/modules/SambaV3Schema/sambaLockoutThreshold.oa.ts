...
/* START_OF_SYMBOL_DEFINITION sambaLockoutThreshold */
/**
 * @summary sambaLockoutThreshold
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLockoutThreshold: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaLockoutThreshold"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Lockout users after bad logon attempts (default: 0 => off)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 65,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLockoutThreshold */
