...
/* START_OF_SYMBOL_DEFINITION sambaKickoffTime */
/**
 * @summary sambaKickoffTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaKickoffTime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaKickoffTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Timestamp of when the user will be logged off automatically" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 32,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaKickoffTime */
