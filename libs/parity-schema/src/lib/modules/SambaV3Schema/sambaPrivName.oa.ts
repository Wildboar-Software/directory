...
import {
    name,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/name.oa";
import {
 ...
 */
export
const sambaPrivName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 50,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
