...
/* START_OF_SYMBOL_DEFINITION sambaHomePath */
/**
 * @summary sambaHomePath
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaHomePath: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaHomePath"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Home directory UNC path" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 37,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaHomePath */
