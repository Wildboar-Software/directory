...
/* START_OF_SYMBOL_DEFINITION sambaNextUserRid */
/**
 * @summary sambaNextUserRid
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaNextUserRid: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaNextUserRid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Next NT rid to give our for users" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 21,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaNextUserRid */
