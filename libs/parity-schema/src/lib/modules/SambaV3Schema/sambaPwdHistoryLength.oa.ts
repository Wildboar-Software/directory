...
/* START_OF_SYMBOL_DEFINITION sambaPwdHistoryLength */
/**
 * @summary sambaPwdHistoryLength
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaPwdHistoryLength: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaPwdHistoryLength"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Length of Password History Entries (default: 0 =>  off)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 59,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaPwdHistoryLength */
