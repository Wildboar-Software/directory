...
/* START_OF_SYMBOL_DEFINITION sambaNTPassword */
/**
 * @summary sambaNTPassword
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaNTPassword: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaNTPassword"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "MD4 hash of the unicode password" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 25,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaNTPassword */
