...
/* START_OF_SYMBOL_DEFINITION sambaLogoffTime */
/**
 * @summary sambaLogoffTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLogoffTime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaLogoffTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Timestamp of last logoff" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 31,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLogoffTime */
