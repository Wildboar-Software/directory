...
/* START_OF_SYMBOL_DEFINITION sambaSIDList */
/**
 * @summary sambaSIDList
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaSIDList: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaSIDList"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Security ID List" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 51,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaSIDList */
