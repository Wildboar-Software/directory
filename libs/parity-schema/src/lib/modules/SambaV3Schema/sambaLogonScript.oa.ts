...
/* START_OF_SYMBOL_DEFINITION sambaLogonScript */
/**
 * @summary sambaLogonScript
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLogonScript: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaLogonScript"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Logon script path" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 34,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLogonScript */
