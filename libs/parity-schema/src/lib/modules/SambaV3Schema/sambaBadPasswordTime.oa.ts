...
/* START_OF_SYMBOL_DEFINITION sambaBadPasswordTime */
/**
 * @summary sambaBadPasswordTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaBadPasswordTime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaBadPasswordTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Time of the last bad password attempt" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 49,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaBadPasswordTime */
