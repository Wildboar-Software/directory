...
/* START_OF_SYMBOL_DEFINITION sambaAcctFlags */
/**
 * @summary sambaAcctFlags
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaAcctFlags: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaAcctFlags"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Account Flags" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 26,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaAcctFlags */
