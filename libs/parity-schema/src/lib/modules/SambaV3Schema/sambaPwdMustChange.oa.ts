...
/* START_OF_SYMBOL_DEFINITION sambaPwdMustChange */
/**
 * @summary sambaPwdMustChange
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaPwdMustChange: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaPwdMustChange"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Timestamp of when the password will expire" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 29,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaPwdMustChange */
