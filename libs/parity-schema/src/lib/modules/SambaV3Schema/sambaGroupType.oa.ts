...
/* START_OF_SYMBOL_DEFINITION sambaGroupType */
/**
 * @summary sambaGroupType
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaGroupType: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaGroupType"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "NT Group Type" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 19,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaGroupType */
