...
/* START_OF_SYMBOL_DEFINITION sambaLogonTime */
/**
 * @summary sambaLogonTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLogonTime: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaLogonTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Timestamp of last logon" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 30,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLogonTime */
