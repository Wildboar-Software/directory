...
import {
    caseExactMatch,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/caseExactMatch.oa";


/* START_OF_SYMBOL_DEFINITION sambaMungedDial */
/**
 * @summary sambaMungedDial
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const sambaMungedDial: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaMungedDial"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 47,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaMungedDial */
