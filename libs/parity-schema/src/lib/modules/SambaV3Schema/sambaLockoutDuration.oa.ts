...
/* START_OF_SYMBOL_DEFINITION sambaLockoutDuration */
/**
 * @summary sambaLockoutDuration
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLockoutDuration: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaLockoutDuration"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Lockout duration in minutes (default: 30, -1 => forever)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 63,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLockoutDuration */
