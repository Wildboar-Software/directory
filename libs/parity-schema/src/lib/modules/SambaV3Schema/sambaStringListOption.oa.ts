...
/* START_OF_SYMBOL_DEFINITION sambaStringListOption */
/**
 * @summary sambaStringListOption
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaStringListOption: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaStringListOption"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A string list option" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 46,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaStringListOption */
