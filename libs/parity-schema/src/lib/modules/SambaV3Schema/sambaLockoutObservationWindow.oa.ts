...
/* START_OF_SYMBOL_DEFINITION sambaLockoutObservationWindow */
/**
 * @summary sambaLockoutObservationWindow
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaLockoutObservationWindow: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaLockoutObservationWindow"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Reset time after lockout in minutes (default: 30)" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 64,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaLockoutObservationWindow */
