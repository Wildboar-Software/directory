...
/* START_OF_SYMBOL_DEFINITION sambaUserWorkstations */
/**
 * @summary sambaUserWorkstations
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaUserWorkstations: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaUserWorkstations"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "List of user workstations the user is allowed to logon to" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 36,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaUserWorkstations */
