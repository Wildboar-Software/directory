...
/* START_OF_SYMBOL_DEFINITION sambaTrustFlags */
/**
 * @summary sambaTrustFlags
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaTrustFlags: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaTrustFlags"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Trust Password Flags" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 53,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaTrustFlags */
