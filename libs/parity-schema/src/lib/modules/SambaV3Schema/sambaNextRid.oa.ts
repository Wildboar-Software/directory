...
/* START_OF_SYMBOL_DEFINITION sambaNextRid */
/**
 * @summary sambaNextRid
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaNextRid: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sambaNextRid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Next NT rid to give out for anything" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 39,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaNextRid */
