...
/* START_OF_SYMBOL_DEFINITION sambaPrimaryGroupSID */
/**
 * @summary sambaPrimaryGroupSID
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sambaPrimaryGroupSID: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sambaPrimaryGroupSID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Primary Group Security ID" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 7165, 2, 1, 23,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sambaPrimaryGroupSID */
