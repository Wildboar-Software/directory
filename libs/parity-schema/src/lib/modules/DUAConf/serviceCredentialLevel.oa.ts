...
/* START_OF_SYMBOL_DEFINITION serviceCredentialLevel */
/**
 * @summary serviceCredentialLevel
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const serviceCredentialLevel: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["serviceCredentialLevel"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Identifies type of credentials a DUA should use when binding to the LDAP server for a specific service" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 13,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION serviceCredentialLevel */
