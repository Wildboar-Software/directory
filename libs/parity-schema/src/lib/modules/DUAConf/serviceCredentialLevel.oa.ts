 ...
 */
export const serviceCredentialLevel: ATTRIBUTE<IA5String> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'Identifies type of credentials a DUA should use when binding to the LDAP server for a specific service' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts(
        [1, 13],
        duaConfSchemaOID
