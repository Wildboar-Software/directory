...
/* START_OF_SYMBOL_DEFINITION defaultServerList */
/**
 * @summary defaultServerList
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const defaultServerList: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["defaultServerList"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Default LDAP server host address used by a DUA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 0,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION defaultServerList */
