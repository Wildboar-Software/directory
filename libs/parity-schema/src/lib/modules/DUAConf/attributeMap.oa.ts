...
/* START_OF_SYMBOL_DEFINITION attributeMap */
/**
 ...
 */
export
const attributeMap: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["attributeMap"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Attribute mappings used by a DUA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 9,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION attributeMap */
