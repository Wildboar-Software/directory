...
/* START_OF_SYMBOL_DEFINITION defaultSearchBase */
/**
 * @summary defaultSearchBase
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const defaultSearchBase: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["defaultSearchBase"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Default LDAP base DN used by a DUA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 1,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION defaultSearchBase */
