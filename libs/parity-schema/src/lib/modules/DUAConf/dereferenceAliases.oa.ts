 ...
 */
export
const dereferenceAliases: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "Tells DUA if it should dereference aliases" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 16,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
