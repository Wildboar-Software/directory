...
/* START_OF_SYMBOL_DEFINITION objectclassMap */
/**
 * @summary objectclassMap
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const objectclassMap: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["objectclassMap"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Objectclass mappings used by a DUA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 11,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION objectclassMap */
