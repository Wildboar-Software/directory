...
/* START_OF_SYMBOL_DEFINITION followReferrals */
/**
 * @summary followReferrals
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const followReferrals: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["followReferrals"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Tells DUA if it should follow referrals returned by a DSA search result" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 5,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION followReferrals */
