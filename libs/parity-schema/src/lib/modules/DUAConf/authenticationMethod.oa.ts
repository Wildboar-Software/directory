 ...
 */
export
const authenticationMethod: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["authenticationMethod"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "A keystring which identifies the type of authentication method used to contact the DSA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 6,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
