 ...
 */
export const authenticationMethod: ATTRIBUTE<UnboundedDirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'A keystring which identifies the type of authentication method used to contact the DSA' /* OBJECT_FIELD_SETTING */,
    '&id': new _OID(
        [1, 6],
        duaConfSchemaOID
