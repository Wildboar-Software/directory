...
/* START_OF_SYMBOL_DEFINITION profileTTL */
/**
 * @summary profileTTL
 * @description
 * 
 ...
 */
export
const profileTTL: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["profileTTL"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Time to live, in seconds, before a client DUA should re-read this configuration profile" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 7,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION profileTTL */
