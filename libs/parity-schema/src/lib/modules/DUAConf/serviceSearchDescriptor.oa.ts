...
/* START_OF_SYMBOL_DEFINITION serviceSearchDescriptor */
/**
 * @summary serviceSearchDescriptor
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const serviceSearchDescriptor: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["serviceSearchDescriptor"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "LDAP search descriptor list used by a DUA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 14,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION serviceSearchDescriptor */
