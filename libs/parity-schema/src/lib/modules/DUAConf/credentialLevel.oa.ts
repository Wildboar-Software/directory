 ...
 */
export
const credentialLevel: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Identifies type of credentials a DUA should use when binding to the LDAP server" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 10,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
