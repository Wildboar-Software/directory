 ...
 */
export
const defaultSearchScope: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Default search scope used by a DUA" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 12,], duaConfSchemaOID) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
