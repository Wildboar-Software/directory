...
/* START_OF_SYMBOL_DEFINITION mailReceipt */
/**
 * @summary mailReceipt
 * @description
 * 
 ...
 */
export
const mailReceipt: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["mailReceipt"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "E-mail address of the service mailbox" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 16572, 2, 2, 4,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mailReceipt */
