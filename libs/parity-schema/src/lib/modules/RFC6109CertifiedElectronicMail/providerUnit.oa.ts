...
const providerUnit: ATTRIBUTE = {
    ...
    "&ldapDesc": "Name of the secondary operative environment" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 16572, 2, 2, 7,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
