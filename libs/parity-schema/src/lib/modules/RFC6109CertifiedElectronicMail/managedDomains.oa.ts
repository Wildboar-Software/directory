...
/* START_OF_SYMBOL_DEFINITION managedDomains */
/**
 * @summary managedDomains
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const managedDomains: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["managedDomains"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Domains handled by the PEC provider" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 16572, 2, 2, 5,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION managedDomains */
