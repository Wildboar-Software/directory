...
import {
    x509Certificate,
} from "@wildboar/x500/src/lib/modules/AuthenticationFramework/x509Certificate.oa";
import {
    certificateExactMatch,
} from "@wildboar/x500/src/lib/modules/CertificateExtensions/certificateExactMatch.oa";
 ...
 */
export
const providerCertificate: ATTRIBUTE<Certificate> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "X.509 certificate in ASN.1 DER binary format" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 16572, 2, 2, 2,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
