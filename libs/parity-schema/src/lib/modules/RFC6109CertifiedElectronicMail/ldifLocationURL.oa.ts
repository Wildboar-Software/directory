...
/* START_OF_SYMBOL_DEFINITION ldifLocationURL */
/**
 * @summary ldifLocationURL
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const ldifLocationURL: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["LDIFLocationURL"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "URL of the LDIF file that defines the entry" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 16572, 2, 2, 6,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ldifLocationURL */
