...
import {
    caseIgnoreIA5Match,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/caseIgnoreIA5Match.oa";
import {
    caseIgnoreIA5SubstringsMatch,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/caseIgnoreIA5SubstringsMatch.oa";
import {
    ia5String,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/ia5String.oa";

/* START_OF_SYMBOL_DEFINITION providerCertificateHash */
/**
 * @summary providerCertificateHash
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const providerCertificateHash: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["providerCertificateHash"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Hash SHA1 of X.509 certificate in hexadecimal format" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 16572, 2, 2, 1,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION providerCertificateHash */
