...
import { TimeStamp, _decode_TimeStamp, _encode_TimeStamp } from "../OtherAutomaticallyTaggedTypes/TimeStamp.ta";
export { TimeStamp, _decode_TimeStamp, _encode_TimeStamp } from "../OtherAutomaticallyTaggedTypes/TimeStamp.ta";
...
class TimeStamped {
     ...
     * @returns {TimeStamped}
     */
    public static _from_object (_o: { [_K in keyof (TimeStamped)]: (TimeStamped)[_K] }): TimeStamped {
        return new TimeStamped(_o.timeStampValue, _o.timeStampService, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_TimeStamped: $.ComponentSpec[] = [
    new $.ComponentSpec("timeStampValue", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("timeStampService", true, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_TimeStamped: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_TimeStamped: $.ComponentSpec[] = [
 ...
 */
export
function _decode_TimeStamped (el: _Element) {
    if (!_cached_decoder_for_TimeStamped) { _cached_decoder_for_TimeStamped = function (el: _Element): TimeStamped {
    ...
    const callbacks: $.DecodingMap = {
        "timeStampValue": (_el: _Element): void => { timeStampValue = _decode_TimeStamp(_el); },
        "timeStampService": (_el: _Element): void => { timeStampService = _decode_URI(_el); }
    };
 ...
 */
export
function _encode_TimeStamped (value: TimeStamped, elGetter: $.ASN1Encoder<TimeStamped>) {
    if (!_cached_encoder_for_TimeStamped) { _cached_encoder_for_TimeStamped = function (value: TimeStamped, elGetter: $.ASN1Encoder<TimeStamped>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_TimeStamp(value.timeStampValue, $.BER),
            /* IF_ABSENT  */ ((value.timeStampService === undefined) ? undefined : _encode_URI(value.timeStampService, $.BER))
        ],
