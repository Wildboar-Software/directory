...
class Tokenized {
     ...
     * @returns {Tokenized}
     */
    public static _from_object (_o: { [_K in keyof (Tokenized)]: (Tokenized)[_K] }): Tokenized {
 ...
 */
export
const _root_component_type_list_1_spec_for_Tokenized: $.ComponentSpec[] = [
    new $.ComponentSpec("name", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("parts", true, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_Tokenized: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Tokenized: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Tokenized (el: _Element) {
    if (!_cached_decoder_for_Tokenized) { _cached_decoder_for_Tokenized = function (el: _Element): Tokenized {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "parts": (_el: _Element): void => { parts = $._decodeAny(_el); }
    };
 ...
 */
export
function _encode_Tokenized (value: Tokenized, elGetter: $.ASN1Encoder<Tokenized>) {
    if (!_cached_encoder_for_Tokenized) { _cached_encoder_for_Tokenized = function (value: Tokenized, elGetter: $.ASN1Encoder<Tokenized>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.name, $.BER),
            /* IF_ABSENT  */ ((value.parts === undefined) ? undefined : $._encodeAny(value.parts, $.BER))
        ],
