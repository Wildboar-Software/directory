 ...
 */
export
type Address = UTF8String; // UTF8String
 ...
 */
export
function _decode_Address (el: _Element) {
    if (!_cached_decoder_for_Address) { _cached_decoder_for_Address = $._decodeUTF8String; }
 ...
 */
export
function _encode_Address (value: Address, elGetter: $.ASN1Encoder<Address>) {
    if (!_cached_encoder_for_Address) { _cached_encoder_for_Address = $._encodeUTF8String; }
