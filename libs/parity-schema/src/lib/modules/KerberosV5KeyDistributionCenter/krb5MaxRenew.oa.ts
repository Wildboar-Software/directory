...
/* START_OF_SYMBOL_DEFINITION krb5MaxRenew */
/**
 * @summary krb5MaxRenew
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krb5MaxRenew: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["krb5MaxRenew"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 10, 1, 4,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krb5MaxRenew */
