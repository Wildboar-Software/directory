...
/* START_OF_SYMBOL_DEFINITION krb5MaxLife */
/**
 * @summary krb5MaxLife
 * @description
 * 
 ...
 */
export
const krb5MaxLife: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["krb5MaxLife"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 10, 1, 3,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krb5MaxLife */
