...
/* START_OF_SYMBOL_DEFINITION krb5PasswordEnd */
/**
 * @summary krb5PasswordEnd
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krb5PasswordEnd: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["krb5PasswordEnd"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 10, 1, 9,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krb5PasswordEnd */
