...
/* START_OF_SYMBOL_DEFINITION krb5AccountExpirationTime */
/**
 * @summary krb5AccountExpirationTime
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krb5AccountExpirationTime: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["krb5AccountExpirationTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 10, 1, 15,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krb5AccountExpirationTime */
