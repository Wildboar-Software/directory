 ...
 */
export
const krb5Key: ATTRIBUTE<OCTET_STRING> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapSyntax": new _OID([1, 3, 6, 1, 4, 1, 1466, 115, 121, 1, 5,]) /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["krb5Key"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Encoded ASN1 Key as an octet string" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 10, 1, 10,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
