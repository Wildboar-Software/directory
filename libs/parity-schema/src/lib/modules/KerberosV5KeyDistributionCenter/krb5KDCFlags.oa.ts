...
/* START_OF_SYMBOL_DEFINITION krb5KDCFlags */
/**
 * @summary krb5KDCFlags
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krb5KDCFlags: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["krb5KDCFlags"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 5322, 10, 1, 5,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krb5KDCFlags */
