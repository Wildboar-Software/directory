...
import {
    distinguishedName,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/distinguishedName.oa";
...
const dgIdentity: ATTRIBUTE = {
    ...
    "&ldapDesc": "Identity to use when processing the memberURL" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], id_dynGroupAttr) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
