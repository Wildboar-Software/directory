...
/* START_OF_SYMBOL_DEFINITION calCalURI */
/**
 * @summary calCalURI
 * @description
 * 
 ...
 */
export
const calCalURI: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["calCalURI"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([478,], msat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION calCalURI */
