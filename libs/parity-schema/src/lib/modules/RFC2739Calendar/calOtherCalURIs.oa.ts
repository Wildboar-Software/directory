...
/* START_OF_SYMBOL_DEFINITION calOtherCalURIs */
/**
 * @summary calOtherCalURIs
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const calOtherCalURIs: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["calOtherCalURIs"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([482,], msat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION calOtherCalURIs */
