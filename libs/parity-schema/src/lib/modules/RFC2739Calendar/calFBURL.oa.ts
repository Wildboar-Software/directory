...
/* START_OF_SYMBOL_DEFINITION calFBURL */
/**
 * @summary calFBURL
 * @description
 * 
 ...
 */
export
const calFBURL: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["calFBURL"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([479,], msat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION calFBURL */
