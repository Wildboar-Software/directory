...
/* START_OF_SYMBOL_DEFINITION calOtherFBURLs */
/**
 * @summary calOtherFBURLs
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const calOtherFBURLs: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["calOtherFBURLs"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([483,], msat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION calOtherFBURLs */
