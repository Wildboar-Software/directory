...
/* START_OF_SYMBOL_DEFINITION calCAPURI */
/**
 * @summary calCAPURI
 * @description
 * 
 ...
 */
export
const calCAPURI: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["calCAPURI"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([480,], msat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION calCAPURI */
