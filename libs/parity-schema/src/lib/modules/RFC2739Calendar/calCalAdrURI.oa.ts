...
/* START_OF_SYMBOL_DEFINITION calCalAdrURI */
/**
 * @summary calCalAdrURI
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const calCalAdrURI: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["calCalAdrURI"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([481,], msat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION calCalAdrURI */
