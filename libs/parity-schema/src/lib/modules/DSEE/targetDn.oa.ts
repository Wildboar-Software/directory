...
/* START_OF_SYMBOL_DEFINITION targetDn */
/**
 * @summary targetDn
 * @description
 *
 ...
 */
export
const targetDn: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["targetDn"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6,], nsdsat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION targetDn */
