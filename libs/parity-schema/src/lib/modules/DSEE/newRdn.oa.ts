...
/* START_OF_SYMBOL_DEFINITION newRdn */
/**
 * @summary newRdn
 * @description
 *
 ...
 */
export
const newRdn: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["newRdn"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9,], nsdsat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION newRdn */
