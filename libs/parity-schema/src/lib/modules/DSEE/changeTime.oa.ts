...
/* START_OF_SYMBOL_DEFINITION changeTime */
/**
 * @summary changeTime
 * @description
 * 
 ...
 */
export
const changeTime: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["changeTime"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([77,], nsdsat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION changeTime */
