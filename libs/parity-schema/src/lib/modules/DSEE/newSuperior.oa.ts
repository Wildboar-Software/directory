...
/* START_OF_SYMBOL_DEFINITION newSuperior */
/**
 * @summary newSuperior
 * @description
 *
 ...
 */
export
const newSuperior: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["newSuperior"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([11,], nsdsat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION newSuperior */
