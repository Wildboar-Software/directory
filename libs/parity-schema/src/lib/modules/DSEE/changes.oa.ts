...
/* START_OF_SYMBOL_DEFINITION changes */
/**
 * @summary changes
 * @description
 * 
 ...
 */
export
const changes: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["changes"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8,], nsdsat) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION changes */
