...
/* START_OF_SYMBOL_DEFINITION carLicense */
/**
 * @summary carLicense
 * @description
 * 
 ...
 */
export
const carLicense: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["carLicense"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC2798: vehicle license or registration plate" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 1,], netscapeDirectory) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION carLicense */
