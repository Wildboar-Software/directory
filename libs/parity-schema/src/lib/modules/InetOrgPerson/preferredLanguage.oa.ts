...
/* START_OF_SYMBOL_DEFINITION preferredLanguage */
/**
 ...
 */
export
const preferredLanguage: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["preferredLanguage"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC2798: preferred written or spoken language for a person" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 39,], netscapeDirectory) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION preferredLanguage */
