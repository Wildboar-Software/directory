...
/* START_OF_SYMBOL_DEFINITION displayName */
/**
 * @summary displayName
 * @description
 * 
 ...
 */
export
const displayName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["displayName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC2798: preferred name to be used when displaying entries" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 241,], netscapeDirectory) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION displayName */
