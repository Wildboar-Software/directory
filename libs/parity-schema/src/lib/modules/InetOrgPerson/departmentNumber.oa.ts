...
/* START_OF_SYMBOL_DEFINITION departmentNumber */
/**
 * @summary departmentNumber
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const departmentNumber: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["departmentNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC2798: identifies a department within an organization" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 2,], netscapeDirectory) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION departmentNumber */
