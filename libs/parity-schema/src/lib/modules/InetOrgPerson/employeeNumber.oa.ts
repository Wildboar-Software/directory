...
/* START_OF_SYMBOL_DEFINITION employeeNumber */
/**
 ...
 */
export
const employeeNumber: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["employeeNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC2798: numerically identifies an employee within an organization" /* OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION employeeNumber */
