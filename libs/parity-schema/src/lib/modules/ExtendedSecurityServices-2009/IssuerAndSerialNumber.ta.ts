...
class IssuerAndSerialNumber {
     ...
     */
    public static _from_object (_o: { [_K in keyof (IssuerAndSerialNumber)]: (IssuerAndSerialNumber)[_K] }): IssuerAndSerialNumber {
 ...
 */
export
const _root_component_type_list_1_spec_for_IssuerAndSerialNumber: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_IssuerAndSerialNumber: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_IssuerAndSerialNumber: $.ComponentSpec[] = [
 ...
 */
export
function _decode_IssuerAndSerialNumber (el: _Element) {
    if (!_cached_decoder_for_IssuerAndSerialNumber) { _cached_decoder_for_IssuerAndSerialNumber = function (el: _Element): IssuerAndSerialNumber {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("IssuerAndSerialNumber contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_IssuerAndSerialNumber (value: IssuerAndSerialNumber, elGetter: $.ASN1Encoder<IssuerAndSerialNumber>) {
    if (!_cached_encoder_for_IssuerAndSerialNumber) { _cached_encoder_for_IssuerAndSerialNumber = function (value: IssuerAndSerialNumber, elGetter: $.ASN1Encoder<IssuerAndSerialNumber>): _Element {
