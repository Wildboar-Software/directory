...
class ESSCertID {
     ...
     * @returns {ESSCertID}
     */
    public static _from_object (_o: { [_K in keyof (ESSCertID)]: (ESSCertID)[_K] }): ESSCertID {
 ...
 */
export
const _root_component_type_list_1_spec_for_ESSCertID: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ESSCertID: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ESSCertID: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ESSCertID (el: _Element) {
    if (!_cached_decoder_for_ESSCertID) { _cached_decoder_for_ESSCertID = function (el: _Element): ESSCertID {
 ...
 */
export
function _encode_ESSCertID (value: ESSCertID, elGetter: $.ASN1Encoder<ESSCertID>) {
    if (!_cached_encoder_for_ESSCertID) { _cached_encoder_for_ESSCertID = function (value: ESSCertID, elGetter: $.ASN1Encoder<ESSCertID>): _Element {
