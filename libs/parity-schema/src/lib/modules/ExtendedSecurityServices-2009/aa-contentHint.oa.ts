...
import { ContentHints, _decode_ContentHints, _encode_ContentHints } from "../ExtendedSecurityServices-2009/ContentHints.ta";
export { ContentHints, _decode_ContentHints, _encode_ContentHints } from "../ExtendedSecurityServices-2009/ContentHints.ta";
import { id_aa_contentHint } from "../ExtendedSecurityServices-2009/id-aa-contentHint.va";
export { id_aa_contentHint } from "../ExtendedSecurityServices-2009/id-aa-contentHint.va";
 ...
 */
export
const aa_contentHint: ATTRIBUTE<ContentHints> = {
    class: "ATTRIBUTE",
    decoderFor: {
