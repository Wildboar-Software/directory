...
import { MsgSigDigest, _decode_MsgSigDigest, _encode_MsgSigDigest } from "../ExtendedSecurityServices-2009/MsgSigDigest.ta";
export { MsgSigDigest, _decode_MsgSigDigest, _encode_MsgSigDigest } from "../ExtendedSecurityServices-2009/MsgSigDigest.ta";
import { id_aa_msgSigDigest } from "../ExtendedSecurityServices-2009/id-aa-msgSigDigest.va";
export { id_aa_msgSigDigest } from "../ExtendedSecurityServices-2009/id-aa-msgSigDigest.va";
 ...
 */
export
const aa_msgSigDigest: ATTRIBUTE<MsgSigDigest> = {
    class: "ATTRIBUTE",
    decoderFor: {
