 ...
 */
export
type SecurityPolicyIdentifier = OBJECT_IDENTIFIER; // ObjectIdentifierType
 ...
 */
export
function _decode_SecurityPolicyIdentifier (el: _Element) {
    if (!_cached_decoder_for_SecurityPolicyIdentifier) { _cached_decoder_for_SecurityPolicyIdentifier = $._decodeObjectIdentifier; }
 ...
 */
export
function _encode_SecurityPolicyIdentifier (value: SecurityPolicyIdentifier, elGetter: $.ASN1Encoder<SecurityPolicyIdentifier>) {
    if (!_cached_encoder_for_SecurityPolicyIdentifier) { _cached_encoder_for_SecurityPolicyIdentifier = $._encodeObjectIdentifier; }
