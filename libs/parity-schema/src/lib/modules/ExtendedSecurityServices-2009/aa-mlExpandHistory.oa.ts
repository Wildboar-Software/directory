...
import { MLExpansionHistory, _decode_MLExpansionHistory, _encode_MLExpansionHistory } from "../ExtendedSecurityServices-2009/MLExpansionHistory.ta";
export { MLExpansionHistory, _decode_MLExpansionHistory, _encode_MLExpansionHistory } from "../ExtendedSecurityServices-2009/MLExpansionHistory.ta";
import { id_aa_mlExpandHistory } from "../ExtendedSecurityServices-2009/id-aa-mlExpandHistory.va";
export { id_aa_mlExpandHistory } from "../ExtendedSecurityServices-2009/id-aa-mlExpandHistory.va";
 ...
 */
export
const aa_mlExpandHistory: ATTRIBUTE<MLExpansionHistory> = {
    class: "ATTRIBUTE",
    decoderFor: {
