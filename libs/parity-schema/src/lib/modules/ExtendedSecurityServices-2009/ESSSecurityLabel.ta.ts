...
} from '../ExtendedSecurityServices-2009/ESSPrivacyMark.ta';
import {
    SecurityCategories,
    _decode_SecurityCategories,
    _encode_SecurityCategories,
} from '../ExtendedSecurityServices-2009/SecurityCategories.ta';
import {
    SecurityClassification,
    _decode_SecurityClassification,
    _encode_SecurityClassification,
} from '../ExtendedSecurityServices-2009/SecurityClassification.ta';
import {
    SecurityPolicyIdentifier,
    _decode_SecurityPolicyIdentifier,
    _encode_SecurityPolicyIdentifier,
} from '../ExtendedSecurityServices-2009/SecurityPolicyIdentifier.ta';
...
export class ESSSecurityLabel {
    ...
    public static _from_object(_o: {
        [_K in keyof ESSSecurityLabel]: ESSSecurityLabel[_K];
    }): ESSSecurityLabel {
...
let _cached_decoder_for_ESSSecurityLabel: $.ASN1Decoder<ESSSecurityLabel> | null =
    null;
            ...
            const callbacks: $.DecodingMap = {
                ...
                'security-classification': (_el: _Element): void => {
                    security_classification =
                        _decode_SecurityClassification(_el);
                },
...
let _cached_encoder_for_ESSSecurityLabel: $.ASN1Encoder<ESSSecurityLabel> | null =
    null;
