...
import { ReceiptRequest, _decode_ReceiptRequest, _encode_ReceiptRequest } from "../ExtendedSecurityServices-2009/ReceiptRequest.ta";
export { ReceiptRequest, _decode_ReceiptRequest, _encode_ReceiptRequest } from "../ExtendedSecurityServices-2009/ReceiptRequest.ta";
import { id_aa_receiptRequest } from "../ExtendedSecurityServices-2009/id-aa-receiptRequest.va";
export { id_aa_receiptRequest } from "../ExtendedSecurityServices-2009/id-aa-receiptRequest.va";
 ...
 */
export
const aa_receiptRequest: ATTRIBUTE<ReceiptRequest> = {
    class: "ATTRIBUTE",
    decoderFor: {
