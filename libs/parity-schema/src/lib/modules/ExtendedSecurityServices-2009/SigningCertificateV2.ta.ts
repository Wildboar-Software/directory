...
import { ESSCertIDv2, _decode_ESSCertIDv2, _encode_ESSCertIDv2 } from "../ExtendedSecurityServices-2009/ESSCertIDv2.ta";
export { ESSCertIDv2, _decode_ESSCertIDv2, _encode_ESSCertIDv2 } from "../ExtendedSecurityServices-2009/ESSCertIDv2.ta";
import { PolicyInformation, _decode_PolicyInformation, _encode_PolicyInformation } from "@wildboar/x500/src/lib/modules/CertificateExtensions/PolicyInformation.ta";
export { PolicyInformation, _decode_PolicyInformation, _encode_PolicyInformation } from "@wildboar/x500/src/lib/modules/CertificateExtensions/PolicyInformation.ta";
...
class SigningCertificateV2 {
     ...
     */
    public static _from_object (_o: { [_K in keyof (SigningCertificateV2)]: (SigningCertificateV2)[_K] }): SigningCertificateV2 {
 ...
 */
export
const _root_component_type_list_1_spec_for_SigningCertificateV2: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_SigningCertificateV2: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SigningCertificateV2: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SigningCertificateV2 (el: _Element) {
    if (!_cached_decoder_for_SigningCertificateV2) { _cached_decoder_for_SigningCertificateV2 = function (el: _Element): SigningCertificateV2 {
    ...
    const callbacks: $.DecodingMap = {
        "certs": (_el: _Element): void => { certs = $._decodeSequenceOf<ESSCertIDv2>(() => _decode_ESSCertIDv2)(_el); },
 ...
 */
export
function _encode_SigningCertificateV2 (value: SigningCertificateV2, elGetter: $.ASN1Encoder<SigningCertificateV2>) {
    if (!_cached_encoder_for_SigningCertificateV2) { _cached_encoder_for_SigningCertificateV2 = function (value: SigningCertificateV2, elGetter: $.ASN1Encoder<SigningCertificateV2>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeSequenceOf<ESSCertIDv2>(() => _encode_ESSCertIDv2, $.BER)(value.certs, $.BER),
