...
import { ContentReference, _decode_ContentReference, _encode_ContentReference } from "../ExtendedSecurityServices-2009/ContentReference.ta";
export { ContentReference, _decode_ContentReference, _encode_ContentReference } from "../ExtendedSecurityServices-2009/ContentReference.ta";
 ...
 */
export
const aa_contentReference: ATTRIBUTE<ContentReference> = {
    class: "ATTRIBUTE",
    decoderFor: {
