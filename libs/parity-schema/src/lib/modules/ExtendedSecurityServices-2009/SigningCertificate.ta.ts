...
import { ESSCertID, _decode_ESSCertID, _encode_ESSCertID } from "../ExtendedSecurityServices-2009/ESSCertID.ta";
export { ESSCertID, _decode_ESSCertID, _encode_ESSCertID } from "../ExtendedSecurityServices-2009/ESSCertID.ta";
...
class SigningCertificate {
     ...
     */
    public static _from_object (_o: { [_K in keyof (SigningCertificate)]: (SigningCertificate)[_K] }): SigningCertificate {
 ...
 */
export
const _root_component_type_list_1_spec_for_SigningCertificate: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_SigningCertificate: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SigningCertificate: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SigningCertificate (el: _Element) {
    if (!_cached_decoder_for_SigningCertificate) { _cached_decoder_for_SigningCertificate = function (el: _Element): SigningCertificate {
    ...
    const callbacks: $.DecodingMap = {
        "certs": (_el: _Element): void => { certs = $._decodeSequenceOf<ESSCertID>(() => _decode_ESSCertID)(_el); },
 ...
 */
export
function _encode_SigningCertificate (value: SigningCertificate, elGetter: $.ASN1Encoder<SigningCertificate>) {
    if (!_cached_encoder_for_SigningCertificate) { _cached_encoder_for_SigningCertificate = function (value: SigningCertificate, elGetter: $.ASN1Encoder<SigningCertificate>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeSequenceOf<ESSCertID>(() => _encode_ESSCertID, $.BER)(value.certs, $.BER),
