...
import { HashAlgorithm, _decode_HashAlgorithm, _encode_HashAlgorithm } from "../ExtendedSecurityServices-2009/HashAlgorithm.ta";
export { HashAlgorithm, _decode_HashAlgorithm, _encode_HashAlgorithm } from "../ExtendedSecurityServices-2009/HashAlgorithm.ta";
import { id_sha256 } from "@wildboar/x500/src/lib/modules/AlgorithmObjectIdentifiers/id-sha256.va";
export { id_sha256 } from "@wildboar/x500/src/lib/modules/AlgorithmObjectIdentifiers/id-sha256.va";
import { Hash, _decode_Hash, _encode_Hash } from "../ExtendedSecurityServices-2009/Hash.ta";
export { Hash, _decode_Hash, _encode_Hash } from "../ExtendedSecurityServices-2009/Hash.ta";
import { IssuerSerial, _decode_IssuerSerial, _encode_IssuerSerial } from "../ExtendedSecurityServices-2009/IssuerSerial.ta";
export { IssuerSerial, _decode_IssuerSerial, _encode_IssuerSerial } from "../ExtendedSecurityServices-2009/IssuerSerial.ta";
...
function _decode_ESSCertIDv2 (el: _Element) {
    ...
    let hashAlgorithm: OPTIONAL<HashAlgorithm> = ESSCertIDv2._default_value_for_hashAlgorithm;
    let certHash!: Hash;
    let issuerSerial: OPTIONAL<IssuerSerial>;
    /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    /* START_OF_CALLBACKS_MAP */
    const callbacks: $.DecodingMap = {
        "hashAlgorithm": (_el: _Element): void => { hashAlgorithm = _decode_HashAlgorithm(_el); },
...
function _encode_ESSCertIDv2 (value: ESSCertIDv2, elGetter: $.ASN1Encoder<ESSCertIDv2>) {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_DEFAULT */ (value.hashAlgorithm === undefined || $.deepEq(value.hashAlgorithm, ESSCertIDv2._default_value_for_hashAlgorithm) ? undefined : _encode_HashAlgorithm(value.hashAlgorithm, $.BER)),
