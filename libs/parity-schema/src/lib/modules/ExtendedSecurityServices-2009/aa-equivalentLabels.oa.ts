...
import { EquivalentLabels, _decode_EquivalentLabels, _encode_EquivalentLabels } from "../ExtendedSecurityServices-2009/EquivalentLabels.ta";
export { EquivalentLabels, _decode_EquivalentLabels, _encode_EquivalentLabels } from "../ExtendedSecurityServices-2009/EquivalentLabels.ta";
import { id_aa_equivalentLabels } from "../ExtendedSecurityServices-2009/id-aa-equivalentLabels.va";
export { id_aa_equivalentLabels } from "../ExtendedSecurityServices-2009/id-aa-equivalentLabels.va";
 ...
 */
export
const aa_equivalentLabels: ATTRIBUTE<EquivalentLabels> = {
    class: "ATTRIBUTE",
    decoderFor: {
