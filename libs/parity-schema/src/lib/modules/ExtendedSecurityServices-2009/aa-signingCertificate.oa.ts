...
import { SigningCertificate, _decode_SigningCertificate, _encode_SigningCertificate } from "../ExtendedSecurityServices-2009/SigningCertificate.ta";
export { SigningCertificate, _decode_SigningCertificate, _encode_SigningCertificate } from "../ExtendedSecurityServices-2009/SigningCertificate.ta";
 ...
 */
export
const aa_signingCertificate: ATTRIBUTE<SigningCertificate> = {
    class: "ATTRIBUTE",
    decoderFor: {
