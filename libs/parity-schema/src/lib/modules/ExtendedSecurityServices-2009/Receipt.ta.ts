...
import { ESSVersion, ESSVersion_v1 /* IMPORTED_LONG_NAMED_INTEGER */, v1 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_ESSVersion, _encode_ESSVersion } from "../ExtendedSecurityServices-2009/ESSVersion.ta";
export { ESSVersion, ESSVersion_v1 /* IMPORTED_LONG_NAMED_INTEGER */, v1 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_ESSVersion, _encode_ESSVersion } from "../ExtendedSecurityServices-2009/ESSVersion.ta";
...
class Receipt {
     ...
     * @returns {Receipt}
     */
    public static _from_object (_o: { [_K in keyof (Receipt)]: (Receipt)[_K] }): Receipt {
 ...
 */
export
const _root_component_type_list_1_spec_for_Receipt: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_Receipt: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Receipt: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Receipt (el: _Element) {
    if (!_cached_decoder_for_Receipt) { _cached_decoder_for_Receipt = function (el: _Element): Receipt {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new _ConstructionError("Receipt contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_Receipt (value: Receipt, elGetter: $.ASN1Encoder<Receipt>) {
    if (!_cached_encoder_for_Receipt) { _cached_encoder_for_Receipt = function (value: Receipt, elGetter: $.ASN1Encoder<Receipt>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ESSVersion(value.version, $.BER),
