 ...
 */
export
type ContentIdentifier = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_ContentIdentifier (el: _Element) {
    if (!_cached_decoder_for_ContentIdentifier) { _cached_decoder_for_ContentIdentifier = $._decodeOctetString; }
 ...
 */
export
function _encode_ContentIdentifier (value: ContentIdentifier, elGetter: $.ASN1Encoder<ContentIdentifier>) {
    if (!_cached_encoder_for_ContentIdentifier) { _cached_encoder_for_ContentIdentifier = $._encodeOctetString; }
