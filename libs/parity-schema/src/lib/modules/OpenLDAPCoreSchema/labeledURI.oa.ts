...
/* START_OF_SYMBOL_DEFINITION labeledURI */
/**
 * @summary labeledURI
 * @description
 * 
 ...
 */
export
const labeledURI: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["labeledURI"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "RFC2079: Uniform Resource Identifier with optional label." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 250, 1, 57,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION labeledURI */
