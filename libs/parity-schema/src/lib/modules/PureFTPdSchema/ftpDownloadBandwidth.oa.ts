...
export { id_at } from "../PureFTPdSchema/id-at.va";


/* START_OF_SYMBOL_DEFINITION ftpDownloadBandwidth */
/**
 * @summary ftpDownloadBandwidth
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ftpDownloadBandwidth: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ftpDownloadBandwidth"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Bandwidth (in KB/s) to limit download speeds to" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ftpDownloadBandwidth */
