...
/* START_OF_SYMBOL_DEFINITION ftpDownloadRatio */
/**
 * @summary ftpDownloadRatio
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ftpDownloadRatio: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ftpDownloadRatio"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Ratio (compared with FTPRatioUp) for downloaded files" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ftpDownloadRatio */
