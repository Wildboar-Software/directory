...
/* START_OF_SYMBOL_DEFINITION ftpUploadBandwidth */
/**
 * @summary ftpUploadBandwidth
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const ftpUploadBandwidth: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['ftpUploadBandwidth'] /* OBJECT_FIELD_SETTING */,
    '&ldapDesc':
        'Bandwidth (in KB/s) to limit upload speeds to' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts(
        [5],
        id_at
...
/* END_OF_SYMBOL_DEFINITION ftpUploadBandwidth */
