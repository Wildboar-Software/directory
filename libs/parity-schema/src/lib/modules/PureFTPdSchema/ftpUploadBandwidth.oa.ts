 ...
 */
export
const ftpUploadBandwidth: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapDesc": "Bandwidth (in KB/s) to limit upload speeds to" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([5,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
