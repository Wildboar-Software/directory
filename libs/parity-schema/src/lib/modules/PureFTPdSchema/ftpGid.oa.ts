...
/* START_OF_SYMBOL_DEFINITION ftpGid */
/**
 * @summary ftpGid
 * @description
 * 
 ...
 */
export
const ftpGid: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ftpGid"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "System uid (overrides gidNumber if present)" /* OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ftpGid */
