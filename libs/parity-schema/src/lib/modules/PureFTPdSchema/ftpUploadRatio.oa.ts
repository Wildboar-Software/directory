...
/* START_OF_SYMBOL_DEFINITION ftpUploadRatio */
/**
 * @summary ftpUploadRatio
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ftpUploadRatio: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ftpUploadRatio"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Ratio (compared with FTPRatioDown) for uploaded files" /* OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ftpUploadRatio */
