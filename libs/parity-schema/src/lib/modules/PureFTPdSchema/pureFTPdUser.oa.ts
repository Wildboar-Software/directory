 ...
 */
export
const pureFTPdUser: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ ftpStatus, ftpQuotaFiles, ftpQuotaMBytes, ftpUploadRatio, ftpDownloadRatio, ftpUploadBandwidth, ftpDownloadBandwidth, ftpUid, ftpGid, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["pureFTPdUser"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "PureFTPd user with optional quota, throttling and ratio" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 3, 6, 1, 4, 1, 6981, 11, 2, 3,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
