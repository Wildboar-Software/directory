...
/* START_OF_SYMBOL_DEFINITION ftpStatus */
/**
 * @summary ftpStatus
 * @description
 * 
 ...
 */
export
const ftpStatus: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapName": ["ftpStatus"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Account status: enabled or disabled" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([7,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ftpStatus */
