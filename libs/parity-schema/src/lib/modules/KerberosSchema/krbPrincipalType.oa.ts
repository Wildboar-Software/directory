 ...
 */
export
const krbPrincipalType: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapDesc": "This specifies the type of the principal, the types could be any of the types mentioned in section 6.2 of RFC 4120" /* OBJECT_FIELD_SETTING */,
