...
/* START_OF_SYMBOL_DEFINITION krbMaxTicketLife */
/**
 * @summary krbMaxTicketLife
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krbMaxTicketLife: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["krbMaxTicketLife"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The maximum ticket lifetime for a principal in seconds" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krbMaxTicketLife */
