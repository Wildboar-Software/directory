 ...
 */
export
const krbHostServer: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "This attribute holds the Host Name or the ip address, transport protocol and ports of the kerberos service host. The format is host_name-or-ip_address#protocol#port. Protocol can be 0 or 1. 0 is for UDP. 1 is for TCP." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([24, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
