 ...
 */
export
type PrincipalNamingAttrSyntax = UTF8String; // UTF8String
...
let _cached_decoder_for_PrincipalNamingAttrSyntax: $.ASN1Decoder<PrincipalNamingAttrSyntax> | null = null;
 ...
 */
export
function _decode_PrincipalNamingAttrSyntax (el: _Element) {
    if (!_cached_decoder_for_PrincipalNamingAttrSyntax) { _cached_decoder_for_PrincipalNamingAttrSyntax = $._decodeUTF8String; }
...
let _cached_encoder_for_PrincipalNamingAttrSyntax: $.ASN1Encoder<PrincipalNamingAttrSyntax> | null = null;
 ...
 */
export
function _encode_PrincipalNamingAttrSyntax (value: PrincipalNamingAttrSyntax, elGetter: $.ASN1Encoder<PrincipalNamingAttrSyntax>) {
    if (!_cached_encoder_for_PrincipalNamingAttrSyntax) { _cached_encoder_for_PrincipalNamingAttrSyntax = $._encodeUTF8String; }
