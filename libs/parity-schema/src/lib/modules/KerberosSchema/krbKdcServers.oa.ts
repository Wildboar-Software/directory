 ...
 */
export
const krbKdcServers: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "A set of forward references to the KDC Service objects. FDNs of the krbKdcService objects." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([17, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
