...
/* START_OF_SYMBOL_DEFINITION krbPrincipalExpiration */
/**
 * @summary krbPrincipalExpiration
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krbPrincipalExpiration: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["krbPrincipalExpiration"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The time at which the principal expires" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krbPrincipalExpiration */
