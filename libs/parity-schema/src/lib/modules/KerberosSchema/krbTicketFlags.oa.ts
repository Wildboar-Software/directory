 ...
 */
export
const krbTicketFlags: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapDesc": "holds information about the kerberos flags, per RFC 4120, for a principal" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
