 ...
 */
export
const krbRealmReferences: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Forward reference to the Realm object. FDN of the krbRealmContainer object." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([14, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
