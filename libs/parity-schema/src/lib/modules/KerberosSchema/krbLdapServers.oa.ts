 ...
 */
export const krbLdapServers: ATTRIBUTE<UnboundedDirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'List of LDAP servers that kerberos servers can contact, in URI format.' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts(
        [15, 1],
        id_at
