...
/* START_OF_SYMBOL_DEFINITION krbLdapServers */
/**
 * @summary krbLdapServers
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krbLdapServers: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["krbLdapServers"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "List of LDAP servers that kerberos servers can contact, in URI format." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([15, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krbLdapServers */
