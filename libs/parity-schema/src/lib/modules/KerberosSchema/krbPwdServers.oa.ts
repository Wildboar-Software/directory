 ...
 */
export const krbPwdServers: ATTRIBUTE<DistinguishedName> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&ldapDesc':
        'A set of forward references to the Password Service objects. FDNs of the krbPwdService objects.' /* OBJECT_FIELD_SETTING */,
    '&id': _OID.fromParts(
        [18, 1],
        id_at
