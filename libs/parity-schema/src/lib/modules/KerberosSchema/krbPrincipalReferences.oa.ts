...
/* START_OF_SYMBOL_DEFINITION krbPrincipalReferences */
/**
 * @summary krbPrincipalReferences
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krbPrincipalReferences: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["krbPrincipalReferences"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "FDNs pointing to Kerberos principals." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([26, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krbPrincipalReferences */
