 ...
 */
export
const krbPrincipalName: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "This is the principal name in the RFC 1964 specified format" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
