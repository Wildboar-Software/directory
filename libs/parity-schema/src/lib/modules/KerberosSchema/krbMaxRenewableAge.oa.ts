...
/* START_OF_SYMBOL_DEFINITION krbMaxRenewableAge */
/**
 * @summary krbMaxRenewableAge
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const krbMaxRenewableAge: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["krbMaxRenewableAge"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Maximum renewable lifetime for a principal's ticket in seconds" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION krbMaxRenewableAge */
