 ...
 */
export
const krbUPEnabled: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "TRUE, if User Password is to be used as the kerberos password; FALSE, if User Password and the kerberos password are different." /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([3, 1,], id_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
