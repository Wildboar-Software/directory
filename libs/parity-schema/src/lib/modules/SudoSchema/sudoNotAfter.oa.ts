...
/* START_OF_SYMBOL_DEFINITION sudoNotAfter */
/**
 * @summary sudoNotAfter
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const sudoNotAfter: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoNotAfter"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "End of time interval for which the entry is valid" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 9,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoNotAfter */
