...
/* START_OF_SYMBOL_DEFINITION sudoHost */
/**
 * @summary sudoHost
 * @description
 * 
 ...
 */
export
const sudoHost: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoHost"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Host(s) who may run sudo" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 2,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoHost */
