 ...
 */
export
const sudoNotBefore: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "Start of time interval for which the entry is valid" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 8,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
