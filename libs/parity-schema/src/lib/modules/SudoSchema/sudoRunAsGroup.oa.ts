...
/* START_OF_SYMBOL_DEFINITION sudoRunAsGroup */
/**
 * @summary sudoRunAsGroup
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const sudoRunAsGroup: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoRunAsGroup"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Group(s) impersonated by sudo" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 7,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoRunAsGroup */
