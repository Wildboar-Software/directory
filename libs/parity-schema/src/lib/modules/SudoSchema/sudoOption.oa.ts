...
/* START_OF_SYMBOL_DEFINITION sudoOption */
/**
 * @summary sudoOption
 * @description
 * 
 ...
 */
export
const sudoOption: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoOption"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Options(s) followed by sudo" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 5,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoOption */
