...
/* START_OF_SYMBOL_DEFINITION sudoCommand */
/**
 * @summary sudoCommand
 * @description
 * 
 ...
 */
export
const sudoCommand: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoCommand"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Command(s) to be executed by sudo" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 3,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoCommand */
