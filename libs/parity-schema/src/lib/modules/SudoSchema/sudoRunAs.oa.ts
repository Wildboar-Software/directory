...
/* START_OF_SYMBOL_DEFINITION sudoRunAs */
/**
 * @summary sudoRunAs
 * @description
 * 
 ...
 */
export
const sudoRunAs: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoRunAs"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "User(s) impersonated by sudo" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 4,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoRunAs */
