...
/* START_OF_SYMBOL_DEFINITION sudoOrder */
/**
 * @summary sudoOrder
 * @description
 * 
 ...
 */
export
const sudoOrder: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["sudoOrder"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "an integer to order the sudoRole entries" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 10,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoOrder */
