...
/* START_OF_SYMBOL_DEFINITION sudoUser */
/**
 * @summary sudoUser
 * @description
 * 
 ...
 */
export
const sudoUser: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["sudoUser"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "User(s) who may run sudo" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9, 1, 1,], id_aaron_spangler) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION sudoUser */
