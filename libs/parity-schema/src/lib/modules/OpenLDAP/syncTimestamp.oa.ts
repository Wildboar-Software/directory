...
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/generalizedTimeMatch.oa";
import {
    generalizedTimeOrderingMatch,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/generalizedTimeOrderingMatch.oa";
import {
    generalizedTime,
} from "@wildboar/x500/src/lib/modules/SelectedAttributeTypes/generalizedTime.oa";
 ...
 */
export
const syncTimestamp: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([1, 3, 6, 1, 4, 1, 4203, 666, 1, 26,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
