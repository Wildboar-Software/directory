...
import {
    BdcPKCInformation,
    _decode_BdcPKCInformation,
    _encode_BdcPKCInformation,
} from '../TAI/BdcPKCInformation.ta';
import {
    BPUReportInformation,
    _decode_BPUReportInformation,
    _encode_BPUReportInformation,
} from '../TAI/BPUReportInformation.ta';
 ...
 * @class
 */
export class BDCReportContentInformation {
    constructor(
        /**
    ...
    public static _from_object(_o: {
        [_K in keyof BDCReportContentInformation]: BDCReportContentInformation[_K];
    }): BDCReportContentInformation {
        return new BDCReportContentInformation(
            _o.bdcPKCInformation,
            _o.bdcReportInformation
        );
    }
}
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_BDCReportContentInformation: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'bdcPKCInformation',
            false,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_BDCReportContentInformation: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_BDCReportContentInformation: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_BDCReportContentInformation: $.ASN1Decoder<BDCReportContentInformation> | null =
    null;
 ...
 */
export function _decode_BDCReportContentInformation(el: _Element) {
    if (!_cached_decoder_for_BDCReportContentInformation) {
        _cached_decoder_for_BDCReportContentInformation = function (
            el: _Element
        ): BDCReportContentInformation {
            const sequence: _Element[] = el.sequence;
            if (sequence.length < 2) {
                throw new _ConstructionError(
                    'BDCReportContentInformation contained only ' +
...
let _cached_encoder_for_BDCReportContentInformation: $.ASN1Encoder<BDCReportContentInformation> | null =
    null;
 ...
 */
export function _encode_BDCReportContentInformation(
    value: BDCReportContentInformation,
    elGetter: $.ASN1Encoder<BDCReportContentInformation>
) {
    if (!_cached_encoder_for_BDCReportContentInformation) {
        _cached_encoder_for_BDCReportContentInformation = function (
            value: BDCReportContentInformation,
            elGetter: $.ASN1Encoder<BDCReportContentInformation>
        ): _Element {
            return $._encodeSequence(
                ([] as (_Element | undefined)[])
                    .concat([
                        /* REQUIRED   */ _encode_BdcPKCInformation(
                            value.bdcPKCInformation,
                            $.BER
                        ),
                        /* REQUIRED   */ _encode_BPUReportInformation(
                            value.bdcReportInformation,
                            $.BER
                        ),
                    ])
