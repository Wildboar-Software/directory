...
function _encode_BiometricPara_Item (value: BiometricPara_Item, elGetter: $.ASN1Encoder<BiometricPara_Item>) {
    if (!_cached_encoder_for_BiometricPara_Item) { _cached_encoder_for_BiometricPara_Item = function (value: BiometricPara_Item, elGetter: $.ASN1Encoder<BiometricPara_Item>): _Element {
