...
import { PublicKeyCert, _decode_PublicKeyCert, _encode_PublicKeyCert } from "../TAI/PublicKeyCert.ta";
export { PublicKeyCert, _decode_PublicKeyCert, _encode_PublicKeyCert } from "../TAI/PublicKeyCert.ta";
