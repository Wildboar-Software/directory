...
import { BiometricSecurityLevelId, _decode_BiometricSecurityLevelId, _encode_BiometricSecurityLevelId } from "../TAI/BiometricSecurityLevelId.ta";
export { BiometricSecurityLevelId, _decode_BiometricSecurityLevelId, _encode_BiometricSecurityLevelId } from "../TAI/BiometricSecurityLevelId.ta";
import { ModalityPolicy, _decode_ModalityPolicy, _encode_ModalityPolicy } from "../TAI/ModalityPolicy.ta";
export { ModalityPolicy, _decode_ModalityPolicy, _encode_ModalityPolicy } from "../TAI/ModalityPolicy.ta";
import { BiometricPara, _decode_BiometricPara, _encode_BiometricPara } from "../TAI/BiometricPara.ta";
export { BiometricPara, _decode_BiometricPara, _encode_BiometricPara } from "../TAI/BiometricPara.ta";
...
function _encode_SecurityLevelBioRef (value: SecurityLevelBioRef, elGetter: $.ASN1Encoder<SecurityLevelBioRef>) {
    if (!_cached_encoder_for_SecurityLevelBioRef) { _cached_encoder_for_SecurityLevelBioRef = function (value: SecurityLevelBioRef, elGetter: $.ASN1Encoder<SecurityLevelBioRef>): _Element {
