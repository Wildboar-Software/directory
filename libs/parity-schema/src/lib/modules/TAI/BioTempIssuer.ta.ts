...
export class BioTempIssuer {
    ...
    public static _from_object(_o: {
        [_K in keyof BioTempIssuer]: BioTempIssuer[_K];
    }): BioTempIssuer {
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_BioTempIssuer: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'issuerName',
            true,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_BioTempIssuer: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_BioTempIssuer: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_BioTempIssuer: $.ASN1Decoder<BioTempIssuer> | null =
    null;
 ...
 */
export function _decode_BioTempIssuer(el: _Element) {
    if (!_cached_decoder_for_BioTempIssuer) {
        _cached_decoder_for_BioTempIssuer = $._decode_implicit<BioTempIssuer>(
            () =>
                function (el: _Element): BioTempIssuer {
...
let _cached_encoder_for_BioTempIssuer: $.ASN1Encoder<BioTempIssuer> | null =
    null;
 ...
 */
export function _encode_BioTempIssuer(
    value: BioTempIssuer,
    elGetter: $.ASN1Encoder<BioTempIssuer>
) {
    if (!_cached_encoder_for_BioTempIssuer) {
        _cached_encoder_for_BioTempIssuer = $._encode_implicit(
            _TagClass.context,
            0,
            () =>
                function (
