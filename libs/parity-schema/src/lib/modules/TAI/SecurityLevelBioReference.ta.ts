...
import { SecurityLevelBioRef, _decode_SecurityLevelBioRef, _encode_SecurityLevelBioRef } from "../TAI/SecurityLevelBioRef.ta";
export { SecurityLevelBioRef, _decode_SecurityLevelBioRef, _encode_SecurityLevelBioRef } from "../TAI/SecurityLevelBioRef.ta";
...
const _root_component_type_list_1_spec_for_SecurityLevelBioReference: $.ComponentSpec[] = [
    new $.ComponentSpec("securityLevelNum", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("securityLevelBioRef", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
...
function _encode_SecurityLevelBioReference (value: SecurityLevelBioReference, elGetter: $.ASN1Encoder<SecurityLevelBioReference>) {
    if (!_cached_encoder_for_SecurityLevelBioReference) { _cached_encoder_for_SecurityLevelBioReference = function (value: SecurityLevelBioReference, elGetter: $.ASN1Encoder<SecurityLevelBioReference>): _Element {
