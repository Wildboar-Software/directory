...
import { SecurityLevelBioReference, _decode_SecurityLevelBioReference, _encode_SecurityLevelBioReference } from "../TAI/SecurityLevelBioReference.ta";
export { SecurityLevelBioReference, _decode_SecurityLevelBioReference, _encode_SecurityLevelBioReference } from "../TAI/SecurityLevelBioReference.ta";
 ...
 */
export
const bioSecLevelReference: ATTRIBUTE<SecurityLevelBioReference> = {
    class: "ATTRIBUTE",
    decoderFor: {
