 ...
 * @class
 */
export class DkgExtensionDataSyntax {
    constructor(
        /**
    ...
    public static _from_object(_o: {
        [_K in keyof DkgExtensionDataSyntax]: DkgExtensionDataSyntax[_K];
    }): DkgExtensionDataSyntax {
        return new DkgExtensionDataSyntax(
            _o.alignmentHelpData,
            _o.biometricKeyBindingData
        );
    }
}
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_DkgExtensionDataSyntax: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'alignmentHelpData',
            false,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_DkgExtensionDataSyntax: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_DkgExtensionDataSyntax: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_DkgExtensionDataSyntax: $.ASN1Decoder<DkgExtensionDataSyntax> | null =
    null;
 ...
 */
export function _decode_DkgExtensionDataSyntax(el: _Element) {
    if (!_cached_decoder_for_DkgExtensionDataSyntax) {
        _cached_decoder_for_DkgExtensionDataSyntax = function (
            el: _Element
        ): DkgExtensionDataSyntax {
            const sequence: _Element[] = el.sequence;
            if (sequence.length < 2) {
                throw new _ConstructionError(
                    'DkgExtensionDataSyntax contained only ' +
...
let _cached_encoder_for_DkgExtensionDataSyntax: $.ASN1Encoder<DkgExtensionDataSyntax> | null =
    null;
 ...
 */
export function _encode_DkgExtensionDataSyntax(
    value: DkgExtensionDataSyntax,
    elGetter: $.ASN1Encoder<DkgExtensionDataSyntax>
) {
    if (!_cached_encoder_for_DkgExtensionDataSyntax) {
        _cached_encoder_for_DkgExtensionDataSyntax = function (
            value: DkgExtensionDataSyntax,
            elGetter: $.ASN1Encoder<DkgExtensionDataSyntax>
        ): _Element {
                ...
                ([] as (_Element | undefined)[])
                    .concat([
                        /* REQUIRED   */ $._encodeOctetString(
                            value.alignmentHelpData,
                            $.BER
                        ),
                        /* REQUIRED   */ $._encodeOctetString(
                            value.biometricKeyBindingData,
                            $.BER
                        ),
                    ])
