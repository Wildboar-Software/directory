...
const oncRpc: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ commonName, oncRpcNumber, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([5,], id_nis_oc) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
