...
/* START_OF_SYMBOL_DEFINITION oncRpcNumber */
/**
 * @summary oncRpcNumber
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const oncRpcNumber: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["oncRpcNumber"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([18,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION oncRpcNumber */
