...
/* START_OF_SYMBOL_DEFINITION ipServiceProtocol */
/**
 * @summary ipServiceProtocol
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ipServiceProtocol: ATTRIBUTE = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": undefined,
    },
    ...
    "&ldapName": ["ipServiceProtocol"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([16,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ipServiceProtocol */
