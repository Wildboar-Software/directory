...
/* START_OF_SYMBOL_DEFINITION uidNumber */
/**
 * @summary uidNumber
 * @description
 * 
 ...
 */
export
const uidNumber: ATTRIBUTE<Uint32> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint32,
    },
    ...
    "&ldapName": ["uidNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "An integer uniquely identifying a user in an administrative domain" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([0,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uidNumber */
