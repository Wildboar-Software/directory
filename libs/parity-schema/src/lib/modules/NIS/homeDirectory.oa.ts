 ...
 */
export
const homeDirectory: ATTRIBUTE<AbsoluteFilePath> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "The absolute path to the home directory" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([3,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
