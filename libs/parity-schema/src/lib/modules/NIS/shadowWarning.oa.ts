...
/* START_OF_SYMBOL_DEFINITION shadowWarning */
/**
 * @summary shadowWarning
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const shadowWarning: ATTRIBUTE<Uint32> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint32,
    },
    ...
    "&ldapName": ["shadowWarning"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([8,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION shadowWarning */
