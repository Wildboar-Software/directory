...
/* START_OF_SYMBOL_DEFINITION ipHostNumber */
/**
 * @summary ipHostNumber
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ipHostNumber: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["ipHostNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "IP address" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([19,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ipHostNumber */
