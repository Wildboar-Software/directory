...
/* START_OF_SYMBOL_DEFINITION memberNisNetgroup */
/**
 * @summary memberNisNetgroup
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const memberNisNetgroup: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["memberNisNetgroup"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([13,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION memberNisNetgroup */
