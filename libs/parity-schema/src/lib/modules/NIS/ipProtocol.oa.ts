...
const ipProtocol: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ commonName, ipProtocolNumber, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([4,], id_nis_oc) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
