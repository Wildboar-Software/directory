...
/* START_OF_SYMBOL_DEFINITION nisMapName */
/**
 * @summary nisMapName
 * @description
 * 
...
const nisMapName: ATTRIBUTE = {
    ...
    "&ldapName": ["nisMapName"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([26,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION nisMapName */
