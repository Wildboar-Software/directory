...
/* START_OF_SYMBOL_DEFINITION ipServicePort */
/**
 * @summary ipServicePort
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const ipServicePort: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["ipServicePort"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([15,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION ipServicePort */
