...
/* START_OF_SYMBOL_DEFINITION shadowMax */
/**
 * @summary shadowMax
 * @description
 * 
 ...
 */
export
const shadowMax: ATTRIBUTE<Uint32> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint32,
    },
    ...
    "&ldapName": ["shadowMax"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([7,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION shadowMax */
