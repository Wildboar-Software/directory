...
/* START_OF_SYMBOL_DEFINITION bootFile */
/**
 * @summary bootFile
 * @description
 * 
 ...
 */
export
const bootFile: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["bootFile"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "Boot image name" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([24,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION bootFile */
