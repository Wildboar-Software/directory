...
const nisObject: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ commonName, nisMapEntry, nisMapName, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([10,], id_nis_oc) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
