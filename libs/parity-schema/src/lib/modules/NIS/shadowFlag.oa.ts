...
/* START_OF_SYMBOL_DEFINITION shadowFlag */
/**
 * @summary shadowFlag
 * @description
 * 
 ...
 */
export
const shadowFlag: ATTRIBUTE<Uint32> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint32,
    },
    ...
    "&ldapName": ["shadowFlag"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([11,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION shadowFlag */
