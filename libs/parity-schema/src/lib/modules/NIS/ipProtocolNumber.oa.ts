...
export { Uint8, _decode_Uint8, _encode_Uint8 } from "../NIS/Uint8.ta";
 ...
 */
export
const ipProtocolNumber: ATTRIBUTE<Uint8> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint8,
    },
    ...
    "&id": new _OID([17,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
