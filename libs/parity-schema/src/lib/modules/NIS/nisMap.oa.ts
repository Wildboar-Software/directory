...
const nisMap: OBJECT_CLASS = {
    ...
    "&ldapDesc": "A generic abstraction of a NIS map" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([9,], id_nis_oc) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
