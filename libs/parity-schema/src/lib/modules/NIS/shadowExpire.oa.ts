...
/* START_OF_SYMBOL_DEFINITION shadowExpire */
/**
 * @summary shadowExpire
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const shadowExpire: ATTRIBUTE<Uint32> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint32,
    },
    ...
    "&ldapName": ["shadowExpire"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([10,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION shadowExpire */
