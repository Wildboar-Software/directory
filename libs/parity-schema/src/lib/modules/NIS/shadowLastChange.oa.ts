...
import { UnixEpoch, _decode_UnixEpoch, _encode_UnixEpoch } from "../NIS/UnixEpoch.ta";
export { UnixEpoch, _decode_UnixEpoch, _encode_UnixEpoch } from "../NIS/UnixEpoch.ta";
 ...
 */
export
const shadowLastChange: ATTRIBUTE<UnixEpoch> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": new _OID([5,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
