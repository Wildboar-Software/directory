...
/* START_OF_SYMBOL_DEFINITION memberUid */
/**
 * @summary memberUid
 * @description
 * 
 ...
 */
export
const memberUid: ATTRIBUTE<IA5String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["memberUid"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([12,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION memberUid */
