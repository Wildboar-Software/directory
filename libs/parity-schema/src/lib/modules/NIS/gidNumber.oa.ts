...
export { Uint32, _decode_Uint32, _encode_Uint32 } from "../NIS/Uint32.ta";
...
/* START_OF_SYMBOL_DEFINITION gidNumber */
/**
 * @summary gidNumber
 * @description
 * 
 ...
 */
export
const gidNumber: ATTRIBUTE<Uint32> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Uint32,
    },
    ...
    "&ldapName": ["gidNumber"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "An integer uniquely identifying a group in an administrative domain" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([1,], id_nis_at) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION gidNumber */
