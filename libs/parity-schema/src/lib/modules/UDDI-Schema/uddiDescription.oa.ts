...
/* START_OF_SYMBOL_DEFINITION uddiDescription */
/**
 * @summary uddiDescription
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiDescription: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiDescription"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "short description" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 5,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiDescription */
