...
/* START_OF_SYMBOL_DEFINITION uddiCategoryBag */
/**
 * @summary uddiCategoryBag
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiCategoryBag: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiCategoryBag"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "categorization information" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 15,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiCategoryBag */
