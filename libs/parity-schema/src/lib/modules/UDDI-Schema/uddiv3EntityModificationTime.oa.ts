 ...
 */
export
const uddiv3EntityModificationTime: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "UDDIv3 Last Modified Time for Entity" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 37,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
