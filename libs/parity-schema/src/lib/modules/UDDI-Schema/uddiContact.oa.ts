 ...
 */
export
const uddiContact: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&MandatoryAttributes": [ uddiPersonName, uddiUUID, ] /* OBJECT_FIELD_SETTING */,
    "&OptionalAttributes": [ uddiUseType, uddiDescription, uddiPhone, uddiEMail, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["uddiContact"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6, 2,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
