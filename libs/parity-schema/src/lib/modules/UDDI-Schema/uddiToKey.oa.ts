...
/* START_OF_SYMBOL_DEFINITION uddiToKey */
/**
 * @summary uddiToKey
 * @description
 * 
 ...
 */
export
const uddiToKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiToKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "unique businessEntity key reference" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 26,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiToKey */
