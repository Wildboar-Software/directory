...
/* START_OF_SYMBOL_DEFINITION uddiSortCode */
/**
 * @summary uddiSortCode
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiSortCode: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiSortCode"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "specifies an external display mechanism" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 11,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiSortCode */
