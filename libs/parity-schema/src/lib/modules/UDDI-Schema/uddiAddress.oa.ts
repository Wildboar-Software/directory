 ...
 */
export
const uddiAddress: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ uddiUseType, uddiSortCode, uddiTModelKey, uddiv3TModelKey, uddiAddressLine, uddiLang, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": ["uddiAddress"] /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([6, 3,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
