...
/* START_OF_SYMBOL_DEFINITION uddiIdentifierBag */
/**
 * @summary uddiIdentifierBag
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiIdentifierBag: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiIdentifierBag"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "identification information" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 14,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiIdentifierBag */
