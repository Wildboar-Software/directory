...
/* START_OF_SYMBOL_DEFINITION uddiv3EntityKey */
/**
 * @summary uddiv3EntityKey
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3EntityKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3EntityKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Entity unique identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 44,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3EntityKey */
