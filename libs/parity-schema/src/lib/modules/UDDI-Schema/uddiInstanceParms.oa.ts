...
/* START_OF_SYMBOL_DEFINITION uddiInstanceParms */
/**
 * @summary uddiInstanceParms
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiInstanceParms: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiInstanceParms"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "URL reference to required settings" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 22,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiInstanceParms */
