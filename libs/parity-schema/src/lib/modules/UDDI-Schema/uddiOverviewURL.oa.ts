...
/* START_OF_SYMBOL_DEFINITION uddiOverviewURL */
/**
 * @summary uddiOverviewURL
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiOverviewURL: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiOverviewURL"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "URL reference to overview document" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 24,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiOverviewURL */
