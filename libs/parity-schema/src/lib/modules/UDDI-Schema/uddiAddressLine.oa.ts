...
/* START_OF_SYMBOL_DEFINITION uddiAddressLine */
/**
 * @summary uddiAddressLine
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiAddressLine: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiAddressLine"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "address" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 13,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiAddressLine */
