...
/* START_OF_SYMBOL_DEFINITION uddiv3BusinessKey */
/**
 * @summary uddiv3BusinessKey
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3BusinessKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3BusinessKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 businessEntity unique identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 31,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3BusinessKey */
