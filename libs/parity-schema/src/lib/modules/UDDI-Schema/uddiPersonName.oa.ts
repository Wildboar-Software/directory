...
/* START_OF_SYMBOL_DEFINITION uddiPersonName */
/**
 * @summary uddiPersonName
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiPersonName: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiPersonName"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "name of person or job role available for contact" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 8,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiPersonName */
