...
/* START_OF_SYMBOL_DEFINITION uddiKeyedReference */
/**
 * @summary uddiKeyedReference
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiKeyedReference: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiKeyedReference"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "categorization information" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 16,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiKeyedReference */
