...
/* START_OF_SYMBOL_DEFINITION uddiOperator */
/**
 * @summary uddiOperator
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiOperator: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiOperator"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "registry site operator of businessEntitys master copy" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 3,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiOperator */
