...
/* START_OF_SYMBOL_DEFINITION uddiEMail */
/**
 * @summary uddiEMail
 * @description
 * 
 ...
 */
export
const uddiEMail: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiEMail"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "e-mail address for contact" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 10,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiEMail */
