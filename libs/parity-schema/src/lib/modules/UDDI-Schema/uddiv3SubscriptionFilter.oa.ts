...
/* START_OF_SYMBOL_DEFINITION uddiv3SubscriptionFilter */
/**
 * @summary uddiv3SubscriptionFilter
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3SubscriptionFilter: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3SubscriptionFilter"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Subscription Filter" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 39,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3SubscriptionFilter */
