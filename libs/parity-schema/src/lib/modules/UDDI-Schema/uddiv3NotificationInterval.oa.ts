...
/* START_OF_SYMBOL_DEFINITION uddiv3NotificationInterval */
/**
 * @summary uddiv3NotificationInterval
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3NotificationInterval: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3NotificationInterval"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Notification Interval" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 40,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3NotificationInterval */
