...
/* START_OF_SYMBOL_DEFINITION uddiv3BindingKey */
/**
 * @summary uddiv3BindingKey
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3BindingKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3BindingKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 BindingTemplate unique identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 33,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3BindingKey */
