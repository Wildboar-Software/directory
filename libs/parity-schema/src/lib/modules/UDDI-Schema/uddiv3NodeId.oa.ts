...
/* START_OF_SYMBOL_DEFINITION uddiv3NodeId */
/**
 * @summary uddiv3NodeId
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3NodeId: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3NodeId"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Node Identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 36,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3NodeId */
