...
/* START_OF_SYMBOL_DEFINITION uddiServiceKey */
/**
 * @summary uddiServiceKey
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiServiceKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiServiceKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "businessService unique identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 17,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiServiceKey */
