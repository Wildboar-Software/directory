...
/* START_OF_SYMBOL_DEFINITION uddiv3DigitalSignature */
/**
 * @summary uddiv3DigitalSignature
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3DigitalSignature: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3DigitalSignature"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 entity digital signature" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 35,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3DigitalSignature */
