 ...
 */
export
const uddiv3BriefResponse: ATTRIBUTE<BOOLEAN> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeBoolean,
    },
    ...
    "&ldapDesc": "UDDIv3 Subscription ExpiresAfter field" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 43,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
