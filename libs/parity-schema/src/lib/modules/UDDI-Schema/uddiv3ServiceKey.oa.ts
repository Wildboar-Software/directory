...
/* START_OF_SYMBOL_DEFINITION uddiv3ServiceKey */
/**
 * @summary uddiv3ServiceKey
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3ServiceKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3ServiceKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 businessService unique identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 32,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3ServiceKey */
