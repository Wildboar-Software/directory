...
/* START_OF_SYMBOL_DEFINITION uddiUUID */
/**
 * @summary uddiUUID
 * @description
 * 
 ...
 */
export
const uddiUUID: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiUUID"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "unique attribute" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 27,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiUUID */
