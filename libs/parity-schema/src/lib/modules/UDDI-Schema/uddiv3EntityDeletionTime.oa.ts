...
/* START_OF_SYMBOL_DEFINITION uddiv3EntityDeletionTime */
/**
 * @summary uddiv3EntityDeletionTime
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export
const uddiv3EntityDeletionTime: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3EntityDeletionTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Entity Deletion Time" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 46,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3EntityDeletionTime */
