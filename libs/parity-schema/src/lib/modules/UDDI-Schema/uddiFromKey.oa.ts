 ...
 */
export
const uddiFromKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiFromKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "unique businessEntity key reference" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 25,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiFromKey */
