...
/* START_OF_SYMBOL_DEFINITION uddiUseType */
/**
 * @summary uddiUseType
 * @description
 * 
 ...
 */
export
const uddiUseType: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiUseType"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "name of convention the referenced document follows" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 7,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiUseType */
