...
/* START_OF_SYMBOL_DEFINITION uddiOverviewDescription */
/**
 * @summary uddiOverviewDescription
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiOverviewDescription: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiOverviewDescription"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "outlines tModel usage" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 23,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiOverviewDescription */
