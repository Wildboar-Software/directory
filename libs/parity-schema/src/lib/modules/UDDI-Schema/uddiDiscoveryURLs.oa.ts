...
/* START_OF_SYMBOL_DEFINITION uddiDiscoveryURLs */
/**
 * @summary uddiDiscoveryURLs
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiDiscoveryURLs: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiDiscoveryURLs"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "URL to retrieve a businessEntity instance" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 6,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiDiscoveryURLs */
