...
/* START_OF_SYMBOL_DEFINITION uddiAccessPoint */
/**
 * @summary uddiAccessPoint
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiAccessPoint: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiAccessPoint"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "entry point address to call a web service" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 19,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiAccessPoint */
