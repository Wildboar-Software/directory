...
/* START_OF_SYMBOL_DEFINITION uddiLang */
/**
 * @summary uddiLang
 * @description
 * 
 ...
 */
export
const uddiLang: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiLang"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "xml:lang value in v3 Address structure" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 30,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiLang */
