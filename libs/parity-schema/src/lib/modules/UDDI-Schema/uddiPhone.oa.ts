...
/* START_OF_SYMBOL_DEFINITION uddiPhone */
/**
 * @summary uddiPhone
 * @description
 * 
 ...
 */
export
const uddiPhone: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiPhone"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "telephone number for contact" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 9,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiPhone */
