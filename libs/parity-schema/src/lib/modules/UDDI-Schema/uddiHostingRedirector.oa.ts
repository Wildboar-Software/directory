...
/* START_OF_SYMBOL_DEFINITION uddiHostingRedirector */
/**
 * @summary uddiHostingRedirector
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiHostingRedirector: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiHostingRedirector"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "designates a pointer to another bindingTemplate" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 20,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiHostingRedirector */
