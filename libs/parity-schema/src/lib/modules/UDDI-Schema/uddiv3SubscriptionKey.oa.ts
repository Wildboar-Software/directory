...
/* START_OF_SYMBOL_DEFINITION uddiv3SubscriptionKey */
/**
 * @summary uddiv3SubscriptionKey
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3SubscriptionKey: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiv3SubscriptionKey"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Subscription unique identifier" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 38,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3SubscriptionKey */
