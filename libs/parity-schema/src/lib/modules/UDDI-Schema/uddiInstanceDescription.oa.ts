...
/* START_OF_SYMBOL_DEFINITION uddiInstanceDescription */
/**
 * @summary uddiInstanceDescription
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiInstanceDescription: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["uddiInstanceDescription"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "instance details description" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 21,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiInstanceDescription */
