...
/* START_OF_SYMBOL_DEFINITION uddiv3MaxEntities */
/**
 * @summary uddiv3MaxEntities
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const uddiv3MaxEntities: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["uddiv3MaxEntities"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "UDDIv3 Subscription maxEntities field" /* OBJECT_FIELD_SETTING */,
    "&id": new _OID([4, 41,], id_uddi) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION uddiv3MaxEntities */
