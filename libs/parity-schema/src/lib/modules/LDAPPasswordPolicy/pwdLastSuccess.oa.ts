...
export { id_at_pwdLastSuccess } from "../LDAPPasswordPolicy/id-at-pwdLastSuccess.va";
 ...
 */
export
const pwdLastSuccess: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "The timestamp of the last successful authentication" /* OBJECT_FIELD_SETTING */,
