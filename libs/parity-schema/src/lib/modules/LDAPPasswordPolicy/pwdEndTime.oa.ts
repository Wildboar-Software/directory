 ...
 */
export
const pwdEndTime: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": ["pwdEndTime"] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "The time the password becomes disabled" /* OBJECT_FIELD_SETTING */,
    "&id": id_at_pwdEndTime /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
