...
import { id_at_pwdMaxLength } from '../LDAPPasswordPolicy/id-at-pwdMaxLength.va';
...
export { id_at_pwdMaxLength } from '../LDAPPasswordPolicy/id-at-pwdMaxLength.va';

/* START_OF_SYMBOL_DEFINITION pwdMaxLength */
/**
 * @summary pwdMaxLength
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const pwdMaxLength: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdMaxLength'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdMaxLength /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdMaxLength */
