...
import { id_at_pwdMaxAge } from "../LDAPPasswordPolicy/id-at-pwdMaxAge.va";
export { id_at_pwdMaxAge } from "../LDAPPasswordPolicy/id-at-pwdMaxAge.va";
 ...
 */
export
const pwdMaxAge: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["pwdMaxAge"] /* OBJECT_FIELD_SETTING */,
    "&id": id_at_pwdMaxAge /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
