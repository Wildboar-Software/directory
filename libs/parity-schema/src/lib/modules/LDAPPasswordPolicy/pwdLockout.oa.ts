...
import { id_at_pwdLockout } from '../LDAPPasswordPolicy/id-at-pwdLockout.va';
...
export { id_at_pwdLockout } from '../LDAPPasswordPolicy/id-at-pwdLockout.va';

/* START_OF_SYMBOL_DEFINITION pwdLockout */
/**
 * @summary pwdLockout
 * @description
 *
 ...
 */
export const pwdLockout: ATTRIBUTE<BOOLEAN> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeBoolean,
    },
    ...
    '&ldapName': ['pwdLockout'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdLockout /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdLockout */
