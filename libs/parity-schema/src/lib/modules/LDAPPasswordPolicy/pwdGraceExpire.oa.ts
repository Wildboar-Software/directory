...
import { id_at_pwdGraceExpire } from '../LDAPPasswordPolicy/id-at-pwdGraceExpire.va';
...
export { id_at_pwdGraceExpire } from '../LDAPPasswordPolicy/id-at-pwdGraceExpire.va';

/* START_OF_SYMBOL_DEFINITION pwdGraceExpire */
/**
 * @summary pwdGraceExpire
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const pwdGraceExpire: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdGraceExpire'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdGraceExpire /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdGraceExpire */
