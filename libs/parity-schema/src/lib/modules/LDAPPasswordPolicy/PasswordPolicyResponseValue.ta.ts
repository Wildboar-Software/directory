 ...
 * @class
 */
export class PasswordPolicyResponseValue {
    constructor(
        /**
         * @summary `warning`.
         * @public
    ...
    public static _from_object(_o: {
        [_K in keyof PasswordPolicyResponseValue]: PasswordPolicyResponseValue[_K];
    }): PasswordPolicyResponseValue {
        return new PasswordPolicyResponseValue(
            _o.warning,
            _o.error,
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_PasswordPolicyResponseValue: $.ComponentSpec[] =
    [
        new $.ComponentSpec(
            'warning',
            true,
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_PasswordPolicyResponseValue: $.ComponentSpec[] =
    [];
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_PasswordPolicyResponseValue: $.ComponentSpec[] =
    [];
...
let _cached_decoder_for_PasswordPolicyResponseValue: $.ASN1Decoder<PasswordPolicyResponseValue> | null =
    null;
 ...
 */
export function _decode_PasswordPolicyResponseValue(el: _Element) {
    if (!_cached_decoder_for_PasswordPolicyResponseValue) {
        _cached_decoder_for_PasswordPolicyResponseValue = function (
            el: _Element
        ): PasswordPolicyResponseValue {
            ...
            const callbacks: $.DecodingMap = {
                warning: (_el: _Element): void => {
                    warning =
                        $._decode_explicit<PasswordPolicyResponseValue_warning>(
                            () => _decode_PasswordPolicyResponseValue_warning
                        )(_el);
                },
                error: (_el: _Element): void => {
                    error =
                        $._decode_explicit<PasswordPolicyResponseValue_error>(
                            () => _decode_PasswordPolicyResponseValue_error
                        )(_el);
                },
            };
...
let _cached_encoder_for_PasswordPolicyResponseValue: $.ASN1Encoder<PasswordPolicyResponseValue> | null =
    null;
 ...
 */
export function _encode_PasswordPolicyResponseValue(
    value: PasswordPolicyResponseValue,
    elGetter: $.ASN1Encoder<PasswordPolicyResponseValue>
) {
    if (!_cached_encoder_for_PasswordPolicyResponseValue) {
        _cached_encoder_for_PasswordPolicyResponseValue = function (
            value: PasswordPolicyResponseValue,
            elGetter: $.ASN1Encoder<PasswordPolicyResponseValue>
        ): _Element {
