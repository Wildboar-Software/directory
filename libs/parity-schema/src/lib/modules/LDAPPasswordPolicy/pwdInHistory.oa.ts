...
import { id_at_pwdInHistory } from '../LDAPPasswordPolicy/id-at-pwdInHistory.va';
...
export { id_at_pwdInHistory } from '../LDAPPasswordPolicy/id-at-pwdInHistory.va';

/* START_OF_SYMBOL_DEFINITION pwdInHistory */
/**
 * @summary pwdInHistory
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const pwdInHistory: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdInHistory'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdInHistory /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdInHistory */
