...
import { id_at_pwdMinAge } from '../LDAPPasswordPolicy/id-at-pwdMinAge.va';
...
export { id_at_pwdMinAge } from '../LDAPPasswordPolicy/id-at-pwdMinAge.va';

/* START_OF_SYMBOL_DEFINITION pwdMinAge */
/**
 * @summary pwdMinAge
 * @description
 *
 ...
 */
export const pwdMinAge: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdMinAge'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdMinAge /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdMinAge */
