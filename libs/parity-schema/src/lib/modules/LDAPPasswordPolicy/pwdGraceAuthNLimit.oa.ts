...
import { id_at_pwdGraceAuthNLimit } from '../LDAPPasswordPolicy/id-at-pwdGraceAuthNLimit.va';
...
export { id_at_pwdGraceAuthNLimit } from '../LDAPPasswordPolicy/id-at-pwdGraceAuthNLimit.va';

/* START_OF_SYMBOL_DEFINITION pwdGraceAuthNLimit */
/**
 * @summary pwdGraceAuthNLimit
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const pwdGraceAuthNLimit: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdGraceAuthNLimit'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdGraceAuthNLimit /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdGraceAuthNLimit */
