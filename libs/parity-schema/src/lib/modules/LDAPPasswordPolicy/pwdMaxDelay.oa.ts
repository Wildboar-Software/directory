...
import { id_at_pwdMaxDelay } from '../LDAPPasswordPolicy/id-at-pwdMaxDelay.va';
...
export { id_at_pwdMaxDelay } from '../LDAPPasswordPolicy/id-at-pwdMaxDelay.va';

/* START_OF_SYMBOL_DEFINITION pwdMaxDelay */
/**
 * @summary pwdMaxDelay
 * @description
 *
 ...
 */
export const pwdMaxDelay: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdMaxDelay'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdMaxDelay /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdMaxDelay */
