...
import { id_at_pwdLockoutDuration } from "../LDAPPasswordPolicy/id-at-pwdLockoutDuration.va";
export { id_at_pwdLockoutDuration } from "../LDAPPasswordPolicy/id-at-pwdLockoutDuration.va";
 ...
 */
export
const pwdLockoutDuration: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&ldapName": ["pwdLockoutDuration"] /* OBJECT_FIELD_SETTING */,
    "&id": id_at_pwdLockoutDuration /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
