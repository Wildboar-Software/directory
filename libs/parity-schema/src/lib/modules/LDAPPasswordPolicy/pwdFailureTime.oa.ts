...
export { id_at_pwdFailureTime } from "../LDAPPasswordPolicy/id-at-pwdFailureTime.va";
 ...
 */
export
const pwdFailureTime: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapDesc": "The timestamps of the last consecutive authentication failures" /* OBJECT_FIELD_SETTING */,
