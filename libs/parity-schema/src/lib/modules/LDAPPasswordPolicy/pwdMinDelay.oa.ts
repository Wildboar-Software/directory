...
import { id_at_pwdMinDelay } from '../LDAPPasswordPolicy/id-at-pwdMinDelay.va';
...
export { id_at_pwdMinDelay } from '../LDAPPasswordPolicy/id-at-pwdMinDelay.va';

/* START_OF_SYMBOL_DEFINITION pwdMinDelay */
/**
 * @summary pwdMinDelay
 * @description
 *
 ...
 */
export const pwdMinDelay: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdMinDelay'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdMinDelay /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdMinDelay */
