...
import { id_at_pwdMaxIdle } from '../LDAPPasswordPolicy/id-at-pwdMaxIdle.va';
...
export { id_at_pwdMaxIdle } from '../LDAPPasswordPolicy/id-at-pwdMaxIdle.va';

/* START_OF_SYMBOL_DEFINITION pwdMaxIdle */
/**
 * @summary pwdMaxIdle
 * @description
 *
 ...
 */
export const pwdMaxIdle: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&ldapName': ['pwdMaxIdle'] /* OBJECT_FIELD_SETTING */,
    '&id': id_at_pwdMaxIdle /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION pwdMaxIdle */
