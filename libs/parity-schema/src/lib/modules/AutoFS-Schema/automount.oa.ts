...
const automount: OBJECT_CLASS = {
    ...
    "&MandatoryAttributes": [ commonName, automountInformation, ] /* OBJECT_FIELD_SETTING */,
    ...
    "&id": new _OID([1, 3, 6, 1, 4, 1, 2312, 4, 2, 3,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
};
