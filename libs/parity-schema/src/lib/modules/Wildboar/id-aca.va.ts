...
import { accessControlAttribute } from "../Wildboar/accessControlAttribute.va";
export { accessControlAttribute } from "../Wildboar/accessControlAttribute.va";
 ...
 */
export
const id_aca: ID = accessControlAttribute;
