...
import { certificateExtension } from "../Wildboar/certificateExtension.va";
export { certificateExtension } from "../Wildboar/certificateExtension.va";
 ...
 */
export
const id_ce: ID = certificateExtension;
