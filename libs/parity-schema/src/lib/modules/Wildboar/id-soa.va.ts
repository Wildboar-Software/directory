...
import { schemaOperationalAttribute } from "../Wildboar/schemaOperationalAttribute.va";
export { schemaOperationalAttribute } from "../Wildboar/schemaOperationalAttribute.va";
 ...
 */
export
const id_soa: ID = schemaOperationalAttribute;
