...
import { schemaObjectClass } from "../Wildboar/schemaObjectClass.va";
export { schemaObjectClass } from "../Wildboar/schemaObjectClass.va";
 ...
 */
export
const id_soc: ID = schemaObjectClass;
