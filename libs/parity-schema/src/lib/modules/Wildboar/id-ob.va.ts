...
import { operationalBinding } from "../Wildboar/operationalBinding.va";
export { operationalBinding } from "../Wildboar/operationalBinding.va";
 ...
 */
export
const id_ob: ID = operationalBinding;
