...
import { knowledgeMatchingRule } from "../Wildboar/knowledgeMatchingRule.va";
export { knowledgeMatchingRule } from "../Wildboar/knowledgeMatchingRule.va";
 ...
 */
export
const id_kmr: ID = knowledgeMatchingRule;
