...
import { matchingRestriction } from "../Wildboar/matchingRestriction.va";
export { matchingRestriction } from "../Wildboar/matchingRestriction.va";
 ...
 */
export
const id_mre: ID = matchingRestriction;
