...
import { operationalAttributeType } from "../Wildboar/operationalAttributeType.va";
export { operationalAttributeType } from "../Wildboar/operationalAttributeType.va";
 ...
 */
export
const id_oa: ID = operationalAttributeType;
