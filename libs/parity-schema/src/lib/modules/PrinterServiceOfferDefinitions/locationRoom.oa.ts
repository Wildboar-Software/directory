...
import { ub_trader_so_locationRoom } from "../PrinterServiceOfferDefinitions/ub-trader-so-locationRoom.va";
export { ub_trader_so_locationRoom } from "../PrinterServiceOfferDefinitions/ub-trader-so-locationRoom.va";
...
import { id_trader_at_so_locationRoom } from "../PrinterServiceOfferDefinitions/id-trader-at-so-locationRoom.va";
export { id_trader_at_so_locationRoom } from "../PrinterServiceOfferDefinitions/id-trader-at-so-locationRoom.va";


/* START_OF_SYMBOL_DEFINITION locationRoom */
/**
 * @summary locationRoom
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const locationRoom: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_so_locationRoom /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION locationRoom */
