...
/* START_OF_SYMBOL_DEFINITION id_trader_at_so_pageSize */
/**
 * @summary id_trader_at_so_pageSize
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_trader_at_so_pageSize: OBJECT_IDENTIFIER = _OID.fromParts(
    [6],
    id_trader_at_so
);
/* END_OF_SYMBOL_DEFINITION id_trader_at_so_pageSize */
