...
import { ub_trader_so_locationBlg } from "../PrinterServiceOfferDefinitions/ub-trader-so-locationBlg.va";
export { ub_trader_so_locationBlg } from "../PrinterServiceOfferDefinitions/ub-trader-so-locationBlg.va";
...
export { id_trader_at_so_locationBlg } from "../PrinterServiceOfferDefinitions/id-trader-at-so-locationBlg.va";
 ...
 */
export
const locationBuilding: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
