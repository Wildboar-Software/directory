...
import { id_trader_at_so_queueLength } from '../PrinterServiceOfferDefinitions/id-trader-at-so-queueLength.va';
...
export { id_trader_at_so_queueLength } from '../PrinterServiceOfferDefinitions/id-trader-at-so-queueLength.va';

/* START_OF_SYMBOL_DEFINITION queueLength */
/**
 * @summary queueLength
 * @description
 *
 ...
 */
export const queueLength: ATTRIBUTE<INTEGER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': $._decodeInteger,
    },
    ...
    '&id': id_trader_at_so_queueLength /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION queueLength */
