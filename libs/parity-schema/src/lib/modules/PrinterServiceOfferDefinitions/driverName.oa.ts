...
import { ub_trader_so_driverName } from "../PrinterServiceOfferDefinitions/ub-trader-so-driverName.va";
export { ub_trader_so_driverName } from "../PrinterServiceOfferDefinitions/ub-trader-so-driverName.va";
...
import { id_trader_at_so_driverName } from "../PrinterServiceOfferDefinitions/id-trader-at-so-driverName.va";
export { id_trader_at_so_driverName } from "../PrinterServiceOfferDefinitions/id-trader-at-so-driverName.va";


/* START_OF_SYMBOL_DEFINITION driverName */
/**
 * @summary driverName
 * @description
 * 
 ...
 */
export
const driverName: ATTRIBUTE<DirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_trader_at_so_driverName /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION driverName */
