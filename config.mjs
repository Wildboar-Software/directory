...
const labellingAuthoritiesFileContents: Buffer | undefined = process.env.MEERKAT_LABELLING_AUTHORITIES
    ...
    : undefined;
const labellingAuthorities = labellingAuthoritiesFileContents
    ? [
...
const decodedCRLs = tlsCRLFileContents
...
export default function () {
    return {
        ...
        tls: {
            ...
            minVersion: process.env.MEERKAT_TLS_MIN_VERSION,
            maxVersion: process.env.MEERKAT_TLS_MAX_VERSION,
