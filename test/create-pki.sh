...
openssl req -new -newkey rsa:2048 -nodes -keyout dsa1.key.pem -out req1.pem -subj "/CN=dsa1"
openssl req -new -newkey rsa:2048 -nodes -keyout dsa2.key.pem -out req2.pem -subj "/CN=dsa2"
openssl req -new -newkey rsa:2048 -nodes -keyout dsa3.key.pem -out req3.pem -subj "/CN=dsa3"
...
openssl req -new -newkey rsa:2048 -nodes -keyout jt.key.pem -out reqjt.pem -subj "/C=CA/CN=Justin Trudeau"
