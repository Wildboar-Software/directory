...
export MEERKAT_FOLLOW_REFERRAL_TTL="$(snapctl get follow-referral-ttl)"
...
export MEERKAT_MAX_USED_INVOKE_IDS="$(snapctl get max-used-invoke-ids)"
...
export MEERKAT_SHADOW_TOTAL_REFRESH_VERTEX_CONCURRENCY="$(snapctl get shadow-total-refresh-vertex-concurrency)"
...
export MEERKAT_XR_UPSERT_CONCURRENCY="$(snapctl get xr-upsert-concurrency)"
