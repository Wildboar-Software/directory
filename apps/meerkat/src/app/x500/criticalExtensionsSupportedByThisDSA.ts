...
criticalExtensionsSupportedByThisDSA[EXT_BIT_EXTENDED_FILTER - 1] = FALSE_BIT;
criticalExtensionsSupportedByThisDSA[EXT_BIT_TARGET_SYSTEM - 1] = TRUE_BIT;
criticalExtensionsSupportedByThisDSA[EXT_BIT_USE_ALIAS_ON_UPDATE - 1] = FALSE_BIT;
...
criticalExtensionsSupportedByThisDSA[EXT_BIT_SECURITY_ATTRIBUTE_CERTIFICATION_PATH - 1] = FALSE_BIT;
...
criticalExtensionsSupportedByThisDSA[EXT_BIT_HIERARCHY_SELECTIONS - 1] = FALSE_BIT;
criticalExtensionsSupportedByThisDSA[EXT_BIT_RELAXATION - 1] = FALSE_BIT;
...
criticalExtensionsSupportedByThisDSA[EXT_BIT_PAGED_RESULTS_ON_THE_DSP - 1] = FALSE_BIT;
