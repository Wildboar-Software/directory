import { countryCode3c, countryCode3n, countryName } from "@wildboar/x500/SelectedAttributeTypes";
import type { Name } from "@wildboar/pki-stub";
import { compare } from "@wildboar/iso3166";

/**
 * @summary Determine whether two distinguished names are within the same "local scope"
 * @description
 *
 ...
 * @function
 */
export function isLocalScope(dn1: Name, dn2: Name): boolean {
    try {
