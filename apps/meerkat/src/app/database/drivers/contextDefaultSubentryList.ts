...
} from "@wildboar/x500/src/lib/modules/InformationFramework/contextDefaultSubentryList.oa";
import getDistinguishedName from "../../x500/getDistinguishedName";
import {
    id_sc_contextAssertionSubentry,
} from "@wildboar/x500/src/lib/modules/InformationFramework/id-sc-contextAssertionSubentry.va";
import {
...
const readValues: SpecialAttributeDatabaseReader = async (
    ...
    return relevantSubentries
        ...
        .map((dn) => ({
            type: contextDefaultSubentryList["&id"],
