// This implementation was ripped from the `metaphone` NPM package, which is/was
// released under an MIT license at the time this was copied.
const sh = 'X';
const th = '0';
 ...
 */
export
function metaphone (value: string): string {
  let phonized: string = '';
  let index: number = 0;
  let skip: number;
