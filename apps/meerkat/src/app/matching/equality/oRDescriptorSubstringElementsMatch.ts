...
export
function getORDescriptorSubstringElementsMatcher (ctx: Context): EqualityMatcher {
    const orNameMatcher = getORNameSubstringElementsMatch(ctx);
    return (
...
export default getORDescriptorSubstringElementsMatcher;
