...
import {
    chainedLdapTransport as operation,
...
export
async function chainedLdapTransport (
    ctx: Context,
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained ldapTransport operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedLdapTransport;
