...
import {
    chainedRemoveEntry as operation,
...
export
async function chainedRemoveEntry (
    ctx: Context,
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained removeEntry operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedRemoveEntry;
