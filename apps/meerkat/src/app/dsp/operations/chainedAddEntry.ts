...
export
async function chainedAddEntry (
    ctx: Context,
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained addEntry operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedAddEntry;
