...
export
async function chainedModifyDN (
    ctx: Context,
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained modifyDN operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedModifyDN;
