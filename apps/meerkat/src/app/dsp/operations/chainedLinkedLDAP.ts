...
import {
    chainedLinkedLDAP as operation,
...
async function chainedLinkedLDAP (
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained linkedLDAP operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedLinkedLDAP;
