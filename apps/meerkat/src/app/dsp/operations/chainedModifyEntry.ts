...
import {
    chainedModifyEntry as operation,
...
export
async function chainedModifyEntry (
    ctx: Context,
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained modifyEntry operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedModifyEntry;
