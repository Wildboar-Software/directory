...
import {
    chainedAdministerPassword as operation,
...
export
async function chainedAdministerPassword (
    ctx: Context,
    ...
    const data: Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1 = ("signed" in arg)
        ...
        : arg.unsigned;
    ctx.log.info(`Received chained administerPassword operation ${data.chainedArgument.operationIdentifier}.`);
...
export default chainedAdministerPassword;
