...
- Better loop detection: Meerkat DSA now does a better job of identifying
  infinite loops formed from chained operations.
...
- Meerkat DSA appears to run just fine in the latest [Bun](https://bun.sh/)
  runtime now, but it does not appear to be _that_ much faster.
